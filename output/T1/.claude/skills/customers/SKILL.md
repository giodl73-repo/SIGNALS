...
Write artifact to: simulations/validate/customers/{{topic}}-customers-{{date}}.md
Include frontmatter: skill: validate-customers, topic: {{topic}}, date: {{date}}, weighted_score: [N]