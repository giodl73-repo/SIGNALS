---
name: signal-quest
description: "Quest namespace: define rubrics (/signal-quest-rubric), generate variations (/signal-quest-variate), score outputs (/signal-quest-score), find the golden prompt (/signal-quest-golden).
"
