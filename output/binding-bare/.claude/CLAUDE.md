...
- /discover-brainstorm -- Generate a pool of ideas for any topic -- more than you need, so you can rank and filter. Each idea gets: name, one-line *(inherited from T1, T3 -- full content loaded on demand)*
