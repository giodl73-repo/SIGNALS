---
name: achievements
description: Show achievements earned for a topic. Scans signals/ artifacts, checks which achievements have been earned across 35 milestones in 8 categories, shows what is in progress and what to run next. DISPLAY ONLY — writes no files.
