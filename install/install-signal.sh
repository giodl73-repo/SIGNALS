#!/usr/bin/env bash
# Signal — Signal-prefix binding install
# Skills installed as: /signal-competitors, /signal-decide, /signal-spec, etc.
# 75 atomic skills, signal- prefix
# Use this when you have other Claude Code plugins and want to avoid collisions.
...
echo "Signal v0.1 — signal- prefix binding install"
echo "  source : $SIGNAL_ROOT/output/binding-signal/T1/.claude/skills/"
echo "  target : $TARGET"
echo ""

# Check if generated output exists
OUTPUT_DIR="$SIGNAL_ROOT/output/binding-signal/T1/.claude/skills"
...
echo "Signal v0.1 (signal- prefix) installed: $INSTALLED skills -> .claude/skills/"
echo ""
echo "First commands to try:"
echo "  /signal-decide <your-feature>       Full pre-commitment decision campaign"
echo "  /signal-competitors <your-feature>  Scout inertia and named competitors"
echo "  /signal-hypothesis <your-feature>   Frame and falsify the core assumption"
