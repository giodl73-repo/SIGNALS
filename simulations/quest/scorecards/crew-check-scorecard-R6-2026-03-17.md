...
|----|-----------|---------|----------|
| C-01 | Role source traceability | **PASS** | `.craft/roles/` named by path; G1 halts if absent; no invented roles |
...
| ID | Criterion | Verdict | Evidence |
|----|-----------|---------|----------|
| C-01 | Role source traceability | **PASS** | `.craft/roles/` named; G1 halt if absent |
...
| ID | Criterion | Verdict | Evidence |
|----|-----------|---------|----------|
| C-01 | Role source traceability | **PASS** | `.craft/roles/` referenced; G1 BLOCKING halt |
...
| ID | Criterion | Verdict | Evidence |
|----|-----------|---------|----------|
| C-01 | Role source traceability | **PASS** | `.craft/roles/`; G1 BLOCKING halt |
