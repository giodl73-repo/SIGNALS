...
| **C-04** Output location | PASS — Phase 4 OUTPUT-AREA: .roles/{area}/; Phase 5 writes files there; REGISTRY.md at .roles/{area}/REGISTRY.md | PASS — same path derivation pattern | PASS — same | PASS — same | PASS — same |
