...
| C-05 | Does not write .roles/ | **PASS** | "HARD BOUNDARY (C-12 satisfier)" explicit; post-write confirms "No .roles/ content" |
...
| C-05 | Does not write .roles/ | **PASS** | "HARD BOUNDARY (C-12 satisfier)" explicit; Section 4 post-write confirms |
...
| C-05 | Does not write .roles/ | **PASS** | "DRAFT BOUNDARY (C-12 satisfier)" explicit; FINALIZE PHASE post-write confirms |
...
| C-05 | Does not write .roles/ | **PASS** | Sub-section 1.1 "HARD BOUNDARY"; Sub-section 4.2 confirms "No .roles/ content" |
...
| C-05 | Does not write .roles/ | **PASS** | "DRAFT ONLY (C-12)" first line; Lock-In: "C-05 -- no .roles/ content / STATUS: ACKNOWLEDGED (essential — any violation fails)" |
