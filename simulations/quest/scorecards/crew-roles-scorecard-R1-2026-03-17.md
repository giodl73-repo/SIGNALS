...
| C-03 | PASS | "Output path: .craft/roles/{area}/ where {area} reflects the actual input domain" |
...
| C-03 | PASS | "Output path: .craft/roles/{area}/" in Phase 4 |
...
| C-03 | PASS | Phase 4: "write all files to .craft/roles/{area}/"; non-generic area requirement explicit |
...
| C-03 | PASS | Phase 4: `.craft/roles/{area}/`; "Do not use 'roles', 'default', or any generic segment" |
