...
| C-04 | PASS | Phase 4 OUTPUT-AREA: `.craft/roles/{area}/`; area slug must use Phase 2 domain vocabulary |
...
| C-04 | PASS | Phase 5 WRITE target: `.craft/roles/{area}/`; OUTPUT-AREA spec in PREPARE |
...
| C-04 | PASS | Phase 5 writes to `.craft/roles/{area}/` |
...
| C-03 | PASS | All four stock roles in Phase 3 |
| C-04 | PASS | Phase 4 OUTPUT-AREA `.craft/roles/{area}/`; Phase 5 writes to this path |
...
| C-04 | PASS | Phase 4 Step A OUTPUT-AREA: `.craft/roles/{area}/`; domain vocabulary required for area slug |
