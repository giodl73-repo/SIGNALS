...
- **C-04**: `.craft/roles/{area-slug}/{role-slug}.md` path pattern explicit; VALIDATE checks area slug uniqueness; CROSS-REF dir check confirms subdirs match parse manifest slugs. V-05 adds STRUCTURAL-ERROR:IA-OUT-OF-ORDER.
