...
|----|--------|---------|----------|
| C-01 | essential | **PASS** | Schema column: "Must match a filename stem in `.craft/roles/`. Zero fabricated names." Phase 1 builds pool from files found. |
...
| ID | Weight | Verdict | Evidence |
|----|--------|---------|----------|
| C-01 | essential | **PASS** | "Read every file in `.craft/roles/`. Build the reviewer pool from what you find." Step 3 selects from that pool only. |
