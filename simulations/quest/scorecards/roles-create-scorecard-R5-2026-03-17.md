...
**C-05** — Phase 2 in all variations checks for `.craft/roles/{area}/inertia-advocate.md`. When absent, a complete companion file is generated with full frontmatter and body table -- not a suggestion. All 5 satisfy this and exceed C-05's minimum by also satisfying C-11.
