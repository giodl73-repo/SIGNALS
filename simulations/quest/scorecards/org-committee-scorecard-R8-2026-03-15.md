...
| C-02 | Participants from `.roles/` | **PASS** | Phase 0 reads charter explicitly; fallback to Signal defaults with mandatory disclosure |
...
| C-02 | Participants from `.roles/` | **PASS** | "Read `.roles/`" with explicit fallback disclosure |
