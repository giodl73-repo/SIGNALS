...
| C-02 Role-loaded perspective | ++ | "should surface the role's governing orientation frame (orientation.frame from the loaded .craft/roles/ file)" -- explicit and named |
...
| C-18 Role orientation frame | ++ | "surface the role's governing orientation frame (orientation.frame from the loaded .craft/roles/ file) -- not just the role's name" |
