...
|----|-----------|---------|-----|---------------|
| C-01 | File written to correct path | PASS | 12 | Step 4 writes in order: `.craft/roles/{area}/inertia-advocate.md` (if generated in Step 2) then `.craft/roles/{area}/{subrole}.md`. Paths explicit. |
...
| ID | Criterion | Verdict | Pts | Evidence Note |
|----|-----------|---------|-----|---------------|
| C-01 | File written to correct path | PASS | 12 | Phase 7 writes correct paths. Audit item [A]: "Does `.craft/roles/{area}/{subrole}.md` exist as the output path? (not current dir, not simulations/)" -- path compliance is an explicit pre-write checkpoint. |
...
| ID | Criterion | Verdict | Pts | Evidence Note |
|----|-----------|---------|-----|---------------|
| C-01 | File written to correct path | PASS | 12 | Phase 5 writes in order: `.craft/roles/{area}/inertia-advocate.md` (if generated) then `.craft/roles/{area}/{subrole}.md`. |
