...
|---|---|---|
| C-01 Areas named and traceable | PASS | SCANNER instructions enumerate 7 specific source types (CLAUDE.md, package.json, design/, namespaces, test areas, SPECS.md, .craft/roles/) as named evidence anchors |
