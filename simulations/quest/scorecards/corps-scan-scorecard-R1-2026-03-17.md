...
| C-05 No .craft/roles writes | essential | **PASS** | DRAFT NOTICE line 1 + "Do NOT write .craft/roles/ file content anywhere in this output" in Phase 2 — double boundary |
...
| C-05 No .craft/roles writes | essential | **PASS** | DRAFT NOTICE line 1 + "Do NOT write .craft/roles/ file content anywhere in this output" in Step 3 |
...
| C-05 No .craft/roles writes | essential | **PARTIAL** | "Nothing gets built from this output" communicates intent but lacks explicit "Do NOT write .craft/roles/" prohibition — weaker boundary |
...
| C-05 No .craft/roles writes | essential | **PASS** | DRAFT NOTICE + phase gate structure preserves boundary under conversational register |
...
| C-05 No .craft/roles writes | essential | **PASS** | DRAFT NOTICE + phase gate + explicit DO NOT prohibition — triple boundary |
...
3. **Layered boundary enforcement on C-05** — opening DRAFT NOTICE + in-YAML "Do NOT write .craft/roles/ file content" creates double (or triple in V-05) enforcement. Neither layer alone is as robust; together they make the boundary nearly failure-proof regardless of how far into the output a model drifts.
