...
| C-04 | **PASS** | Paths `.craft/roles/{area-slug}/inertia-advocate.md` + `.craft/roles/{area-slug}/{role-slug}.md` derived from org.yaml; CONTRACT phase validates structure before files |
...
| C-13 | **PASS** | CONTRACT Phase 3 before WRITE-IA/WRITE-ROLES/WRITE-CHART; TABLE-CLOSED: "File generation must produce exactly [n] .craft/roles/ files" (++) |
