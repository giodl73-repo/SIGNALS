...
| C-02 | Participants loaded from `.roles/` | **PASS** | Step 2 explicit load with graceful fallback |
...
| C-02 | Participants loaded from `.roles/` | **PASS** | Rule 1: "Load participants from `.roles/`"; `Participants loaded from:` template field forces disclosure |
...
| C-02 | Participants loaded from `.roles/` | **PASS** | "Load participants. Read `.roles/`... If no charter: use Signal defaults and state them." |
...
|----|-----------|--------|---------|
| C-01 | Committee type declared correctly | **PASS** | "Output the first line: `Committee: [TYPE] — [agenda item title]`" |
| C-02 | Participants loaded from `.roles/` | **PASS** | Step 2 loads charter; inertia-advocate added if present; fallback stated |
...
| C-02 | Participants loaded from `.roles/` | **PASS** | "Load participants. Read `.roles/` for this committee type's charter... Fallback: Signal defaults — state them explicitly." |
