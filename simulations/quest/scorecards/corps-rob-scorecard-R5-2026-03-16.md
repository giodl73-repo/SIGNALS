...
| C-02 | Role-loaded perspective | PASS | Setup reads org.yaml + .craft/roles/; MOST CRITICAL declared per role |
...
| C-02 | Role-loaded perspective | PASS | Setup reads org.yaml + .craft/roles/ |
...
| C-02 | Role-loaded perspective | PASS | Setup reads org.yaml + .craft/roles/; ROLE CONCERN per stage is topic-specific |
