...
| C-04 | **PASS** | Step 3 derives area slug; Step 4 writes to `.roles/{area}/` |
...
| C-04 | **PASS** | Output to `.roles/{derived-area-name}/` |
...
| C-04 | **PASS** | "Write one `.md` file per role to `.roles/{area}/`" |
...
| C-04 | **PASS** | Phase 3 area slug + Phase 4 writes to `.roles/{area}/` |
