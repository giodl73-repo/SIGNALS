...
| C-05 | Does not write .roles/ | PASS | Disclaimer at top; no role file content anywhere in prompt |
...
| C-05 | Does not write .roles/ | PASS | Disclaimer required output at top; no role file content |
...
| C-05 | Does not write .roles/ | PASS | Disclaimer required output; no .roles/ content |
...
| C-05 | Does not write .roles/ | PASS | Disclaimer at top; no .roles/ content |
...
| C-04 | Standard roles per team | PASS | "at least 2 named roles. No 'TBD'." Inertia Advocate excluded |
| C-05 | Does not write .roles/ | PASS | Skill-wide constraint at very top: "Any role output containing role file content is a skill violation." Strongest C-05 framing of all 5 variations |
