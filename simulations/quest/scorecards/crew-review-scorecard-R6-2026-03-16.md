...
|----|--------|--------|----------|
| C-01 | essential | PASS | Property R1: all roles from `.craft/roles/`, unconditional ERROR halts for absent/empty/malformed |
...
| ID | Weight | Status | Evidence |
|----|--------|--------|----------|
| C-01 | essential | PASS | PHASE 1 LOAD: reads `.craft/roles/`, unconditional ERROR halts |
...
| ID | Weight | Status | Evidence |
|----|--------|--------|----------|
| C-01 | essential | PASS | Step 1 LOAD: ERROR halts, role pool from `.craft/roles/` only |
...
| ID | Weight | Status | Evidence |
|----|--------|--------|----------|
| C-01 | essential | PASS | Step 1 LOAD: ERROR halts, role pool from `.craft/roles/` |
