...
|----|-----------|---------|-----|---------------|
| C-01 | File written to correct path | PASS | 12 | Step 5: "Write the complete role to: .roles/{area}/{subrole}.md" — explicit. |
...
| ID | Criterion | Verdict | Pts | Evidence Note |
|----|-----------|---------|-----|---------------|
| C-01 | File written to correct path | PASS | 12 | "File path: .roles/{area}/{subrole}.md" shown in the template header. |
...
| ID | Criterion | Verdict | Pts | Evidence Note |
|----|-----------|---------|-----|---------------|
| C-01 | File written to correct path | PASS | 12 | Phase 5: "Write to: .roles/{area}/{subrole}.md (Write the inertia-advocate file first if it was absent in Phase 2.)" |
...
| ID | Criterion | Verdict | Pts | Evidence Note |
|----|-----------|---------|-----|---------------|
| C-01 | File written to correct path | PASS | 12 | "The file goes in .roles/{area}/{subrole}.md" — stated explicitly. |
...
| C-05 | Inertia-advocate surfaced when absent | PASS | 12 | "Before you write anything, check whether .roles/{area}/inertia-advocate.md exists. If it doesn't, mention it — something like 'I notice there's no inertia-advocate in the {area} area yet…'" — check sequenced correctly, suggested wording provided. |
...
| ID | Criterion | Verdict | Pts | Evidence Note |
|----|-----------|---------|-----|---------------|
| C-01 | File written to correct path | PASS | 12 | Phase 5: "Write files: .roles/{area}/inertia-advocate.md (if generated in Phase 2) and .roles/{area}/{subrole}.md." Correct path for both outputs. |
