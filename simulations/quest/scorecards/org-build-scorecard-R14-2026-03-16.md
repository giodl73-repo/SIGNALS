...
| ID | Result | Evidence |
|----|--------|----------|
| **C-06** | **PASS** | File path template `.craft/roles/{area}/{role}.md` structurally enforces area subdirectories. Phase 2 requires minimum 4 areas (standard), each producing roles under that area's subdir. |
