...
| C-05 No .craft/roles/ | Essential | PASS | Stated as hard constraint up front before output begins |
...
| C-05 No .craft/roles/ | Essential | PASS | C-05 front-loaded as a named constraint before register relaxes |
...
| C-05 No .craft/roles/ | Essential | PASS | "DRAFT GATE states the draft-only constraint as an entry condition" — cannot enter DRAFT without acknowledging boundary |
...
| C-05 No .craft/roles/ | Essential | PASS | Two-stage design is output-only; neither stage writes .craft/roles/ |
...
| C-05 No .craft/roles/ | Essential | PASS | No section for role files; skeleton contains no .craft/roles/ affordance |
