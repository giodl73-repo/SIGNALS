...
|----|-----------|------|------|------|------|------|
| C-01 | Role selection grounded in .craft/roles/ | PASS | PASS | PASS | PASS | PASS |
...
Evidence notes:
- All five variations explicitly read `.craft/roles/`, disallow fabrication, and include 4-column matrix with severity constraints. C-02 passes for V-02/V-05 because the 5-column schema is a superset containing all four required columns.
