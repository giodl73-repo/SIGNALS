...
**Evidence (shared):** All variations declare labeled stage format, role loading from `.roles/`, structured finding tables with ≥2 per stage, Go/No-Go verdict block in TPM.
