...
| C-04 | Essential | **PASS** | `.roles/{area}/` output path; Phase 4 writes individual `.md` files |
...
| C-04 | Essential | **PASS** | `.roles/{area}/` path |
...
| C-04 | Essential | **PASS** | `.roles/{area}/` output path |
