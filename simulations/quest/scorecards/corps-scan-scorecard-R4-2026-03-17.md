...
| C-05 | Essential | Does not write .craft/roles/ |
...
| C-05 | PASS | "SCOPE: draft org.yaml only. No `.craft/roles/` files. No role file content of any kind." + REQUIRED FIRST OUTPUT directive |
...
| C-05 | PASS | "SKILL-WIDE CONSTRAINT: No role writes `.craft/roles/` files. No role produces role file content." + "Before SCANNER begins, output this statement: 'Draft org.yaml for review only. No role files are created.'" |
