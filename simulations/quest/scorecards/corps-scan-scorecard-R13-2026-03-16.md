...
| C-05 Does not write .craft/roles/ | PASS | PASS | PASS | PASS | PASS | HARD BOUNDARY front-loaded; C-05 ACKNOWLEDGED with "essential failure if violated" on every pre-check |
