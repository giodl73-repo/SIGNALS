...
| C-05 Does not write .craft/roles/ | PASS | IVR-P1-B enforces exclusion unconditionally; REPAIR: "Remove unconditionally. corps-scan produces draft org.yaml only." |
