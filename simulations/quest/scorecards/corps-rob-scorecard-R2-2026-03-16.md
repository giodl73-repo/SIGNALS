...
| C-02 | Role-loaded perspective | PASS | Template: "specific concern grounded in this role's lens — the most critical item they found"; setup reads `.craft/roles/` |
...
| C-02 | Role-loaded perspective | PASS | Template: "specific concern — not a category, specific to this role's lens"; setup reads `.craft/roles/` |
...
|----|-----------|---------|----------|
| C-01 | Stage identity | PASS | `## Stage:` + ROLE: line |
| C-02 | Role-loaded perspective | PASS | Template: "specific concern grounded in this role's lens"; setup reads `.craft/roles/` |
