...
*Evidence:* Phase 6 writes to `.roles/{area}/{subrole}.md` (C-01). FIELD-REGISTER CONTRACT plus Phase 3 gates ensure all 12 frontmatter fields (C-02). Phase 0/1 routes name-only, description, interactive correctly (C-03). FIELD-REGISTER specifies domain-specific field content (C-04). Phase 2 generates inertia-advocate companion when absent (C-05).
