...
| C-03 | **PASS** | Phase 1 generates `.craft/roles/governance/inertia-advocate.md` before any other role. Role name contains `inertia-advocate`. |
...
| ID | Result | Evidence |
|----|--------|----------|
| C-06 | **PASS** | Phase 2 produces area subdirectories; Phase 1 places IA under `.craft/roles/governance/`. Min 2 subdirs achieved structurally. |
