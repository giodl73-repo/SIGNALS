...
| ID | Result | Evidence |
|----|--------|----------|
| C-01 | **PASS** | Step 1 builds pool from `.roles/` only; error+halt if absent |
...
| ID | Result | Evidence |
|----|--------|----------|
| C-01 | **PASS** | Step 1 builds pool from `.roles/` only |
...
| ID | Result | Evidence |
|----|--------|----------|
| C-01 | **PASS** | Stage 1: `.roles/` only; ERROR+halt if missing |
...
| ID | Result | Evidence |
|----|--------|----------|
| C-01 | **PASS** | P1.1: `.roles/` only; "Zero roles may be invented" |
