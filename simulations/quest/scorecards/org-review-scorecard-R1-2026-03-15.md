...
|-----------|--------|----------|
| C-01 Role Selection | **PASS** | "Read `.roles/signal/`... Do not invent roles" — explicit registry constraint |
...
| Criterion | Rating | Evidence |
|-----------|--------|----------|
| C-01 Role Selection | **PASS** | "All roles must come from `.roles/signal/`. Do not invent roles." |
...
| Criterion | Rating | Evidence |
|-----------|--------|----------|
| C-01 Role Selection | **PASS** | "All roles must come from `.roles/signal/`." |
...
| Criterion | Rating | Evidence |
|-----------|--------|----------|
| C-01 Role Selection | **PASS** | "No role may be invented. Every reviewer must have a corresponding file in `.roles/signal/`." Phase 1 Step 1: enumerate all files first |
...
| Criterion | Rating | Evidence |
|-----------|--------|----------|
| C-01 Role Selection | **PASS** | "Read `.roles/signal/` to enumerate available reviewers." Registry-sourced. |
