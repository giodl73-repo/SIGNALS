...
Let me read the skill definition and gather topic context.

● Read SKILL.md
  │ .claude\skills\simulate-stress\SKILL.md
  └ 15 lines read

● Read SKILL.md
  │ .claude\skills\simulate-stress.t3\SKILL.md
  └ 234 lines read
...
Let me gather topic context from existing signals.
...
Now I have full context. Let me create the output directory and write the artifact.
