...
| C-02 | Participants from `.roles/` | **PASS** | Explicit instruction to load from charter; fallback with disclosure |
...
| C-02 | Participants from `.roles/` | **PASS** | Rule 1: "Load participants from `.roles/`; state fallback explicitly" |
| C-03 | Each participant speaks from role lens | **PASS** | "2-4 sentences from documented role orientation" |
...
| C-02 | Participants from `.roles/` | **PASS** | Phase 0: explicit load + fallback disclosure |
...
| C-02 | Participants from `.roles/` | **PASS** | Step 1: load from charter + inertia-advocate.md fallback |
| C-03 | Each participant speaks from role lens | **PASS** | "2-4 sentences from documented role orientation" |
...
| C-02 | Participants from `.roles/` | **PASS** | Rule 1: load from charter; explicit fallback |
| C-03 | Each participant speaks from role lens | **PASS** | "2-4 sentences from documented role orientation" |
