...
|----|-----------|-------|----------|
| C-01 | Role source traceability | 12 | Gate 1 reads `.roles/` exclusively; "Do not add roles not present in that directory"; ERROR+halt if absent |
...
| ID | Criterion | Score | Evidence |
|----|-----------|-------|----------|
| C-01 | Role source traceability | 12 | Step 1: `.roles/` only; HALT [G1] if absent/empty |
...
| ID | Criterion | Score | Evidence |
|----|-----------|-------|----------|
| C-01 | Role source traceability | 12 | Gate 1: `.roles/` only; HALT [G1] named in registry; "zero invented roles" |
...
| ID | Criterion | Score | Evidence |
|----|-----------|-------|----------|
| C-01 | Role source traceability | 12 | GATE 1: `.roles/` only; HALT [G1]; zero invented roles |
