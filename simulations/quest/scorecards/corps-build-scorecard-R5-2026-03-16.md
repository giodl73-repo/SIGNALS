...
| C-13 Headcount as build contract | PASS | Phase 3 CONTRACT produces ARTIFACT-A before any files; TABLE-CLOSED count drives file generation; "File generation must produce exactly [n] .craft/roles/ files" |
...
| C-13 | PASS | PHASE 3 CONTRACT: ARTIFACT-A is first output; TABLE-CLOSED count constrains file count: "File generation must produce exactly [n] .craft/roles/ files"; PHASE 7 WRITE-ROLES enters only after CHART-WRITTEN |
