...
|----|-----------|--------|---------|
| C-01 | Role source traceability | PASS | Step 1 explicitly reads `.craft/roles/`, "Do not add roles not present in that directory." Strong guard. |
...
| ID | Criterion | Result | Evidence |
|----|-----------|--------|---------|
| C-01 | Role source traceability | PASS | "Read `.craft/roles/`. Build role pool from files found. No invented roles." Clear guard. |
...
| ID | Criterion | Result | Evidence |
|----|-----------|--------|---------|
| C-01 | Role source traceability | PASS | "SHALL be the filename stem of a role file in `.craft/roles/`. MAY NOT be invented." Formal prohibition in the schema contract. |
