...
| ID | Verdict | Evidence |
|----|---------|----------|
| C-01 | PASS | PHASE 1 LOAD reads `.roles/`; L3 hard halts if absent/empty/malformed; L4 zero invented roles |
...
| C-14 | PASS | L3 hard halt: "Directory absent: ERROR: .roles/ not found. Halt." unconditional |
