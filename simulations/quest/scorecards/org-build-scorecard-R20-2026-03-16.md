...
| C-03 | **PASS** | Phase 3 Constraints: "MUST include inertia-advocate as a named role file under .roles/." Unconditional. |
...
| ID | Result | Evidence |
|----|--------|----------|
| C-06 | **PASS** | Phase 3 Constraints: "MUST create minimum 2 area subdirectories under .roles/." Sub-step AREA-GROUPING: "Each area becomes a subdirectory." |
...
| C-22 | **FAIL** | T2-IA-GATE uses `{{T2-PRESSURE}}/{{T2-VERDICT}}` slots inside a record block field — not a pre-print artifact skeleton. No skeleton for org-chart.md or .roles/ files with named {{}} slots. |
