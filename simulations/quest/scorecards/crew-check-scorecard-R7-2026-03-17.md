...
|----|-----------|--------|----------|
| C-01 | Role source traceability | PASS | `.craft/roles/` load gate, REVIEWER PRIORITY MANIFEST with role slots |
...
| ID | Criterion | Result | Evidence |
|----|-----------|--------|----------|
| C-01 | Role source traceability | PASS | `.craft/roles/` G1 gate, REVIEWER PRIORITY MANIFEST |
...
| ID | Criterion | Result | Evidence |
|----|-----------|--------|----------|
| C-01 | Role source traceability | PASS | `.craft/roles/` G1 gate |
