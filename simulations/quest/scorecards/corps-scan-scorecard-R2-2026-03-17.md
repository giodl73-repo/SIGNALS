...
| C-05 Does not write .craft/roles/ | Essential | **PASS** | "Do NOT write `.craft/roles/` files. Do NOT instruct the user to create role files. Do NOT include role file content." — leading constraint |
...
| C-05 Does not write .craft/roles/ | Essential | **PASS** | "corps-scan does not write `.craft/roles/` files. It does not describe what role files would contain." — stated unconditionally |
...
| C-05 Does not write .craft/roles/ | Essential | **PASS** | SCOPE CONSTRAINT block + Phase 3 PRECONDITION + checklist item; triple-layered |
...
| C-05 Does not write .craft/roles/ | Essential | **PASS** | "Non-negotiable scope: This skill does not write `.craft/roles/` files." |
...
| C-05 Does not write .craft/roles/ | Essential | **PASS** | Skill-wide constraint applies to all three roles; "Any role output containing role file content is a skill violation." ROLE 3 re-states it. |
