...
|----|-----------|---------|-----|---------------|
| C-01 | File written to correct path | PASS | 12 | Phase 5: write order for inertia-advocate and main role. Both paths to .craft/roles/{area}/. |
...
| ID | Criterion | Verdict | Pts | Evidence Note |
|----|-----------|---------|-----|---------------|
| C-01 | File written to correct path | PASS | 12 | "Write the companion file to .craft/roles/{area}/inertia-advocate.md" and main role write instruction present. |
...
| ID | Criterion | Verdict | Pts | Evidence Note |
|----|-----------|---------|-----|---------------|
| C-01 | File written to correct path | PASS | 12 | Phase 5 write order: inertia-advocate first (if generated), then .craft/roles/{area}/{subrole}.md. Both paths explicit. |
