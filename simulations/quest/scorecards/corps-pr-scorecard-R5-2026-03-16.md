...
| C-02 | **PASS** | Each role section has `Source files` and `Orientation: [one phrase from .craft/roles/]` |
...
| C-02 | **PASS** | Phase C role template: `Source files` + `Orientation: [one phrase from .craft/roles/]` |
...
| C-02 | **PASS** | 4C output template: `Source files` + `Orientation: [one phrase from .craft/roles/]` |
...
| C-02 | **PASS** | Phase C template: `Source files` + `Orientation: [one phrase from .craft/roles/]` |
