...
v3 adds two aspirational criteria (C-14 to C-15) extracted from Round 2 excellence
...
| Band | Essential (5x) | Recommended (3x) | Aspirational (7x) |
|------|---------------|-----------------|------------------|
| Points | 60 | 30 | 10 |
| Formula | pass/5 x 60 | pass/3 x 30 | pass/7 x 10 |
