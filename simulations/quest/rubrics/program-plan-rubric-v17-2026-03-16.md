# program-plan Rubric — v17

Evaluates a `program:plan` prompt against Signal's plugin contract and evidence-quality bar.
46 aspirational criteria, 4 essential, 3 recommended. Total max: **320 pts**.
...
## Aspirational Criteria (teaching quality — 210 pts)
...
| Aspirational | 230 pts | C-08 through C-53 (46 criteria) | 5 | 230 |

```
composite = (essential_pass/4 * 60)
          + (recommended_pass/3 * 30)
          + (aspirational_pass/46 * 230)
```

PASS = full points, PARTIAL = half points, FAIL = 0.

**Total max**: 60 + 30 + 230 = **320 pts**.
...
Aspirational: C-08 [ ]  C-09 [ ]  C-10 [ ]  C-11 [ ]
              ...
              C-48 [ ]  C-49 [ ]  C-50 [ ]  C-51 [ ]
              C-52 [ ]  C-53 [ ]
              Pass count: ___ / 46  ->  ___ / 46 * 230 = ___ pts  (of 230)

Composite score: ___ / 320
