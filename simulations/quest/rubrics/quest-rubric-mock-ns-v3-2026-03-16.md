...
**Reference scores under v3**:
- V-03/V-04 (enumerated prohibitions + named fields): all 6 aspirational = 100
- V-02 (generic superlative + "All three fields required" breakdown): 5/6 aspirational = ~98.3
- V-01 (step-label ordering, template only, no prohibition): 3.5/6 aspirational = ~95.8
