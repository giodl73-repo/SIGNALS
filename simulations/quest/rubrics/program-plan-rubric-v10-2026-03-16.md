# program-plan Rubric — v10

Evaluates a `program:plan` prompt against Signal's plugin contract and evidence-quality bar.
28 aspirational criteria, 4 essential, 3 recommended. Total max: **230 pts**.
...
| Aspirational | 140 pts | C-08 through C-35 (28 criteria) | 5 | 140 |

```
composite = (essential_pass/4 * 60)
          + (recommended_pass/3 * 30)
          + (aspirational_pass/28 * 140)
```
...
Aspirational: C-08 [ ]  C-09 [ ]  C-10 [ ]  C-11 [ ]
              ...
              C-28 [ ]  C-29 [ ]  C-30 [ ]  C-31 [ ]
              C-32 [ ]  C-33 [ ]  C-34 [ ]  C-35 [ ]
              Pass count: ___ / 28  ->  ___ / 28 * 140 = ___ pts  (of 140)

Composite score: ___ / 230
...
- **Scoring total is 230** (not 220) because the aspirational tier expanded from 26 to 28
