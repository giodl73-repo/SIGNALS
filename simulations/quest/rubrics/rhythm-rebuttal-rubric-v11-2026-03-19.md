v11 written to `simulations/quest/rubrics/rhythm-rebuttal-rubric-v11-2026-03-19.md`.

---

**What changed:**

Formula: `/28` → `/31`. Three new aspirational criteria:
...
**Structural chain**: C-37 completes C-34's accountability map. C-38 unifies the two repair surfaces into a named cross-reference. C-39 ensures the upstream block can be acted on in isolation without Phase 7 context. Each is strictly independent — a skill can pass two and fail the third.
aths as a complete, independently-resolvable unit — a skill can pass C-35 (upstream has (a)/(b)) but fail C-39 if the block requires Phase 7 context to interpret (e.g., failure condition and repair paths are separated, or the label is absent) |
...
| Aspirational (C-09–C-39) | 10 | (passed / **31**) × 10 |
