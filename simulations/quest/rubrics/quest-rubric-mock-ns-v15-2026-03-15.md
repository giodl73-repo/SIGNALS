...
Scoring denominator: aspirational 32 -> 35. Formula: `aspirational_pass / 35 * 10`.
...
| Band | Essential (5x) | Recommended (3x) | Aspirational (35x) |
|------|---------------|-----------------|-------------------|
| Points | 60 | 30 | 10 |
| Formula | pass/5 x 60 | pass/3 x 30 | pass/35 x 10 |
