# program-plan Rubric — v19

Evaluates a `program:plan` prompt against Signal's plugin contract and evidence-quality bar.
49 aspirational criteria, 4 essential, 3 recommended. Total max: **335 pts**.
...
| Aspirational | 245 pts | C-08 through C-56 (49 criteria) | 5 | 245 |

```
composite = (essential_pass/4 * 60)
          + (recommended_pass/3 * 30)
          + (aspirational_pass/49 * 245)
```

PASS = full points, PARTIAL = half points, FAIL = 0.

**Total max**: 60 + 30 + 245 = **335 pts**.
...
Aspirational: C-08 [ ]  C-09 [ ]  C-10 [ ]  C-11 [ ]
              ...
              C-52 [ ]  C-53 [ ]  C-54 [ ]  C-55 [ ]
              C-56 [ ]
              Pass count: ___ / 49  ->  ___ / 49 * 245 = ___ pts  (of 245)

Composite score: ___ / 335
...
- **C-56 is aspirational** because echoing the mandate at the application site requires the
  ...
  independent exposures make non-compliance structurally improbable.
