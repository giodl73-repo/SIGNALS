# campaign-decide-rubric-v17-2026-03-17.md

**Quest**: campaign-decide
**Version**: v17
**Date**: 2026-03-17
**Denominator**: /36 aspirational (18.0 pts total — 0.5 pts each)
**Max composite**: 108.0
...
| Aspirational | C-09..C-44 | 0.5 | 18.0 | Raise the bar |
| **Max composite** | | | **108.0** | |
...
**C-45 candidate (R17 Excellence Signal — V-04):** Combined preamble-time temporal encoding
(C-43) and per-phase minimum evidence budgets (C-44) in a single variation, confirming the
two axes are independent and additive — no interaction degradation when both are present
simultaneously.
