...
|------|---------------------------------------|---------------|-------------|
| C-01 | All 6 EXIT SIGNALs declared in order  | essential     | correctness |
| C-02 | All 6 artifacts written + confirmed   | essential     | behavior    |
| C-03 | Session Invariant D verbatim at S2/3/4| essential     | correctness |
| C-04 | Synthesis verdict + confidence present| essential     | correctness |
| C-05 | Null tally chain cross-checked        | essential     | correctness |
| C-06 | Gate S scout loader executes          | recommended   | coverage    |
| C-07 | Handoff table 11 fields + derivations | recommended   | format      |
| C-08 | Counter-hypothesis resolved with verdict | recommended | depth      |
| C-09 | Atomic dual-lock fires when warranted | aspirational  | behavior    |
| C-10 | Incumbent displacement framing throughout | aspirational | depth     |
