# Rubric: trace-deployment (v14)

**Skill**: `trace:deployment`
**Version**: 14 (updated from R17 scorecard — C-35 and C-36 promoted from R17 excellence patterns;
C-35 codifies the inertia-section-c12-not-c23 distinction: a standalone STATUS QUO baseline section
is placement-agnostic for C-12 but never satisfies C-23's role-block-specific placement requirement,
regardless of content depth; C-36 codifies the interrogative-headers-exclusive-register confirmation:
formal all-caps headers deactivate C-21, C-26, C-33, and C-34 simultaneously, confirming register is
the sole activating condition for those four criteria; total rises from 220 to 230;
prose structural-adoption ceiling rises from 175 to 180)
**Date**: 2026-03-15
**Criteria**: 36 across 4 tiers | **Total**: 230 pts
...
## Aspirational Criteria (140 pts — structural excellence)
...
|------|---------|--------------------------|
| Template | 170/230 | C-14, C-16, C-18, C-21, C-22, C-24, C-26, C-27, C-28, C-35 reachable; C-15, C-17, C-29, C-30, C-31, C-32, C-33, C-34, C-36 blocked |
| Prose (structural adoption) | 180/230 | C-14, C-15, C-21, C-26, C-29, C-30, C-31, C-33, C-34, C-35 reachable; C-16, C-17, C-22, C-24, C-27, C-28, C-32, C-36 blocked |
| Prose (compression) | 165/230 | C-15, C-17, C-19, C-20, C-25, C-29, C-30, C-31, C-32, C-35 reachable; C-14, C-16, C-21, C-22, C-24, C-26, C-27, C-28, C-33, C-34, C-36 blocked |
...
**Summary of v13 → v14 changes:**

| Change | Detail |
|--------|--------|
| **C-23 note added** | Explicit cross-reference to C-35 added: "Role-block placement is the distinguishing condition: incident narrative in a standalone STATUS QUO section does not satisfy C-23 regardless of content depth — see C-35" |
| **C-35 added** | inertia-section-c12-not-c23: standalone STATUS QUO section activates C-12 (placement-agnostic) but never activates C-23 (role-block-specific); content depth irrelevant |
| **C-36 added** | interrogative-headers-exclusive-register: formal all-caps headers deactivate C-21, C-26, C-33, C-34 simultaneously; register is sole activating condition; net −15 vs interrogative-register equivalent |
| Total | 220 → 230 |
| Aspirational total | 130 → 140 (28 criteria at 5 pts each) |
| Prose structural-adoption ceiling | 175/220 → 180/230 (C-35 reachable) |
| Template ceiling | 165/220 → 170/230 (C-35 reachable; C-36 blocked on ceiling path) |
| Prose compression ceiling | 160/220 → 165/230 (C-35 reachable) |
| Formal-header variant | New path row added; C-36 accessible at net −15 vs colloquial equivalent |
