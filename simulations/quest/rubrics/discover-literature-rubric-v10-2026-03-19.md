Written to `simulations/quest/rubrics/discover-literature-rubric-v10-2026-03-19.md`.

---

**Summary of v10 changes:**

**New criterion — C-27 Inertia Status Lifecycle Integration** (V-05 R9)
- Source: the Phase 1 COMPLETE: token gaining `inertia_committed=[yes]` alongside its N-of-4 counter annotation, plus INERTIA VERIFICATION in Phase 4
- What it closes: C-14 compliance is verifiable from the inertia blocks; C-27 makes it verifiable from the lifecycle token layer too — a cross-axis signal requiring no extra blocks to read
- Dependency chain: `C-14 + C-23 -> C-27`
- Key design property: additive, not displacing — status fields coexist with N-of-4 counters and all prior annotation content

**New key decision — C-26 heading-agnosticism confirmed** (V-03 R9)
- "Dual-Path Redundancy Proof" satisfies C-26 identically to "C-24 Independence Verification"
- Only structural elements (a)-(d) are binding; the heading label is not
- Completes the agnosticism meta-pattern: C-22 token-agnostic (R7), C-21 label-independent (R6), C-26 heading-agnostic (R9)

**Scoring delta:**

| | v9 | v10 |
|--|----|----|
| Aspirational criteria | 18 | 19 |
| Aspirational ceiling | 90 pts | 95 pts |
| Total ceiling | 180 | **185** |
23 -> C-27`

**Nine-axis aspiration progression:**
...
**Ceiling trajectory**: v1: 120 -> v2: 125 -> v3: 130 -> v4: 140 -> v5: 150 -> v6: 155 -> v7: 160 -> v8: 170 -> v9: 180 -> **v10: 185**

| Tier | Criteria | Pts each | Total |
|------|----------|----------|-------|
| Essential | C-01..C-05 | 12 | 60 |
| Recommended | C-06..C-08 | 10 | 30 |
| Aspirational | C-09..C-27 | 5 | 95 |
| **Total** | | | **185** |
...
## ASPIRATIONAL Criteria (95 points -- raise the bar once essential/recommended are stable)
