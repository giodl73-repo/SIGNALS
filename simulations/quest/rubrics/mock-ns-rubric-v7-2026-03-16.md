Written to `simulations/quest/rubrics/mock-ns-rubric-v7-2026-03-16.md`.

---

**v7 summary: 2 new criteria, 2 new failure traps**
...
- **C-25** (from V-05 vs V-01): Both pass C-23 (gate as opening sentence). V-01 uses single-sentence imperative: "Before any other step begins, emit the TOPICS.md status line below." V-05 uses two-sentence form: "This step emits first. Write the TOPICS.md status line before any other work begins." The declarative sentence ("This step emits first") asserts the step's ROLE — the emit is the step's defining function, not a conditional precondition. C-23 is a structural requirement; C-25 is a semantic one.

- **C-26** (from V-05 vs V-02/V-03): All three pass C-24 (5-op CONSTRAINT). V-02/V-03 use canonical phrase forms verbatim. V-05 uses synonym forms throughout: "No lookup of skill categories / No skill-id resolution / No mock content generation / No artifact body construction / No artifact path assembly or file output." Synonym vocabulary demonstrates prohibition-by-concept — the spec cannot be satisfied by exact-match phrase compliance.

**Two new failure traps:**
- "CONSTRAINT before gate" (V-02/V-04): CONSTRAINT-first inverts the logical structure — defense before barrier — fails C-23
- "One-sentence gate satisfies C-23, misses C-25" (V-01): single imperative passes C-23, fails C-25

**Two new discriminator notes** added to C-23 and C-24: "C-23 passing does not imply C-25 passing" and "C-24 passing does not imply C-26 passing."

**Scoring**: max rises from 112 to **116** (18 aspirational × 2 = 36). V-05 (R6) scores 116/116 — only variate to pass both C-25 and C-26. V-01/V-02/V-03 each score 110/116. V-04 scores 108/116.
attern): CONSTRAINT-first inverts the logical structure; CONSTRAINT is defense-in-depth, not the primary barrier -- placing it first displaces the gate and fails C-23
