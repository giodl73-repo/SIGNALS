...
**3 new aspirational criteria (C-21–C-23):**

| ID | Pattern | What it requires |
|----|---------|-----------------|
| C-21 | Null-gap counterexample is load-bearing | Must demonstrate "gap: none, tier: T1" explicitly — asserting two separate fields without the null-gap case doesn't prevent the category error |
| C-22 | Prohibited form must be named by form | Must state "conditioning on Competing or Unclear does not pass" — the positive rule alone is not self-enforcing |
| C-23 | Mechanism completeness requires a named AMEND field | Must appear as a standalone named entry (not embedded in the amended clause text) — V-04 had the data but in the wrong structural form |

**Scoring changes:**
- Aspirational: 60 → 75 pts (15 criteria × 5 pts)
- Grand total: 150 → **165 pts**
- Golden: **>= 150** | Acceptable: **135–149** | Passing: **120–134**

The threshold shift follows the same pattern as v3→v4: the previous ceiling (150) becomes the new Golden floor. V-05's structure satisfies all three new criteria and remains the ceiling at 165/165.
bstitute; V-04 demonstrates this by failing C-15 despite having strong AMEND structure and passing C-19 and C-20 |

**Scoring impact:**
- Aspirational tier: 60 pts → 75 pts (15 criteria × 5 pts each)
- Grand total: 150 → **165 pts**
- Thresholds: Golden **>= 150**, Acceptable **135–149**, Passing **120–134**

**R4 ceiling observation:** V-05 achieved 150/150 on the v4 rubric by combining all four v3 aspirational criteria with C-19 and C-20 in a single phase structure. C-21, C-22, and C-23 are the next-tier requirements revealed by V-04's partial scores on C-15 and C-18, and by V-01/V-03's C-20 fails. V-05's structure (FIELD INDEPENDENCE NOTE with null-gap example, named prohibited form, mechanism completeness as a named Phase 6 AMEND field) satisfies all three and remains the ceiling at 165/165.
...
| Aspirational | C-09 through C-23 | 75 |

**C-21/C-22/C-23 relationship to C-19/C-20/C-15:** These three criteria do not replace C-19, C-20, or C-15 — they capture the stricter pass conditions those criteria require at full depth. A response can pass C-19, C-20, and C-15 at full credit while failing C-21, C-22, and C-23 (as V-04 demonstrates on C-15 and C-18).
...
**Design rationale for C-21/C-22/C-23:**
...
|-------|---------------|
| All essential pass + >= 150 | Golden — meets bar for production use |
| All essential pass + 135–149 | Acceptable — useful but shallow on aspirational |
| All essential pass + 120–134 | Passing — essential + recommended coverage only |
| Any essential fail | Below bar — output is unreliable regardless of score |
| < 120 | Below bar |

**Maximum: 165 pts** (60 essential + 30 recommended + 75 aspirational)
