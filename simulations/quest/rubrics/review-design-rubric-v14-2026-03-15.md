# review-design Rubric — v14

**Skill**: `review-design`
**Rubric version**: v14 (C-01 through C-44, denominator 37)
**Extracted from**: R14 scorecard (2026-03-15)
...
- **Pass condition**: Every named halt that fires on a cross-block reference mismatch specifies
  ...
  cross-block reference mismatch halts in the identity-integrity chain (F-10, F-15, F-16, F-17,
  F-28) where both resolution directions are architecturally valid. Halts on structural absence
  (F-01, F-04) or count parity (F-09, F-12) are exempt -- those failure modes have a single
  unambiguous repair path.
...
Note: aspirational denominator changed from 35 to 37 in v14 (added C-43, C-44). Each
aspirational criterion contributes ~0.270 points at full pass.
