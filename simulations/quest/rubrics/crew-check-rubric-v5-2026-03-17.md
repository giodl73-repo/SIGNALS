...
The skill includes an explicit lens-anchor step as a named execution phase before findings are written. The step quotes or paraphrases the role's orientation frame from its `.roles/` definition.
