# program-plan Rubric — v18

Evaluates a `program:plan` prompt against Signal's plugin contract and evidence-quality bar.
47 aspirational criteria, 4 essential, 3 recommended. Total max: **325 pts**.
...
| Aspirational | 235 pts | C-08 through C-54 (47 criteria) | 5 | 235 |

```
composite = (essential_pass/4 * 60)
          + (recommended_pass/3 * 30)
          + (aspirational_pass/47 * 235)
```

PASS = full points, PARTIAL = half points, FAIL = 0.

**Total max**: 60 + 30 + 235 = **325 pts**.
...
Aspirational: C-08 [ ]  C-09 [ ]  C-10 [ ]  C-11 [ ]
              ...
              C-48 [ ]  C-49 [ ]  C-50 [ ]  C-51 [ ]
              C-52 [ ]  C-53 [ ]  C-54 [ ]
              Pass count: ___ / 47  ->  ___ / 47 * 235 = ___ pts  (of 235)

Composite score: ___ / 325
