...
**v24 changes from v23 (v5 from v4)**: Added C-18 (SLA-Absent Escape Valve) as a new aspirational criterion extracted from R4 excellence signals. Sourced from V-03 C-16: the `SLA-ABSENT` escape valve that creates a three-way outcome for the breach-link field -- typed ID / declared-absent / empty -- preventing the C-16 hard-dependency fail condition from firing in legitimately SLA-free scenarios. Aspirational pool expands from 45 pts (9 criteria) to 50 pts (10 criteria); max composite rises from 135 to 140. Golden threshold unchanged.
...
```
score = (essential_pass/5 * 60) + (recommended_pass/3 * 30) + (aspirational_pass/10 * 50)
```
...
> Raise the bar once essential and recommended are stable. C-09 through C-13 added in v21; C-14 and C-15 added in v22; C-16 and C-17 added in v23; C-18 added in v24.
...
(5/5 * 60) + (3/3 * 30) + (0/10 * 50) = 60 + 30 + 0 = 90 -- golden

**All essential pass, 2/3 recommended, no aspirational**:
(5/5 * 60) + (2/3 * 30) + (0/10 * 50) = 60 + 20 + 0 = 80 -- golden (threshold met)

**4/5 essential pass, all recommended pass, all aspirational**:
(4/5 * 60) + (3/3 * 30) + (10/10 * 50) = 48 + 30 + 50 = 128 -- NOT golden (essential incomplete)

**All essential pass, 1/3 recommended, all aspirational**:
(5/5 * 60) + (1/3 * 30) + (10/10 * 50) = 60 + 10 + 50 = 120 -- golden

**All essential + all recommended + all aspirational**:
(5/5 * 60) + (3/3 * 30) + (10/10 * 50) = 60 + 30 + 50 = 140 -- golden (max)

**R4 V-01 equivalent (all essential + recommended + C-17 partial + C-09-C-16/C-18 pass)**:
(5/5 * 60) + (3/3 * 30) + (9.5/10 * 50) = 60 + 30 + 47.5 = 137.5 -- golden

**R4 V-02 equivalent (all essential + recommended + C-16 partial + C-09-C-15/C-17/C-18 pass)**:
(5/5 * 60) + (3/3 * 30) + (9.5/10 * 50) = 60 + 30 + 47.5 = 137.5 -- golden

**R4 V-03 equivalent (all essential + recommended + C-17 partial + C-09-C-16/C-18 pass)**:
(5/5 * 60) + (3/3 * 30) + (9.5/10 * 50) = 60 + 30 + 47.5 = 137.5 -- golden

**R3 V-01/V-02/V-03 equivalent under v24 (8.5 aspirational, C-18 not assessed)**:
(5/5 * 60) + (3/3 * 30) + (8.5/10 * 50) = 60 + 30 + 42.5 = 132.5 -- golden

**R2 V-02 equivalent (all essential + C-07 partial + aspirational C-09-C-15 pass; C-16/C-17/C-18 not assessed)**:
(5/5 * 60) + (2.5/3 * 30) + (7/10 * 50) = 60 + 25 + 35 = 120 -- golden
