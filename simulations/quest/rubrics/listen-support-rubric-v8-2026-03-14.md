Written to `simulations/quest/rubrics/listen-support-rubric-v8-2026-03-14.md`.

---

**What changed v7 -> v8:**

One new criterion extracted from the R7 above-ceiling signal:

| ID | Name | Tightens | Who satisfies |
|----|------|----------|---------------|
| C-27 | Named Inertia Competitor Phase Framing | C-11 | V-03, V-05 |

**Tier:** Aspirational 18 / 90 pts → 19 / 95 pts. Total ceiling **180 → 185**.

**C-27 structural logic — three independently testable properties:**

1. **Tool-name fidelity** — STATUS QUO names the inertia competitor by product name. Grep-checkable; "existing tooling" does not pass.
2. **Phase-differentiated body templates** — instructions explicitly state two stances by adoption-curve position: P1 template names dual-tool tension ("I still have [tool] open..."); P3 template names parity gap ("In [tool] I could do X; here I cannot."). Testable at the sentence level.
3. **Switching-friction gap reframe** — at least one gap framed as a migration barrier naming the competitor. Produces a qualitatively different gap inventory from the doc/design/operational taxonomy C-04 requires.

**Why C-11 is insufficient:** C-11 passes with any concrete scenario that anchors volume and body content. A STATUS QUO can describe parallel tool usage, justify high volume, and produce traceable body framing without ever naming the competing tool, differentiating templates by phase, or reframing gaps as switching-friction. All three C-27 properties are above C-11's pass ceiling and all three are structurally independent of each other.
ifferentiated body templates + switching-friction gap reframe. The adoption curve is the structural scaffolding that makes phase-differentiated volume and severity emerge from the scenario rather than from post-hoc calibration.
...
## Aspirational Criteria (95 pts total -- raises the bar above 90)
...
**Essential ceiling**: 60 | **Recommended ceiling**: 90 | **Aspirational ceiling**: 185
