Reading the scorecard carefully to extract what's structurally new in V-02 and V-03 beyond what C-27 already captures.

**V-01** — establishes PRE-COMMIT BLOCK placement discipline (already the basis for C-27)

**V-02** — distinctive pattern: WS-blocks are *first-class section headers* in the document structure, not embedded in phase lists or schema definitions; independently navigable without read-through

**V-03** — two new patterns:
1. **WRITE SURFACE REGISTER** — an upfront declaration table listing all three sites before any phase, creating a verifiable contract
2. **Milestone annotation linkage** — each WS-block cites which register entry it fulfills, closing the contract loop

That yields three new criteria: C-28, C-29, C-30.

---

## Rubric — topic:plan (v8)

**5 essential / 3 recommended / 22 aspirational — 30 criteria total**
...
**Formula**: `(essential/5 × 60) + (recommended/3 × 30) + (aspirational/22 × 10)`
