...
## Rubric: org-chart -- v19

**10 essential/recommended criteria + 43 aspirational. Golden = all 5 essential pass + composite >= 80.**
...
**Total: 305 pts. Golden = all 5 essential pass + composite >= 80 (>= 244/305).**
...
A variation satisfying C-50 necessarily satisfies C-09. C-50 governs the explicit prohibition of structural-ordering devices as rationale substitutes; C-09 governs rationale presence and outcome-basis.
