...
Uncapped maximum across 38 criteria is 76; the cap rewards breadth while holding the composite
ceiling at 100.
...
| Aspirational | 10% | C-09 through C-46 | PASS=2, PARTIAL=1, FAIL=0; capped at 10 |
...
**Ceiling references under v15:**
- R15 V-01 (C-44/C-46 FAIL; C-45 FAIL): 70/76 uncapped
  -> composite = 60 + 30 + 10 = **100** (capped)
- R15 V-02 (C-44/C-46 FAIL; C-45 FAIL): 70/76 uncapped
  -> composite = **100** (capped)
- R15 V-04 (C-44/C-46 FAIL; C-45 PASS): 72/76 uncapped
  -> composite = **100** (capped)
- R15 V-03 (C-45 PASS; C-46 PASS; C-15 PARTIAL costs -1): 73/76 uncapped
  -> composite = **100** (capped)
- R15 V-05 (all 38 criteria PASS): 76/76 uncapped
  -> composite = **100** (new uncapped ceiling: 76/76 -- first perfect score under v15)
- Open for R16: C-44 PASS for V-01/V-02/V-04 (inline gap notation; formal registry absent);
  C-45 PASS for V-01/V-02 (completeness block absent); C-46 follows C-44 for V-01/V-02/V-04.
