Reading the scorecard for extractable excellence patterns:

1. **V-03 C-23 PARTIAL** — code-fence pipe-aligned block sits on the "or equivalent" boundary and is flagged "at risk." Excellence signal: native markdown table syntax, not code-fenced text. → **C-24**

2. **V-04 architectural pattern** — "TOKEN required by declared value in every gate output field" — stronger than C-11 (downstream findings) and C-13 (portable identifier). Every gate's output *specification* names TOKEN as a required element by its declared value. → **C-25**

Aspirational tier: 15 → 17 criteria, 10/17 ≈ 0.588 pts each.
...
## Aspirational Criteria (weight = 10 points total, 0.588 points each)
...
| Aspirational | C-09 -- C-25 | 0.588 | 10 |
| **Max composite** | | | **100** |
