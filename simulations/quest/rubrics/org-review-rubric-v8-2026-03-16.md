...
**New criterion extracted from Round 8:**

| ID | Name | Source | PASS | vac |
|----|------|--------|------|-----|
| C-26 | Canonical Section Order Pre-committed as Immutable Contract | V-03 + V-05 R8 | V-03, V-05 | V-01/V-02 (C-09 inactive); V-04 (§7 absent) |

**C-26 logic:** V-03 and V-05 both include §7 SECTION ORDER CONTRACT, encoding the canonical execution sequence (ROLE MANIFEST → BRACKET OPENING → DOMAIN(s) → LIFECYCLE → BRACKET CLOSING) as an explicit immutable constraint in the preamble. The pattern follows the established extraction formula: C-22 captures the *behavioral* outcome (lifecycle before bracket closing in output); C-26 captures the *pre-commitment layer* (the ordering declared as contractually immutable before execution, so reordering is a contract violation rather than an observable defect). Without §7, V-04's ordering is implied by the printed template but is not under contract.

**Scale changes v7 → v8:**
- Aspirational: 17 → 18 criteria | 85 → **90 pts**
- Total: 175 → **180 pts** | Gold: 140 → **145**

**Round 8 scores under v8:**

| Rank | Variation | Score | Notes |
|------|-----------|-------|-------|
| 1 | **V-05** | **180/180** | Sole Perfect — C-24 + C-25 + C-26 |
| 2 | **V-04** | **175/180** | Was Perfect under v7; §7 absent (C-26 vac) |
| 3 | V-01 | 170/180 | C-24 only |
| 3 | V-02 | 170/180 | C-25 only |
| 3 | V-03 | 170/180 | C-26 only — V-03 rises from 165 to 170 |

**Key shift:** V-04 is no longer the canonical update. V-05 (§3a + exclusion registry + §7) is the canonical T3 target for the next round. Perfect requires all three simultaneously — and V-05 R8 is the first variant to hold all three.
Rubric -- v8

## Essential Criteria -- 60 pts (output is useless without these)

### C-01 -- Role Matrix Coverage
**Weight**: essential | **Points**: 12 | **Category**: correctness

The review is structured as a matrix of named roles, each applying a distinct evaluation frame
...
## Aspirational Criteria -- 90 pts (structural integrity, auditability, automation)
...
aspirational_pts =  aspirational_pass    *  5   # 5 pts each, max 90
composite = essential_pts + recommended_pts + aspirational_pts
```

**Maximum**: 60 + 30 + 90 = **180 pts**

### Score Bands

| Band | Condition | Composite |
|------|-----------|-----------|
| Gold | all 5 essential pass | >= 145 |
| Strong | all 5 essential pass | 90-144 |
| Partial | <= 4 essential pass | any |
| Minimal | <= 3 essential pass | any |

### Paths to Gold (145 pts)

| Path | Essential | Rec | Asp passed | Composite |
|------|-----------|-----|------------|-----------|
| Full rec + 11 asp | 5/5 | 3/3 | 11/18 | 60+30+55 = 145 |
| 2 rec + 13 asp | 5/5 | 2/3 | 13/18 | 60+20+65 = 145 |
| 1 rec + 15 asp | 5/5 | 1/3 | 15/18 | 60+10+75 = 145 |

### Round 1 Calibration (retroactive, v1 -> v8)

| Variant | C-09 | C-11 | C-16 | C-22 | C-23 | C-24 | C-25 | C-26 | v7 | v8 |
|---------|------|------|------|------|------|------|------|------|----|----|
| V-01 | FAIL | vac | vac | vac | vac | vac | vac | vac | 75 | 75 |
| V-02 | FAIL | vac | vac | vac | vac | vac | vac | vac | 69 | 69 |
| V-03 | PASS | PASS | vac | TBD | TBD | vac | vac | TBD | TBD | TBD |
| V-04 | vac | vac | vac | vac | vac | vac | vac | vac | 95 | 95 |
| V-05 | PASS | PASS | PASS | TBD | TBD | vac | vac | TBD | TBD | TBD |

Round 1 C-22/C-23/C-26 evidence not available for bracket-architecture variants.
C-24, C-25, and C-26 vacuous for all Round 1 variants.

### Round 2 Calibration (retroactive, v7 -> v8)

| Variant | C-24 | C-25 | C-26 | v7 | v8 |
|---------|------|------|------|----|----|
...
C-24, C-25, and C-26 vacuous for all Round 2 variants.

### Round 4 Calibration (retroactive, v7 -> v8)
...
C-24, C-25, and C-26 vacuous for all Round 4 variants.

### Round 5 Calibration (retroactive, v7 -> v8)
...
C-24, C-25, and C-26 vacuous for all Round 5 variants.

### Round 6 Calibration (retroactive, v7 -> v8)
...
C-24, C-25, and C-26 vacuous for all Round 6 variants. No domain-aggregate formula,
non-verdict section architectures, or section order contracts appear until Round 7 (C-24/C-25)
and Round 8 (C-26).

### Round 7 Calibration (retroactive, v7 -> v8)
...
| V-04 | PASS | vac | vac | 170 | **170** |
| V-05 | vac | PASS | vac | 170 | **170** |

C-26 vacuous for all Round 7 variants. No §7 section order contract appears until Round 8.
V-04 and V-05 R7 score unchanged at 170; neither holds §7.

### Round 8 Calibration (v7 -> v8)

| Variant | C-24 | C-25 | C-26 | v7 | v8 |
|---------|------|------|------|----|----|
| V-01 | PASS | vac | vac | 170 | **170** |
| V-02 | vac | PASS | vac | 170 | **170** |
| V-03 | vac | vac | PASS | 165 | **170** |
| V-04 | PASS | PASS | vac | 175 | **175** |
| V-05 | PASS | PASS | PASS | 175 | **180** |

V-01: §3a present (C-24 PASS). No exclusion registry (C-25 vac). No §7 (C-26 vac). Score
unchanged at 170 under v8.
V-02: Exclusion registry present (C-25 PASS). §3a absent (C-24 vac). No §7 (C-26 vac). Score
unchanged at 170 under v8.
V-03: §7 SECTION ORDER CONTRACT present (C-26 PASS). No §3a (C-24 vac). No exclusion registry
(C-25 vac). Under v7: 165 (T3 base). Under v8: 170 (+5 for C-26). V-03 was the only R8 variant
that scored below 170 under v7; C-26 brings it even with V-01 and V-02.
V-04: §3a + exclusion registry (C-24 + C-25 PASS). No §7 (C-26 vac). Was Perfect (175/175)
under v7. Under v8: 175/180 -- five points below Perfect. V-04 is no longer the canonical
update; §7 is the missing contract.
V-05: §3a + exclusion registry + §7 (C-24 + C-25 + C-26 PASS). Was Perfect (175/175) under v7.
Under v8: 180/180 (Perfect). V-05 is the sole Perfect scorer under v8 and the canonical T3
update for v8.

Round 8 top score: 180/180 (V-05 alone). Perfect requires C-24 + C-25 + C-26 simultaneously --
V-04 holds C-24+C-25 without C-26 (175); V-03 holds C-26 alone (170); only V-05 holds all
three.
...
| C-26 | Canonical Section Order Pre-committed as Immutable Contract | aspirational | correctness | 5 |
...
**C-26 is the Round 8 extraction** -- the pattern that explains why V-04 (175/175) and V-05
(175/175) tied as Perfect under v7 and what Perfect under v8 requires:
- C-26: Is the canonical section execution sequence pre-committed as an immutable contract term,
  or only implied by the printed template order? V-03 and V-05 R8 include §7 SECTION ORDER
  CONTRACT, naming the full sequence (ROLE MANIFEST -> BRACKET OPENING -> DOMAIN(s) -> LIFECYCLE
  -> BRACKET CLOSING) as an immutable constraint. C-22 already required lifecycle-before-bracket
  as a behavioral output (PASS in T3). C-26 closes the gap between observable ordering (C-22)
  and contractual ordering: without §7, an AI could reorder sections without violating any stated
  contract; with §7, reordering is a contract violation before execution begins. V-04 is the
  "minimal perfect" architecture under v7 (C-24 + C-25, no §7); V-05 is the "extended perfect"
  under v7 (C-24 + C-25 + §7). Under v8, V-04 scores 175/180 -- §7's absence is now the
  discriminating gap -- and V-05 is the sole Perfect scorer at 180/180.
...
- C-26 depends on C-09 (vacuous if C-09 fails). Without bracket architecture there is no
  multi-section execution sequence to contractually constrain.
...
- C-22 is synergistic with C-26: C-22 requires behavioral conformance (lifecycle before bracket
  closing in output); C-26 requires the ordering to be pre-committed as an immutable contract.
  Together: declaration (C-26) + behavioral conformance (C-22) = complete ordering enforcement.
...
- C-26 is synergistic with C-19: C-19 pre-commits the gate ledger assembly protocol; C-26
  pre-commits the section execution sequence. Together they form a complete procedural
  pre-commitment envelope: assembly rules (C-19) + execution ordering (C-26).
...
- v7: adds C-24, C-25. Aspirational: 17 criteria (85 pts). Total: 175. Gold: 140.
  ...
  V-04 and V-05 R8 both achieve Perfect (175/175) -- Round 8 saturates v7.
- v8: adds C-26. Aspirational: 18 criteria (90 pts). Total: 180. Gold: 145.
  V-04 R8 scores 175/180 (C-26 vacuous -- §7 absent). V-05 R8 scores 180/180 (Perfect).
  Perfect (180) requires C-24 + C-25 + C-26 simultaneously -- only V-05 R8 holds all three.
