...
| C-02 | Role-loaded perspective (from .craft/roles/) | essential | correctness |
...
**Design decisions:**
- C-02 targets the core differentiator of org-rob: roles loaded from `.craft/roles/` must visibly shape findings, not produce generic output any reviewer would write
