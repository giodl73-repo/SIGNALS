**v11 rubric written** to `simulations/quest/rubrics/discover-causal-rubric-v11-2026-03-17.md`.

---

## What changed: v10 -> v11

**2 new criteria: C-32 and C-33** from the R10 V-05 candidate signals.

**C-32: C-31 structural requirement named at Phase 6 synthesis** (parallel to C-29)

V-05 R10's Phase 6 integration rule explicitly names the C-31 structural requirement -- that the Phase 3 CONDITIONAL BRANCH must carry the prohibited form. Just as C-29 requires Phase 6 to name the C-26 "first-appearance-at-synthesis" violation, C-32 requires Phase 6 to name the C-31 "Phase 3 update does not close Phase 6" requirement. A response can pass C-31 while failing C-32: Phase 3 carries the prohibited form; Phase 6 never names that structural requirement at synthesis.

**C-33: Phase 3 prohibited-form status tracked as ARTIFACT field** (parallel to `anchor_updated_from_phase1` in C-30)

V-05 R10 adds `phase3_anchor_update_prohibited_form: true | false | n/a` to the ARTIFACT frontmatter. This pairs with the `anchor_updated_from_phase1` field (C-30) to give a complete machine-readable audit of the anchor update path. Gradeability requires C-30 PASS (same N/A condition as C-30/C-31), but C-33 is gradeable even when C-31 fails -- a C-31 FAIL response should carry `false`, not omit the field.

**The enforcement chain is now complete:**

| Production point | Requirement | Prohibited form | Synthesis integrity rule | ARTIFACT field |
|-----------------|-------------|-----------------|--------------------------|----------------|
| Phase 1 | C-26 | C-27 | C-29 (Phase 6 names C-26) | -- |
| Phase 3 | C-30 | C-31 | C-32 (Phase 6 names C-31) | C-33 |
| Phase 6 | C-30 (stale-anchor rule) | -- | -- | C-30 (`anchor_updated_from_phase1`) |

**Scoring:** 25 aspirational × 5 = 125 pts | Total **215 pts** | Golden **>= 205** | Acceptable **190-204** | Passing **175-189**

| Variation | v10 | C-32 | C-33 | v11 | Tier |
|-----------|-----|------|------|-----|------|
| V-01..V-04 | 195 | N/A | FAIL | **190** | Acceptable |
| V-05 | 205 | PASS | PASS | **215** | Golden (ceiling) |
| -- |
| Phase 3 | C-30 (Phase 6 carries updated step) | C-31 (prohibited form at Phase 3) | C-32 (Phase 6 names C-31 rule) | C-33 (field in ARTIFACT) |
| Phase 6 | C-30 (stale-anchor integration rule) | -- | -- | C-30 (`anchor_updated_from_phase1`) |

**Scoring update:**
- Aspirational: 115 -> 125 pts (25 criteria x 5 pts)
- Total: 205 -> **215 pts**
- Golden **>= 205** | Acceptable **190-204** | Passing **175-189**
- Previous ceiling (205) = new Golden floor

**R10 scores under v11:**

| Variation | v10 score | C-32 | C-33 | v11 score | Tier |
|-----------|---------|------|------|-----------|------|
| V-01 | 195 | N/A (C-31 FAIL) | FAIL | **190** | Acceptable |
| V-02 | 195 | N/A (C-31 FAIL) | FAIL | **190** | Acceptable |
| V-03 | 195 | N/A (C-31 FAIL) | FAIL | **190** | Acceptable |
| V-04 | 195 | N/A (C-31 FAIL) | FAIL | **190** | Acceptable |
| V-05 | 205 | PASS | PASS | **215** | Golden (ceiling) |

C-32 is N/A for V-01 through V-04 because C-31 FAIL makes C-32 not gradeable. C-33 is gradeable for all five variations (C-30 PASS in all) -- V-01 through V-04 fail it (no ARTIFACT field), losing 5 pts from their v10 score.
...
## Aspirational Criteria (125 pts total)
...
The distinction from C-26, C-28, C-29, C-31, C-32, and C-33:
...
A response can pass C-26, C-27, C-28, and C-29 while failing C-30: all cross-phase integrity rules are named, Phase 1 and Phase 3 are correctly sequenced, but Phase 6 silently carries the Phase 1 step when Phase 3 upgraded it. A response can pass C-30 while failing C-31: Phase 6 names the stale-anchor failure mode, but Phase 3 never names that its own update record is insufficient to satisfy Phase 6. A response can pass C-31 while failing C-32: Phase 3 carries the prohibited form, but Phase 6 never names that C-31 structural requirement at synthesis. A response can pass C-30 while failing C-33: anchor provenance ARTIFACT field present, but Phase 3 co-location status field absent.
...
|-------|---------------|
| All essential pass + >= 205 | Golden -- meets bar for production use |
| All essential pass + 190-204 | Acceptable -- useful but shallow on aspirational |
| All essential pass + 175-189 | Passing -- essential + recommended coverage only |
| Any essential fail | Below bar -- output is unreliable regardless of score |
| < 175 | Below bar |

**Maximum: 215 pts** (60 essential + 30 recommended + 125 aspirational)
