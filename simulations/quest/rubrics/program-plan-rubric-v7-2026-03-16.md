# program-plan Rubric — v7

Evaluates a `program:plan` prompt against Signal's plugin contract and evidence-quality bar.
20 aspirational criteria, 4 essential, 3 recommended. Total max: **190 pts**.
...
## Aspirational Criteria (teaching quality — 100 pts)
...
| Aspirational | 100 pts | C-08 through C-27 (20 criteria) | 5 | 100 |

```
composite = (essential_pass/4 * 60)
          + (recommended_pass/3 * 30)
          + (aspirational_pass/20 * 100)
```
...
Aspirational: C-08 [ ]  C-09 [ ]  C-10 [ ]  C-11 [ ]
              ...
              C-20 [ ]  C-21 [ ]  C-22 [ ]  C-23 [ ]
              C-24 [ ]  C-25 [ ]  C-26 [ ]  C-27 [ ]
              Pass count: ___ / 20  ->  ___ / 20 * 100 = ___ pts  (of 100)

Composite score: ___ / 190
...
- **Scoring total is 190** (not 175) because the aspirational tier expanded from 17 to 20
