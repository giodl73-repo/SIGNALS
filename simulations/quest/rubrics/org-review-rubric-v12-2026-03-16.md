Written to `simulations/quest/rubrics/org-review-rubric-v12-2026-03-16.md`.

---

## v12 summary

**Three new criteria extracted from R13:**

| ID | Name | Source | What it captures |
|----|------|--------|-----------------|
| **C-36** | §1 Scope Surface Domain Annotation Pre-committed | V-03, V-05 R13 | `[DOMAIN: label]` on each §1 IN-SCOPE row creates a mechanical registry for C-34's gap-check. C-34 can pass editorially without it. |
| **C-37** | NH Dimension Table Bracket Closing Re-population Pre-committed | V-01, V-04, V-05 R13 | BRACKET CLOSING re-populates the C-35 NH table with post-evidence values; g_null(final) derivable from revised table alone. |
| **C-38** | Multi-Alternative Column Structure in NH Dimension Table | R13 synthesis | NH table extended to three comparison columns (Status-Quo, Proposed-Build, Best-Non-Build-Alt), making both C-23 pairwise differentials table-derivable. Resolves the C-23/C-35 mutual exclusion in all R13 variants. |

**Score changes:** aspirational 27→30, max 225→240, gold 190→205.

**R13 ranking under v12:** V-05 230, V-03 225, V-04 220, V-02/V-01 215. V-05 moves to clear #1. Path to 240: extend V-05 R13's NH table to three columns (C-38) + restore C-23 pairwise formula referencing both table differentials.
Max pts | 225 | **240** |
| Gold threshold | 190 | **205** |

Gold delta matches the 3x5=15 pt pattern from prior rounds. V-05 R13 scores 220/225 (v11); under v12 V-05 gains C-36 PASS (+5) and C-37 PASS (+5) -> **230/240**. V-03 R13 gains C-36 PASS (+5) -> **225/240**. V-04 R13 gains C-37 PASS (+5) -> **220/240**. V-01 R13 gains C-37 PASS (+5) -> **215/240**. V-02 R13 unchanged at **215/240** (no NH table -> C-37 vacuous; no domain tags -> C-36 FAIL).

**Vacuous conditions added to Scoring Key:** C-36 (C-34 inactive), C-37 (C-35 inactive), C-38 (C-35 inactive OR C-23 inactive).

No retroactive score changes on R1--R12. Perfect score of 240 requires a future variant combining V-05 R13's base (C-33+C-34+C-35+C-37 PASS, C-36 PASS) with C-38 PASS (three-column NH dimension table) and C-23 PASS simultaneously -- the synthesis no R13 variant achieves.
...
## Aspirational Criteria -- 150 pts (structural integrity, auditability, automation)
...
aspirational_pts =  aspirational_pass    *  5   # 5 pts each, max 150
composite = essential_pts + recommended_pts + aspirational_pts
```

**Maximum**: 60 + 30 + 150 = **240 pts**

### Score Bands

| Band | Condition | Composite |
|------|-----------|-----------|
| Gold | all 5 essential pass | >= 205 |
| Strong | all 5 essential pass | 90-204 |
| Partial | <= 4 essential pass | any |
| Minimal | <= 3 essential pass | any |

### Paths to Gold (205 pts)

| Path | Essential | Rec | Asp passed | Composite |
|------|-----------|-----|------------|-----------|
| Full rec + 23 asp | 5/5 | 3/3 | 23/30 | 60+30+115 = 205 |
| 2 rec + 25 asp | 5/5 | 2/3 | 25/30 | 60+20+125 = 205 |
| 1 rec + 27 asp | 5/5 | 1/3 | 27/30 | 60+10+135 = 205 |
| 0 rec + 29 asp | 5/5 | 0/3 | 29/30 | 60+0+145 = 205 |

### Round 11 Calibration (retroactive, v10 -> v12)

All R11 variants: C-33/C-34/C-35 absent from all -> C-36/C-37/C-38 all vacuous or FAIL.
No retroactive score change; all R11 v11 scores carry forward unchanged to v12.

### Round 12 Calibration (retroactive, v11 -> v12)
...
(no Best-Alt column confirmed) -- FAIL. No retroactive score change until R12 full text review.

### Round 13 Calibration (v11 -> v12)

| Variant | v11 | C-36 | C-37 | C-38 | v12 |
|---------|-----|------|------|------|-----|
| **V-05** | 220 | PASS (+5) | PASS (+5) | FAIL | **230/240** |
| **V-03** | 220 | PASS (+5) | vac (0) | vac (0) | **225/240** |
| V-04 | 215 | FAIL | PASS (+5) | FAIL | **220/240** |
| V-02 | 215 | FAIL | vac (0) | vac (0) | **215/240** |
| V-01 | 210 | FAIL | PASS (+5) | FAIL | **215/240** |
...
| Rank | Variation | v12 Score | Band | v11 Score |
|------|-----------|-----------|------|-----------|
| **1** | **V-05** | **230/240** | Gold | 220 |
| **2** | **V-03** | **225/240** | Gold | 220 |
| **3** | V-04 | **220/240** | Gold | 215 |
| **4** | V-02 | **215/240** | Gold | 215 |
| **4** | V-01 | **215/240** | Gold | 210 |

Perfect score of 240 requires a future variant combining: V-05 R13's base (C-33+C-34+C-35+C-37
PASS) with C-36 PASS (§1 domain annotation, already in V-05) + C-38 PASS (three-column NH
dimension table) + C-23 PASS (pairwise derivation rule restored via C-38 column structure).
The canonical path: extend V-05 R13's NH dimension table from two columns to three (add
Best-Non-Build-Alt column) and update the NULL HYPOTHESIS DERIVATION RULE to reference both
table differentials. This simultaneously satisfies C-38 and re-activates C-23.
