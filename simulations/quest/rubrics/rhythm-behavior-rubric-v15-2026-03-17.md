Written to `simulations/quest/rubrics/rhythm-behavior-rubric-v15-2026-03-17.md`.

---

**rhythm-behavior Rubric v15**
...
**Three new criteria from R14:**

**C-41 -- C-37 No-N-Ceiling Extends to N=6 Including Synthesis Body** (format, R14)
Confirmed in V-04. The Synthesis body is the 6th structural position; C-37's bounded-by-available-positions principle absorbs it without modification. C-40's framing covered the sub-skill-body maximum; C-41 closes the absolute structural maximum.

**C-42 -- C-39 Register-Invariance Confirmed at N=4 and N=5 Descriptive Maximum** (format, R14)
Confirmed at N=4 (V-02) and N=5 (V-03) in descriptive register. Closes the descriptive-register counterpart of R13's imperative N=5. Sub-skill-body space now closed in both registers.

**C-43 -- Descriptive + N=6 Absolute Structural Maximum Composes Without Interaction** (format, R14)
Confirmed in V-05. C-38 + C-39 + C-37 jointly absorb all six named positions in descriptive register. No new restriction at the absolute structural limit.

**Cross-references updated:** C-37 (R14 note), C-39 (R14 note), C-40 (R14 note), C-22 (R14 extension line), C-34 range updated to C-08 through C-43.
 note), C-39 (R14 note), C-40 (R14 note), and C-22 (R14 extension line).
