Written to `simulations/quest/rubrics/corps-rob-rubric-v8-2026-03-16.md`.

---

**Two new criteria extracted from R7:**

| ID | Signal | Source |
|----|--------|--------|
| C-28 | Named field-level audit schema | V-01 TRIAGE NOTE AUDIT SCHEMA with (a)/(b)/(c) labeled conditions as a named format artifact separate from per-stage instances |
| C-29 | Enumerated condition zero-state | V-01 TRIAGE NOTE AUDIT RESULT block enumerating each condition as individually clean, not a single aggregate "NONE" |

**Distinctions from existing criteria:**

- C-28 vs C-25: C-25 requires three conditions to be checked per stage. C-28 requires those conditions to be declared as a named schema artifact with labeled indices, separate from their application. Three conditions checked inline at each stage satisfies C-25; only a named schema declaration (e.g., `TRIAGE NOTE AUDIT SCHEMA` with `(a)/(b)/(c)`) satisfies C-28. C-25 must pass for C-28 to be scoreable.

- C-29 vs C-19/C-25: C-19 requires an explicit zero-state declaration (e.g., `TRIAGE NOTE GAPS: NONE`). C-25 requires three-condition checking per stage. C-29 requires the zero-state to enumerate each schema condition as individually clean -- `(a) NONE`, `(b) NONE`, `(c) NONE` -- mirroring the named schema structure (C-28). A single aggregate `NONE` satisfies C-19 but not C-29. C-25 and C-28 must both pass for C-29 to be scoreable.

**Scoring impact:**

| | v7 | v8 |
|--|----|----|
| Aspirational pool | 19 x 5 = 95 | 21 x 5 = 105 |
| Max composite | 185 | 195 |
| Golden threshold | 80 (unchanged) | 80 (unchanged) |

**Retroactive R7 scores under v8:**

- V-01: 140 (+10 -- gains C-28 and C-29; was 130)
- V-02: 140 (unchanged -- C-25 fails, so C-28 and C-29 not scoreable)
than to a generic reviewer. A stage that produces role-agnostic findings does not
...
| | v7 | v8 |
|--|----|----|
| Aspirational pool | 19 criteria x 5 pts = 95 | 21 criteria x 5 pts = 105 |
| Max composite | 185 | 195 |
| Golden threshold | 80 (unchanged) | 80 (unchanged) |
...
- V-01: 140 (+10 -- gains C-28 and C-29; was 130 under v7)
- V-02: 140 (unchanged -- C-25 fails, so C-28 and C-29 not scoreable)
...
**Minimal pass (not golden)** -- all 5 essential pass, 1/3 recommended, 0/21 aspirational:
...
**Baseline golden** -- all 5 essential pass, 2/3 recommended, 0/21 aspirational:
...
**Strong** -- all 5 essential pass, 3/3 recommended, 2/21 aspirational:
...
**R7 V-01 equivalent** -- all essential, 2/3 recommended (C-07 + C-08), 12/21 aspirational
...
**R7 V-02 equivalent** -- all essential, 2/3 recommended (C-07 + C-08), 12/21 aspirational
(C-12, C-13, C-14, C-16, C-17, C-18, C-19, C-21, C-22, C-23, C-24, C-26):
...
**R6 V-01/V-02 equivalent** -- all essential, 2/3 recommended (C-07 + C-08), 10/21 aspirational:
...
**R5 V-01 equivalent** -- all essential, 2/3 recommended (C-07 + C-08), 9/21 aspirational
