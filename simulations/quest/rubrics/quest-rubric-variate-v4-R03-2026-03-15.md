...
version: 4
round: R3
changes: Added C-19 (named-block artifact architecture), C-20 (gate must block not repair), C-21 (cross-criterion audit consolidation), C-22 (structural enforcement paired with behavioral anti-deferral instruction) from R3 excellence signals ES-R3-1 through ES-R3-4
---

# Rubric: quest-rubric (v4)
...
**Note**: aspirational denominator is now 14 (C-09 through C-22).
