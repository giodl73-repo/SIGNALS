Written to `simulations/quest/rubrics/corps-build-rubric-v9-2026-03-16.md` (617 lines).

---

Three criteria extracted from the R9 scorecard notes and added as C-27/C-28/C-29:

**C-27 -- AMEND-RECEIPT with type-tagged options** (behavior, v9)
V-02/V-04/V-05 add explicit amendment type tags (ADD-ROLES, ADJUST-LEVELS, RESTRUCTURE-GROUP or equivalent) to each of the three AMEND options, plus a closing AMEND-RECEIPT listing option count and all type tags. C-08 requires three concrete options; C-27 makes the menu machine-readable without re-parsing the prose. Distinct type tags required -- identical tags across three options fail.

**C-28 -- BUILD-VERIFY two-field IA verification** (correctness, v9)
V-03/V-05 extend BUILD-VERIFY to verify both the lens field and the expertise field per team, each receiving a distinct verdict (VERBATIM-LENS / DRIFT-LENS and VERBATIM-EXPERTISE / DRIFT-EXPERTISE). C-17/C-20 close the loop on the lens phrase only; C-28 closes it across both identity-bearing fields. A merged single verdict per team fails.

**C-29 -- SECTIONS-COMPLETE declarative correctness rule** (depth, v9)
V-01/V-04/V-05 attach a declarative correctness rule to the SECTIONS-COMPLETE aggregation block itself -- naming which pass receipts must appear and what makes the block structurally incomplete. C-23 requires declarative rules on at least two blocks; C-29 specifically requires the closing aggregation block to be self-describing, making build-completeness structurally auditable.

**Formula**: `/18 -> /21`. Max aspirational points unchanged at 10.
advocate.md (or
...
### C-27 -- AMEND-RECEIPT with type-tagged amendment options
**Weight**: aspirational
**Category**: behavior
...
| v9 | Added C-27, C-28, and C-29 from R9 excellence signals (V-02/V-04/V-05 AMEND-RECEIPT with type-tagged options; V-03/V-05 BUILD-VERIFY two-field IA verification; V-01/V-04/V-05 SECTIONS-COMPLETE declarative rule); formula /18 -> /21. |
