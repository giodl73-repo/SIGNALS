...
- **C-17**: Per-score methodology trace (per-persona derivation sentence linking dimension values to declared threshold — makes C-09 locally auditable, not just globally declared)
- **C-18**: Kill-barrier trajectory verdict as a distinct output (Resolving/Stable/Worsening label with structural reasoning, separate from the per-persona timeline grid)

Max points updates: 10 aspirational × 10 = 100, total = 180.

```markdown
# Rubric -- validate-inertia v4

**Version:** v4
**Updated:** 2026-03-17
**Change from v3:** Added two new aspirational criteria (C-17, C-18) extracted from Round 3
excellence signals.
...
- **10 aspirational (C-09--C-18):** scoring methodology transparency, time-dependent inertia
...
10 pts each (100 total) = **180 pts max**.
