...
v4 adds two aspirational criteria (C-16 to C-17) extracted from Round 3 excellence
...
| Band | Essential (5x) | Recommended (3x) | Aspirational (9x) |
|------|---------------|-----------------|------------------|
| Points | 60 | 30 | 10 |
| Formula | pass/5 x 60 | pass/3 x 30 | pass/9 x 10 |
