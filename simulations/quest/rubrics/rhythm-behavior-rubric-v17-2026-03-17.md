**rhythm-behavior Rubric v17** is written to `simulations/quest/rubrics/rhythm-behavior-rubric-v17-2026-03-17.md`.
...
| | v16 | v17 |
|---|---|---|
| Aspirational denominator | 40 | **44** |
| New criteria | -- | C-48, C-49, C-50, C-51 |

**Four new aspirational criteria (format, R16):**

- **C-48** -- Cross-Type Dual Placement (Section Body + Inter-Section Peer Slot, **Imperative**) Is Position-Type-Agnostic. Completes the all-imperative endpoint of the cross-type register matrix, pairing with C-47 (all-descriptive).

- **C-49** -- Cross-Type Dual Placement, Mixed Register (**Imperative** Section Body + **Descriptive** Inter-Section Peer Slot) Composes Without Interaction. First mixed-register cross-type cell.

- **C-50** -- Cross-Type Dual Placement, Mixed Register (**Descriptive** Section Body + **Imperative** Inter-Section Peer Slot) Composes Without Interaction. Reverse complement of C-49. Together with C-47/C-48/C-49, the cross-type register matrix (all four cells) is fully closed.

- **C-51** -- Three-Placement Composition (Two Section Bodies + Inter-Section Peer Slot, Mixed Register) Is Governed Entirely by First-Qualifying-Occurrence Principle. First N=3 multi-position-type confirmation. Complexity reduces modularly: positions 1+2 absorbed by C-46; position 3 absorbed by C-48 generalization via C-37.

**Cross-references updated:** C-22 (R16 extension paragraph), C-33 (R16 note), C-34 (R16 note + range bumped to C-08 through C-51), C-37 (R16 note), C-47 (R16 note).
 C-48, and C-49, the cross-type register matrix is fully closed: all four cells confirmed to compose without interaction.
...
First N=3 multi-placement composition confirmed, spanning two position types and two registers. Positions 2 and 3 are each independently inert. The principle is not bounded by N-count or position-type count. N=3 complexity reduces to two confirmed sub-problems: dual section-body pair (C-46) + cross-type third placement (C-48 generalization via C-37). The criteria system composes modularly.

**Cross-references updated:** C-33 (R16 note), C-34 (R16 note), C-37 (R16 note), C-47 (R16 note). C-34 range updated to C-08 through C-51.
