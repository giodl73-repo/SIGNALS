Two new aspirational criteria from Round 8:

- **C-24**: Role execution order as pre-composition gate (V-01 C-18 pattern)
- **C-25**: Terminal verification checklist (V-01 Checklist pattern)

N_aspirational bumps from 16 → 18. Full rubric below.

---

# Quest Rubric — `topic-story` v8
...
Where N_essential = 4, N_recommended = 3, N_aspirational = 18.
