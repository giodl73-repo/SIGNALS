Written to `simulations/quest/rubrics/crew-review-rubric-v10-2026-03-16.md`.

---

**v10 summary: 4 new criteria extracted from R10.**

**New criteria:**

| ID | Pattern | Extends | Source |
|----|---------|---------|--------|
| C-29 | Exhaustive criterion-failure remediation coverage (every row, not just at least one) | C-28 | V-01/V-02 R10 |
| C-30 | Criterion-check table as typed 5-column schema with dedicated "Remediation if NO" column | C-29, C-13 | V-01/V-02 R10 |
| C-31 | Synthesis as a named discrete execution phase (PHASE 3.5 SYNTHESIZE) | C-27, C-23 | V-03 R10 design axis |
| C-32 | Synthesis phase gate: formal exit condition G2 (blocks AMEND until synthesis closes) | C-31, C-17 | V-03 R10 design axis |

**Structural logic:**
- C-28 → C-29: same minimum-count-to-exhaustive escalation as C-19 → C-25 and C-07 → C-27
- C-29 → C-30: typed column makes exhaustive remediation correct-by-construction (C-13 discipline applied to the meta-table)
- C-27 → C-31: same output-check-to-named-phase elevation as C-13 → C-23 and C-09 → C-15
- C-31 → C-32: same named-phase-to-gate escalation as C-15 → C-17

**Scoring delta:**

| | v9 | v10 |
|-|----|-----|
| Aspirational count | 17 | 21 |
| Aspirational max | 42.5 | 52.5 |
| Total max | 162.5 | 172.5 |
| V-01/V-02 R10 | 162.5 | **167.5** |
| V-03 R10 | TBD | TBD (C-31+C-32 target = +5.0) |
iation correct-by-construction: the schema column cannot be omitted for a single row
without violating the table contract. V-02 R10 C-28 row carries a self-referential
instruction: "Add 'Remediation if NO' column..." -- the meta-table is self-auditing at the
structural level.

*C-31 signal:* V-03 R10 design axis: "New PHASE 3.5 -- SYNTHESIZE with G2 closure gate.
Synthesis is a lifecycle phase, not a render step." This is the same structural elevation
applied twice before: C-09 (challenger leads) -> C-15 (challenger as named phase); C-13
(visible validation) -> C-23 (validation as named phase). C-27 requires synthesis to be
complete (output check); C-31 requires the mechanism to be a named phase (structural
mechanism).

*C-32 signal:* V-03 R10 design axis adds a G2 gate that blocks AMEND until synthesis
exits. Mirrors C-17 extending C-15: "domain review does not begin until G1 closes" ->
"AMEND does not begin until G2 closes." The gate makes C-27's per-slot coverage contract
correct-by-construction at phase-exit time rather than at VALIDATE-check time.

**Updated chain tails:**
```
C-24 -> C-26 -> C-28 -> C-29 -> C-30
C-07 -> C-22 -> C-27 -> C-31 -> C-32
```
...
| Aspirational max | 42.5 | 52.5 |
| Total max | 162.5 | 172.5 |
| V-01 R10 | 162.5 | **167.5** |
| V-02 R10 | 162.5 | **167.5** |
| V-03 R10 | TBD | TBD |

**Scoring:** 21 aspirational x 2.5 = 52.5, max **172.5** (was 162.5). Golden threshold
unchanged at 80.

**R10 scores under v10:**
- V-01: 60 + 60 + 47.5 = **167.5**
  (C-29 PASS 2.5; C-30 PASS 2.5; C-31 FAIL 0; C-32 FAIL 0; all v9 aspirational PASS = 42.5)
- V-02: 60 + 60 + 47.5 = **167.5**
  (C-29 PASS 2.5; C-30 PASS 2.5; C-31 FAIL 0; C-32 FAIL 0; all v9 aspirational PASS = 42.5)
- V-03: TBD (designed to achieve C-31 PASS and C-32 PASS)

**New relationship chains:**
- Validation feedback loop: C-24 (criterion-check table) -> C-26 (self-referential
  completeness) -> C-28 (at least one remediation entry) -> C-29 (every row carries
  remediation) -> C-30 (remediation as typed schema column -- exhaustive
  correct-by-construction)
- Synthesis phase: C-07 (minimum-count cross-role signal) -> C-22 (slot-anchored matrix)
  -> C-27 (per-slot coverage contract) -> C-31 (synthesis as named discrete phase)
  -> C-32 (synthesis phase with formal exit gate G2)
...
from R8. C-28 is from R9. C-29 through C-32 are new from R10.
...
satisfies C-32 (minimum form); a named gate with a multi-condition closure predicate
(C-20 pattern applied to synthesis) would exceed C-32. An exit gate without a gate name
does not pass.
...
|----------|--------|--------|--------|-----------|---------|
| All pass | 5/5 | 6/6 | 21/21 | 60+60+52.5=172.5 | YES |
| All essential + 2 recommended | 5/5 | 2/6 | 0/21 | 60+20+0=80 | YES (at threshold) |
| All essential + all recommended | 5/5 | 6/6 | 0/21 | 60+60+0=120 | YES |
| All essential + 1 recommended | 5/5 | 1/6 | 0/21 | 60+10+0=70 | NO |
| 4 essential + all recommended | 4/5 | 6/6 | 0/21 | 48+60+0=108 | NO (essential gap) |
| All essential + 3 rec + 3 asp | 5/5 | 3/6 | 3/21 | 60+30+7.5=97.5 | YES |
| V-05 R7 equivalent (v7 perfect) | 5/5 | 6/6 | 14/21 | 60+60+35.0=155.0 | YES |
| V-01 R8 equivalent | 5/5 | 6/6 | 15/21 | 60+60+37.5=157.5 | YES |
| V-02 R8 equivalent | 5/5 | 6/6 | 15/21 | 60+60+37.5=157.5 | YES |
| V-01 R9 equivalent (under v10) | 5/5 | 6/6 | 16.5/21 | 60+60+41.25=161.25 | YES |
| V-02 R9 equivalent (under v10) | 5/5 | 6/6 | 15/21 | 60+60+37.5=157.5 | YES |
| V-01 R10 | 5/5 | 6/6 | 19/21 | 60+60+47.5=167.5 | YES |
| V-02 R10 | 5/5 | 6/6 | 19/21 | 60+60+47.5=167.5 | YES |
| Perfect (v10) | 5/5 | 6/6 | 21/21 | 60+60+52.5=172.5 | YES |
...
- The full relationship chains:
  ...
  - Synthesis coverage: C-07 (minimum-count signal) -> C-22 (slot column anchors
    ...
    correct-by-construction at phase-exit time).
  - Each step in each chain makes the prior criterion correct-by-construction rather than
    by instruction.
- V-05 R7 equivalent under v10: E=60, R=60, A=C-11 through C-25 all PASS (35.0) +
  C-26 through C-32 all FAIL (0). Composite = 155.0.
- V-01 R8 equivalent under v10: E=60, R=60, A=35.0 + C-26 PASS(2.5) + rest FAIL(0).
  Composite = 157.5.
- V-02 R8 equivalent under v10: E=60, R=60, A=35.0 + C-27 PASS(2.5) + rest FAIL(0).
  Composite = 157.5.
- V-01 R9 equivalent under v10: E=60, R=60, A=35.0 + C-26 PASS(2.5) + C-27 PARTIAL(1.25)
  + C-28 PASS(2.5) + C-29 through C-32 all FAIL(0) = 41.25. Composite = 161.25.
- V-02 R9 equivalent under v10: E=60, R=60, A=35.0 + C-27 PASS(2.5) + rest FAIL(0) = 37.5.
  Composite = 157.5.
- V-01 R10 under v10: E=60, R=60, A=42.5 (all v9 aspirational PASS) + C-29 PASS(2.5) +
  C-30 PASS(2.5) + C-31 FAIL(0) + C-32 FAIL(0) = 47.5. Composite = 167.5.
- V-02 R10 under v10: Same as V-01 R10. Composite = 167.5.
- Scoring formula in v10: Essential 5 x 12 = 60, Recommended 6 x 10 = 60, Aspirational
  21 x 2.5 = 52.5. Max is 172.5. Golden threshold is composite >= 80 with all essential
  passing.
