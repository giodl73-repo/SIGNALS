# program-plan Rubric — v16

Evaluates a `program:plan` prompt against Signal's plugin contract and evidence-quality bar.
44 aspirational criteria, 4 essential, 3 recommended. Total max: **310 pts**.
...
| Aspirational | 220 pts | C-08 through C-51 (44 criteria) | 5 | 220 |

```
composite = (essential_pass/4 * 60)
          + (recommended_pass/3 * 30)
          + (aspirational_pass/44 * 220)
```

PASS = full points, PARTIAL = half points, FAIL = 0.

**Total max**: 60 + 30 + 220 = **310 pts**.
...
Aspirational: C-08 [ ]  C-09 [ ]  C-10 [ ]  C-11 [ ]
              ...
              C-44 [ ]  C-45 [ ]  C-46 [ ]  C-47 [ ]
              C-48 [ ]  C-49 [ ]  C-50 [ ]  C-51 [ ]
              Pass count: ___ / 44  ->  ___ / 44 * 220 = ___ pts  (of 220)

Composite score: ___ / 310
