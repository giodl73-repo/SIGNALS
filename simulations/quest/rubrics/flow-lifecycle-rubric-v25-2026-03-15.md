...
**v25 changes from v24 (v6 from v5)**: Added C-19 (Per-Field Dimensional Enforcement) and C-20 (Escape Valve Dual-Failure Path Declaration) from R5 excellence signals.

C-19 closes the partial-pass trap exposed by V-01-V-04's C-17 failures: naming three fields is not sufficient if field content requirements are unspecified. V-05 fixed this by adding explicit dimensional bounds per field and at least one disqualifying category ("Best practice does not qualify" for Why Required). C-19 generalizes this pattern: every structured field in a required output carries both positive bounds (what category of answer qualifies) and a negative boundary (what is insufficient).

C-20 extends C-18 with the dual-failure path pattern surfaced by V-05: where C-18 requires an escape valve with a named token and a fail distinction, C-20 requires that BOTH failure modes be named explicitly -- (a) has dependency evidence but uses general language, and (b) lacks dependency evidence but leaves the field blank. V-01-V-04 treat empty-or-general as one combined fail bucket; V-05 bifurcates them by SLA-evidence presence in a single paired statement.

Aspirational pool: 10 criteria at 50 pts (v24) -> 12 criteria at 60 pts (v25). 5 pts/criterion rate preserved. Max composite: 140 -> 150.
...
```
score = (essential_pass/5 * 60) + (recommended_pass/3 * 30) + (aspirational_pass/12 * 60)
```
...
> Raise the bar once essential and recommended are stable. C-09 through C-13 added in v21; C-14 and C-15 added in v22; C-16 and C-17 added in v23; C-18 added in v24; C-19 and C-20 added in v25.
...
(5/5 * 60) + (3/3 * 30) + (0/12 * 60) = 60 + 30 + 0 = 90 -- golden

**All essential pass, 2/3 recommended, no aspirational**:
(5/5 * 60) + (2/3 * 30) + (0/12 * 60) = 60 + 20 + 0 = 80 -- golden (threshold met)

**4/5 essential pass, all recommended pass, all aspirational**:
(4/5 * 60) + (3/3 * 30) + (12/12 * 60) = 48 + 30 + 60 = 138 -- NOT golden (essential incomplete)

**All essential pass, 1/3 recommended, all aspirational**:
(5/5 * 60) + (1/3 * 30) + (12/12 * 60) = 60 + 10 + 60 = 130 -- golden

**All essential + all recommended + all aspirational**:
(5/5 * 60) + (3/3 * 30) + (12/12 * 60) = 60 + 30 + 60 = 150 -- golden (max)

**R5 V-05 (all criteria pass)**:
(5/5 * 60) + (3/3 * 30) + (12/12 * 60) = 60 + 30 + 60 = 150 -- golden (MAX)

**R5 V-01/V-02/V-03/V-04 (C-17 partial, C-19 partial, C-20 partial)**:
(5/5 * 60) + (3/3 * 30) + (10.5/12 * 60) = 60 + 30 + 52.5 = 142.5 -- golden

**R4 V-01/V-02/V-03 equivalent under v25 (C-17 partial, C-18 pass, C-19 partial, C-20 partial)**:
(5/5 * 60) + (3/3 * 30) + (10.5/12 * 60) = 60 + 30 + 52.5 = 142.5 -- golden

**R3 V-01/V-02/V-03 equivalent under v25 (8.5 aspirational from C-09-C-17, C-18/C-19/C-20 not assessed)**:
(5/5 * 60) + (3/3 * 30) + (8.5/12 * 60) = 60 + 30 + 42.5 = 132.5 -- golden

**R2 V-02 equivalent (C-07 partial, C-09-C-15 pass, C-16/C-17/C-18/C-19/C-20 not assessed)**:
(5/5 * 60) + (2.5/3 * 30) + (7/12 * 60) = 60 + 25 + 35 = 120 -- golden
