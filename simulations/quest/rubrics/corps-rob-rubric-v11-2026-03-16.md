The rubric is complete. Written to `simulations/quest/rubrics/corps-rob-rubric-v11-2026-03-16.md`.

---

**v11 summary: 2 new criteria from R10 V-03**

| ID | Criterion | Signal | Dependency |
|----|-----------|--------|------------|
| C-36 | Synthesis Positive-Artifact Subsection Schema | V-03 axis: "RULE SYNTHESIS as positive artifact with 5 required subsections" -- elevates C-33's non-audit exclusion to a structural schema with >= 3 mandatory labeled subsections | C-33 |
| C-37 | Dual Illustrative Baseline Examples | V-03: "Dual IB-01+IB-02 baselines" vs V-01/V-02 single IB-01 -- paired examples enable range triangulation, prevent single-exemplar false negatives/positives | none |

**Scoring impact:**

| | v10 | v11 |
|--|-----|-----|
| Aspirational pool | 27 x 5 = 135 | 29 x 5 = 145 |
| Max composite | 225 | 235 |

**Retroactive R10 under v11:**
- V-03: +10 (gains both)
- V-01: 210 (no gains -- C-36 fails: non-audit declared but no subsection enumeration; C-37 fails: single IB-01 only)
- V-02: 210 (no gains -- same pattern)
36: RULE SYNTHESIS with 5 required subsections; gains C-37: Dual IB-01+IB-02)
- V-01: 210 (no gains -- C-36 fails: C-33 passes but no subsection enumeration; C-37 fails: Single IB-01 only)
- V-02: 210 (no gains -- C-36 fails: RULE SYNTHESIS in glossary lacks subsection schema; C-37 fails: Single IB-01 only)

**C-36 -- Synthesis Positive-Artifact Subsection Schema** (format / aspirational)
- Signal: V-03 axis is "RULE SYNTHESIS as positive artifact with 5 required subsections." V-01 and V-02 declare what SYNTHESIS is not (C-33). V-03 additionally enumerates what it must contain. Named subsections make SYNTHESIS a positive artifact: completeness is auditable per subsection. Without the schema, SYNTHESIS satisfies C-33 while remaining structurally open-ended.
- Distinction from C-33: C-33 requires a non-audit declaration. C-36 requires RULE SYNTHESIS to additionally enumerate >= 3 required subsections as a named schema. C-33 must pass for C-36 to be scoreable.

**C-37 -- Dual Illustrative Baseline Examples** (format / aspirational)
- Signal: V-03 carries "Dual IB-01+IB-02 baselines"; V-01 and V-02 carry "Single IB-01." A paired baseline provides structural contrast: IB-01 anchors the minimal acceptable case; IB-02 demonstrates a structurally distinct variation. Dual baselines enable range triangulation; single-exemplar anchoring produces false negatives (novel-but-correct outputs rejected) and false positives (degenerate copies accepted).
- Distinction from C-30: C-30 requires preamble schema declaration with named reference. C-37 requires paired illustrative baseline examples. Orthogonal. C-37 has no upstream dependency.
...
Dependencies:
- C-36 requires C-33 to pass.
- C-37 has no upstream dependency.
