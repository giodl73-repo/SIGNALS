The complete v10 rubric is written. Here is the summary of what changed:
...
| | v9 | v10 |
|---|---|---|
| Aspirational criteria | 21 | **24** |
| Aspirational pts | 105 | **120** |
| Total max | 195 | **210** |
| Gold threshold | 160 | **175** |

**Three new aspirational criteria (C-30, C-31, C-32):**

| ID | Name | Activation point | Source | PASS | FAIL |
|----|------|-----------------|--------|------|------|
| C-30 | Per-Finding Severity Chain Pre-committed | findings time (§14) | V-01, V-04, V-05 R11 | 3 variants | V-02, V-03 |
| C-31 | Role Lens Exhaustion Pre-committed | expertise-coverage time (§15) | V-02, V-04, V-05 R11 | 3 variants | V-01, V-03 |
| C-32 | Primary Driver Derivation Pre-committed | synthesis time (§16) | V-03, V-05 R11 | 2 variants | V-01, V-02, V-04 |

**Distinction lines:**
- C-30 vs C-02: semantics vs propagation (what labels mean vs how they aggregate)
- C-30 vs C-12: finding-severity-to-section vs gate-verdict-to-class
- C-31 vs C-27: role-capability inventory vs challenge-identifier inventory
- C-31 vs C-29: reviewer competency coverage vs artifact scope coverage
- C-32 vs C-10/C-17: attribution ("which gate caused it?") vs outcome ("what label results?")

**Vacuous conditions added to Scoring Key:** C-30 (C-02 inactive), C-31 (C-09 inactive OR no lens.verify entries), C-32 (C-09 inactive).

No retroactive score changes on R1–R10. V-05 R11 is the canonical T3 target for v10.
eview is structured as a matrix of named roles, each applying a distinct evaluation frame
...
## Aspirational Criteria -- 120 pts (structural integrity, auditability, automation)
...
finding to section signal. Both can pass independently: a review with C-02 PASS and C-30 FAIL
has defined severity semantics but assigns section severity editorially.
...
an attribution layer absent from C-10 and C-17. A review with C-10 PASS and C-32 FAIL derives
the correct disposition but attributes it editorially.
...
attribution is assigned editorially (e.g., "the domain consensus was the deciding factor")
without a pre-committed rule formula; or the formula is stated post-hoc after reviewers execute.
Partial if a Primary Driver field is emitted but the derivation formula is not pre-committed in
the preamble, or the rule set does not cover all gate verdict combinations.
...
aspirational_pts =  aspirational_pass    *  5   # 5 pts each, max 120
composite = essential_pts + recommended_pts + aspirational_pts
```

**Maximum**: 60 + 30 + 120 = **210 pts**

### Score Bands

| Band | Condition | Composite |
|------|-----------|-----------|
| Gold | all 5 essential pass | >= 175 |
| Strong | all 5 essential pass | 90-174 |
| Partial | <= 4 essential pass | any |
| Minimal | <= 3 essential pass | any |

### Paths to Gold (175 pts)

| Path | Essential | Rec | Asp passed | Composite |
|------|-----------|-----|------------|-----------|
| Full rec + 17 asp | 5/5 | 3/3 | 17/24 | 60+30+85 = 175 |
| 2 rec + 19 asp | 5/5 | 2/3 | 19/24 | 60+20+95 = 175 |
| 1 rec + 21 asp | 5/5 | 1/3 | 21/24 | 60+10+105 = 175 |
| 0 rec + 23 asp | 5/5 | 0/3 | 23/24 | 60+0+115 = 175 |

### Round 1 Calibration (retroactive, v1 -> v10)

| Variant | C-09 | C-11 | C-16 | C-22 | C-23 | C-24 | C-25 | C-26 | C-27 | C-28 | C-29 | C-30 | C-31 | C-32 | v9 | v10 |
|---------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|----|-----|
| V-01 | FAIL | vac | vac | vac | vac | vac | vac | vac | vac | vac | vac | vac | vac | vac | 75 | 75 |
| V-02 | FAIL | vac | vac | vac | vac | vac | vac | vac | vac | vac | vac | vac | vac | vac | 69 | 69 |
| V-03 | PASS | PASS | vac | TBD | TBD | vac | vac | TBD | vac | vac | vac | vac | vac | vac | TBD | TBD |
| V-04 | vac | vac | vac | vac | vac | vac | vac | vac | vac | vac | vac | vac | vac | vac | 95 | 95 |
| V-05 | PASS | PASS | PASS | TBD | TBD | vac | vac | TBD | vac | vac | vac | vac | vac | vac | TBD | TBD |

C-27 through C-32 vacuous for all Round 1 variants.

### Round 2 Calibration (retroactive, v9 -> v10)

| Variant | C-30 | C-31 | C-32 | v9 | v10 |
|---------|------|------|------|----|-----|
...
C-30, C-31, C-32 vacuous for all Round 2 variants.

### Round 4 Calibration (retroactive, v9 -> v10)
...
C-30, C-31, C-32 vacuous for all Round 4 variants.

### Round 5 Calibration (retroactive, v9 -> v10)
...
C-30, C-31, C-32 vacuous for all Round 5 variants.

### Round 6 Calibration (retroactive, v9 -> v10)
...
C-30, C-31, C-32 vacuous for all Round 6 variants.

### Round 7 Calibration (retroactive, v9 -> v10)
...
C-30, C-31, C-32 vacuous for all Round 7 variants.

### Round 8 Calibration (retroactive, v9 -> v10)
...
C-30, C-31, C-32 vacuous for all Round 8 variants.

### Round 9 Calibration (retroactive, v9 -> v10)

| Rank | Variant | C-27 | C-28 | C-29 | C-30 | C-31 | C-32 | v9 | v10 |
|------|---------|------|------|------|------|------|------|----|-----|
| 1 | **V-05** | PASS | PASS | PASS | vac | vac | vac | 195 | **195** |
| 2 | **V-04** | PASS | PASS | FAIL | vac | vac | vac | 190 | **190** |
| 3 | V-01 | PASS | FAIL | FAIL | vac | vac | vac | 185 | **185** |
| 3 | V-02 | FAIL | PASS | FAIL | vac | vac | vac | 185 | **185** |
| 3 | V-03 | FAIL | FAIL | PASS | vac | vac | vac | 185 | **185** |

C-30, C-31, C-32 vacuous for all Round 9 variants. §14/§15/§16 contracts do not appear before
Round 11.

### Round 11 Calibration (v9 -> v10)

All five R11 variants carry the V-05 R9 template (§3a + exclusion registry + §7 + §8/§9/§10) as
base. All five score 195/195 under v9 before the new criteria are applied.

| Rank | Variant | C-30 | C-31 | C-32 | v9 | v10 |
|------|---------|------|------|------|----|-----|
| 1 | **V-05** | PASS | PASS | PASS | 195 | **210** |
| 2 | V-04 | PASS | PASS | FAIL | 195 | **205** |
| 3 | V-01 | PASS | FAIL | FAIL | 195 | **200** |
| 3 | V-02 | FAIL | PASS | FAIL | 195 | **200** |
| 3 | V-03 | FAIL | FAIL | PASS | 195 | **200** |

V-01: §14 [IMMUTABLE] per-finding severity chain present (C-30 PASS). No lens exhaustion
contract (C-31 FAIL). No primary driver formula (C-32 FAIL). Score: 195 + 5 = 200.
V-02: §15 [IMMUTABLE] lens exhaustion table present (C-31 PASS). No per-finding severity chain
(C-30 FAIL). No primary driver formula (C-32 FAIL). Score: 195 + 5 = 200.
V-03: §16 [IMMUTABLE] primary driver formula present (C-32 PASS). No per-finding severity chain
(C-30 FAIL). No lens exhaustion contract (C-31 FAIL). Score: 195 + 5 = 200.
V-04: §14 + §15 both present (C-30 + C-31 PASS). No primary driver formula (C-32 FAIL).
Score: 195 + 5 + 5 = 205.
V-05: All three contracts present (C-30 + C-31 + C-32 PASS). Score: 195 + 5 + 5 + 5 = 210.

Round 11 top score: 210/210 (V-05 alone). Perfect under v10 requires C-30 + C-31 + C-32
simultaneously. V-04 holds two of three (205); V-01/V-02/V-03 hold one each (200); only V-05
holds all three. V-05 R11 is the canonical T3 target for v10.

**Key shift**: The three new criteria are independent in the same way C-27/C-28/C-29 were
...
§14 activates at findings time; §15 activates at expertise-coverage time; §16 activates at
synthesis time -- no shared fields, no cascade effects.
