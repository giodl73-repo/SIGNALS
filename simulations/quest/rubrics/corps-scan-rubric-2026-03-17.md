...
| Tier | Criteria | Focus |
|------|----------|-------|
| Essential (x5) | C-01 YAML present, C-02 repo-grounded, C-03 group hierarchy, C-04 roles per team, C-05 no .craft/roles writes | Output is valid and boundary-safe |
