Written to `simulations/quest/rubrics/mock-accept-rubric-v7-2026-03-17.md`. Here is the complete rubric:
...
|-----------|------|------|------------|-----------|-------|
| V-05 (full combination) | PASS | PASS | 22/22 | 10.0 | **100.0** |
| V-03 (lifecycle + inertia axes) | PASS | PASS | 22/22 | 10.0 | **100.0** |
| V-04 (lifecycle + output-format only) | FAIL | FAIL | 20/22 | 9.09 | **99.09** |
| V-01 (C-26 FAIL) | FAIL | FAIL | 19/22 | 8.64 | **98.64** |
| V-02 (C-27 FAIL) | FAIL | FAIL | 19/22 | 8.64 | **98.64** |

V-03 and V-05 are the new co-goldens. V-04 drops from 100.0 (v6) to 99.09 (v7). R7 variations must address C-29 and C-30 to push V-04-style paths back toward 100.
...
| ID | Failure Pattern |
|----|----------------|
| MA-27 | C-29: evaluation record has no `Cost-of-MOCK:` field; verdict collapses to two-part form without naming counterfactual validation risk |
| MA-28 | C-30: no DEFAULT DECISION POSITION block before STEP 1; MOCK-ACCEPTED confirmed by absence of disqualification rather than earned against named inertia |
...
### Aspirational -- C-09 to C-30, denominator 22
...
**C-09 N/A cascade:** C-09 -> C-15 -> C-20 -> C-23 -> C-26; denominator when C-09 absent = 17 (22 - 5). C-29 and C-30 independent of C-09 status.
 max 30
