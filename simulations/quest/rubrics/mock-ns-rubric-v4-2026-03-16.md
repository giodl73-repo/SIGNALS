`simulations/quest/rubrics/mock-ns-rubric-v4-2026-03-16.md` written.
...
**Scoring update:** aspirational drops from 2.5 → **2 pts each** (10 × 2 = 20; max remains 100).

**Two new failure traps** added: "Gate language missing" and "Tier-carry implies propagation" — both document the pattern of satisfying C-12 while leaving C-17/C-18 unaddressed, which was the exact gap V-04 was designed to close.
mers) further strengthen C-12-passing implementations but are not required for C-12 itself. V-03 confirmed step-label separation alone satisfies C-12 even without gate language.

**Two new failure traps** added to the table: "Gate language missing" (passes C-12, fails C-17) and "Tier-carry implies propagation" (passes C-12, fails C-18).

**Scoring note**: With 18 criteria total — 5 essential (50) + 3 recommended (30) + 10 aspirational — aspirational weight drops to **2 pts each** (10 × 2 = 20) to hold max at 100.
...
*Raise the bar once essential and recommended are stable. Each criterion is worth 2 pts (10 × 2 = 20; max score = 100).*
