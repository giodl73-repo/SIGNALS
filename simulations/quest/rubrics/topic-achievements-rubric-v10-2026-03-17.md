...
*v9 added C-26 from Round 8 V-05 ("Lifecycle Phase Barrier Language").* Phase-do-not-begin instructions operate prospectively; C-26 tests whether each boundary carries an explicit declarative seal before the next phase's context is introduced. Independent of C-22–C-25.

*v8 added C-24 and C-25 from Round 7 (REGISTRY PRIMACY and severity-stratified FAIL blocks). C-24 requires C-22; C-25 requires C-23.*
...
Saved to `simulations/quest/rubrics/corps-achievements-rubric-v10-2026-03-17.md`.

**Summary of what changed:**

| ID | Pattern | Source | Preconditions |
|----|---------|--------|---------------|
| C-27 | Structural barrier omission resistance (pre-printed template element) | V-02 | None |
| C-28 | Phase N output-set manifest before closure seal | V-03 | None |
| C-29 | Dual-layer barrier redundancy | V-04 | C-26 + C-27 |

**Formula**: `/21` (was `/18`). All prior criteria unchanged.

**What the new criteria reveal about Round 9 scores on v10:** V-01 gets 18/21 (only C-26), V-02 gets 19/21 (C-26+C-27), V-03 gets 19/21 (C-26+C-28), V-04 gets 20/21 (C-26+C-27+C-29, no C-28). The obvious Round 10 target: combine V-03's output manifest with V-04's dual-layer — C-26+C-27+C-28+C-29 = 21/21.
