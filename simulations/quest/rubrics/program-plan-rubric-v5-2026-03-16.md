# program-plan Rubric — v5

Evaluates a `program:plan` prompt against Signal's plugin contract and evidence-quality bar.
14 aspirational criteria, 4 essential, 3 recommended. Total max: **160 pts**.
...
## Aspirational Criteria (raise the bar -- 70 pts)
...
| Aspirational | 70 pts | C-08 through C-21 (14 criteria) | 5 | 70 |
...
Aspirational: C-08 [ ]  C-09 [ ]  C-10 [ ]  C-11 [ ]
              ...
              C-16 [ ]  C-17 [ ]  C-18 [ ]  C-19 [ ]
              C-20 [ ]  C-21 [ ]
              Pass count: ___ / 14  ->  ___ / 14 * 70 = ___ pts  (of 70)

Composite score: ___ / 160
...
- **Scoring total is 160** (not 145) because the aspirational tier expanded from 11 to 14
