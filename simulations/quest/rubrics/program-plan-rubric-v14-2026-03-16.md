# program-plan Rubric — v14

Evaluates a `program:plan` prompt against Signal's plugin contract and evidence-quality bar.
39 aspirational criteria, 4 essential, 3 recommended. Total max: **285 pts**.
...
## Aspirational Criteria (teaching quality — 195 pts)
...
| Aspirational | 195 pts | C-08 through C-46 (39 criteria) | 5 | 195 |

```
composite = (essential_pass/4 * 60)
          + (recommended_pass/3 * 30)
          + (aspirational_pass/39 * 195)
```
...
Aspirational: C-08 [ ]  C-09 [ ]  C-10 [ ]  C-11 [ ]
              ...
              C-40 [ ]  C-41 [ ]  C-42 [ ]  C-43 [ ]
              C-44 [ ]  C-45 [ ]  C-46 [ ]
              Pass count: ___ / 39  ->  ___ / 39 * 195 = ___ pts  (of 195)

Composite score: ___ / 285
...
| Version | Added | Source | Scoring delta |
|---------|-------|--------|---------------|
| v10 | C-34, C-35 | R9 excellence signals | 31 → 33 asp · 155 → 165 pts · 245 → 255 total |
| v11 | C-36, C-37 | R10 excellence signals | 31 → 33 asp · 155 → 165 pts · 245 → 255 total |
| v12 | C-38, C-39, C-40 | R11 excellence signals | 30 → 33 asp · 150 → 165 pts · 240 → 255 total |
| v13 | C-41, C-42, C-43 | R12 excellence signals | 33 → 36 asp · 165 → 180 pts · 255 → 270 total |
| v14 | C-44, C-45, C-46 | R13 excellence signals | 36 → 39 asp · 180 → 195 pts · 270 → 285 total |

---

## Pattern Map (v14 additions)

| Criterion | Source pattern | Gap closed |
|-----------|----------------|------------|
| **C-44** | C-41 index maps annotation types to criteria — adding exact tag strings per entry converts the index from a navigation aid into a self-sufficient verification checklist | Header names which field type satisfies which criterion but leaves tag-form verification to block-scanning; model must still infer the annotation string by reading the block |
| **C-45** | C-41 (entry index) and C-42 (named section) each address the co-location family independently — bidirectional linking makes them a navigational unit traversable in both directions | The two sections are parallel artifacts; a model reading either is not directed to the other, leaving the principle-to-instance relationship implicit rather than structurally connected |
| **C-46** | C-41 creates a header entry-point index — a footer exit marker brackets the block and closes the scan loop | Block scanning is open-ended: the model knows what annotation types to look for (C-41) but has no in-block signal that the scan is complete; omissions are only detectable by re-reading the entire block |
