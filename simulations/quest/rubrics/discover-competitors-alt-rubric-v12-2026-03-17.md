Rubric v12 written to `simulations/quest/rubrics/discover-competitors-alt-rubric-v12-2026-03-17.md`.

---

**Three new criteria added from R12 excellence signals:**

| ID | Criterion | Category | Source |
|----|-----------|----------|--------|
| C-44 | Exhaustive "Reads slot" including conditional reads | behavior | R12 V-01/V-04/V-05 -- Phase 2 declares slot 0 conditional read for Focus column inclusion |
| C-45 | Phase 4 PATH row as structural branch router at row 0 | format | R12 V-02/V-04/V-05 -- PATH row before SOURCE extends C-37's CANDIDATE-first to Phase 4 |
| C-46 | WRITE-TOKEN REGISTRY as first-class PREFLIGHT table | format | R12 V-03/V-05 -- three-table PREFLIGHT: OUTPUT CONTRACTS + EXECUTION DEPENDENCY + WRITE-TOKEN REGISTRY |

**Scoring update (v11 → v12):**

| | v11 | v12 |
|--|-----|-----|
| Aspirational count | 35 | 38 |
| Aspirational max | 175 | 190 |
| Max composite | 265 | 280 |
| Formula | `/ 35 x 175` | `/ 38 x 190` |
| Exceptional | >= 250 | >= 265 |
| Strong | >= 223 | >= 238 |
| Passing | >= 90 | >= 90 |

**Dependency additions:**
- C-44 is independent of C-42 (control vs. data dependencies; both are EXECUTION DEPENDENCY table columns)
- C-45 automatically satisfies C-36; C-45 is the Phase 4 analogue of C-37; neither implies the other
- C-46 automatically satisfies C-28; compatible with C-32; independent of C-31
a receive an explicit HIGH / MEDIUM / LOW threat rating. No competitor appears without a threat level. |
...
## Aspirational Criteria (weight = 190 points total, 5 points each)
...
Grade bands rescaled proportionally from v11 (v11 max = 265; v12 max = 280).
Exceptional threshold preserved at ~94% of max; Strong threshold at ~85% of max; Passing at golden threshold (90).
