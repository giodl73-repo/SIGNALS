# program-plan Rubric — v9

Evaluates a `program:plan` prompt against Signal's plugin contract and evidence-quality bar.
26 aspirational criteria, 4 essential, 3 recommended. Total max: **220 pts**.
...
## Aspirational Criteria (teaching quality — 130 pts)
...
| Aspirational | 130 pts | C-08 through C-33 (26 criteria) | 5 | 130 |

```
composite = (essential_pass/4 * 60)
          + (recommended_pass/3 * 30)
          + (aspirational_pass/26 * 130)
```
...
Aspirational: C-08 [ ]  C-09 [ ]  C-10 [ ]  C-11 [ ]
              ...
              C-28 [ ]  C-29 [ ]  C-30 [ ]  C-31 [ ]
              C-32 [ ]  C-33 [ ]
              Pass count: ___ / 26  ->  ___ / 26 * 130 = ___ pts  (of 130)

Composite score: ___ / 220
...
- **Scoring total is 220** (not 205) because the aspirational tier expanded from 23 to 26
