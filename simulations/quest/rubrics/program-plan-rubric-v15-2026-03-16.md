# program-plan Rubric — v15

Evaluates a `program:plan` prompt against Signal's plugin contract and evidence-quality bar.
42 aspirational criteria, 4 essential, 3 recommended. Total max: **300 pts**.
...
| Aspirational | 210 pts | C-08 through C-49 (42 criteria) | 5 | 210 |

```
composite = (essential_pass/4 * 60)
          + (recommended_pass/3 * 30)
          + (aspirational_pass/42 * 210)
```
...
Aspirational: C-08 [ ]  C-09 [ ]  C-10 [ ]  C-11 [ ]
              ...
              C-44 [ ]  C-45 [ ]  C-46 [ ]  C-47 [ ]
              C-48 [ ]  C-49 [ ]
              Pass count: ___ / 42  ->  ___ / 42 * 210 = ___ pts  (of 210)

Composite score: ___ / 300
