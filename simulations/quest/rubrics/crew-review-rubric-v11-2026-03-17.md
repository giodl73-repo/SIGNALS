Written to `simulations/quest/rubrics/crew-review-rubric-v11-2026-03-17.md`.

---

**v11 summary: 1 new criterion extracted from R11.**

**New criterion:**

| ID | Pattern | Extends | Source |
|----|---------|---------|--------|
| C-33 | G2 closure predicate -- quantified N-verdict-for-N-slot form | C-32, C-20 | V-01 R11 |

**Structural logic:**
- C-32 → C-33: same named-gate-to-typed-closure escalation as C-17 → C-20.
  C-32 requires a named exit gate (G2) with a per-slot coverage condition; C-33 requires
  that condition to be quantified against the loaded slot count, making G2 closure
  correct-by-construction with respect to slot cardinality. A gate that says "closes when
  synthesis is done" satisfies C-32. A gate that says "G2 closes when N verdicts have been
  assigned for N loaded slots" satisfies C-33.
...
**R11 scores under v11:**
- V-01: 60 + 60 + 55.0 = **175.0** (all 22 aspirational PASS; C-33 PASS from G2 N-for-N
  closure predicate)

**Retroactive R10 scores under v11:**
- V-01 R10: 60 + 60 + 47.5 = **167.5** (C-29+C-30 PASS; C-31/C-32/C-33 FAIL; unchanged
  from v10)
- V-02 R10: 60 + 60 + 47.5 = **167.5** (same as V-01 R10; unchanged from v10)

**New relationship chain:**
- Synthesis gate quality: C-32 (G2 gate with named exit condition referencing per-slot
  coverage) -> C-33 (G2 gate with quantified N-verdict-for-N-slot closure predicate --
  gate closure correct-by-construction with respect to slot cardinality).
...
from R8. C-28 is from R9. C-29 through C-32 are from R10. C-33 is new from R11.
...
|----------|--------|--------|--------|-----------|---------|
| All pass | 5/5 | 6/6 | 22/22 | 60+60+55.0=175.0 | YES |
| All essential + 2 recommended | 5/5 | 2/6 | 0/22 | 60+20+0=80 | YES (at threshold) |
| All essential + all recommended | 5/5 | 6/6 | 0/22 | 60+60+0=120 | YES |
| All essential + 1 recommended | 5/5 | 1/6 | 0/22 | 60+10+0=70 | NO |
| 4 essential + all recommended | 4/5 | 6/6 | 0/22 | 48+60+0=108 | NO (essential gap) |
| All essential + 3 rec + 3 asp | 5/5 | 3/6 | 3/22 | 60+30+7.5=97.5 | YES |
| V-05 R7 equivalent (v7 perfect) | 5/5 | 6/6 | 14/22 | 60+60+35.0=155.0 | YES |
| V-01 R8 equivalent | 5/5 | 6/6 | 15/22 | 60+60+37.5=157.5 | YES |
| V-02 R8 equivalent | 5/5 | 6/6 | 15/22 | 60+60+37.5=157.5 | YES |
| V-01 R9 equivalent (under v11) | 5/5 | 6/6 | 16.5/22 | 60+60+41.25=161.25 | YES |
| V-02 R9 equivalent (under v11) | 5/5 | 6/6 | 15/22 | 60+60+37.5=157.5 | YES |
| V-01 R10 (under v11) | 5/5 | 6/6 | 19/22 | 60+60+47.5=167.5 | YES |
| V-02 R10 (under v11) | 5/5 | 6/6 | 19/22 | 60+60+47.5=167.5 | YES |
| V-01 R11 | 5/5 | 6/6 | 22/22 | 60+60+55.0=175.0 | YES |
| Perfect (v11) | 5/5 | 6/6 | 22/22 | 60+60+55.0=175.0 | YES |
...
- C-33 is a construction-time excellence signal from R11 V-01 (first perfect score under
  ...
  correct-by-construction with respect to slot completeness. The same step applied twice
  before: C-17 (gate exists) -> C-20 (gate has typed multi-condition closure); C-32 (G2
  gate exists) -> C-33 (G2 gate has quantified N-for-N slot closure).
...
- The full relationship chains:
  ...
  - Synthesis coverage: C-07 (minimum-count signal) -> C-22 (slot column anchors
    ...
    respect to slot cardinality).
  - Each step in each chain makes the prior criterion correct-by-construction rather than
    by instruction.
- V-05 R7 equivalent under v11: E=60, R=60, A=C-11 through C-25 all PASS (35.0) +
  C-26 through C-33 all FAIL (0). Composite = 155.0.
- V-01 R8 equivalent under v11: E=60, R=60, A=35.0 + C-26 PASS(2.5) + rest FAIL(0).
  Composite = 157.5.
- V-02 R8 equivalent under v11: E=60, R=60, A=35.0 + C-27 PASS(2.5) + rest FAIL(0).
  Composite = 157.5.
- V-01 R9 equivalent under v11: E=60, R=60, A=35.0 + C-26 PASS(2.5) + C-27 PARTIAL(1.25)
  + C-28 PASS(2.5) + C-29 through C-33 all FAIL(0) = 41.25. Composite = 161.25.
- V-02 R9 equivalent under v11: E=60, R=60, A=35.0 + C-27 PASS(2.5) + rest FAIL(0) = 37.5.
  Composite = 157.5.
- V-01 R10 under v11: E=60, R=60, A=42.5 (all v9 aspirational PASS) + C-29 PASS(2.5) +
  C-30 PASS(2.5) + C-31 FAIL(0) + C-32 FAIL(0) + C-33 FAIL(0) = 47.5. Composite = 167.5.
- V-02 R10 under v11: Same as V-01 R10. Composite = 167.5.
- V-01 R11 under v11: E=60, R=60, A=55.0 (all 22 aspirational PASS). Composite = 175.0.
- Scoring formula in v11: Essential 5 x 12 = 60, Recommended 6 x 10 = 60, Aspirational
  22 x 2.5 = 55.0. Max is 175.0. Golden threshold is composite >= 80 with all essential
  passing.
