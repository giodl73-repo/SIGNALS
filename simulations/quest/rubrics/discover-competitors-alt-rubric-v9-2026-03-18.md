The V-04 variation is titled "per-gate REQUIRED OUTPUTS blocks." C-25 requires TOKEN to appear in every gate's output specification (completion condition, template, or field list). V-04's structural pattern goes further: each gate carries a **dedicated, labeled REQUIRED OUTPUTS block** as a structurally separable artifact — not inlined into completion conditions or body prose.

That's one new criterion: **C-26**.

- Aspirational pool: 17 → 18 criteria, `10/18 ≈ 0.556` pts each.
...
## Aspirational Criteria (weight = 10 points total, 0.556 points each)
...
- **C-26 added** — per-gate REQUIRED OUTPUTS blocks. V-04's structural innovation is elevating TOKEN's output contract from completion conditions and inline specs (C-25) to dedicated, extractable REQUIRED OUTPUTS blocks per gate. C-26 depends on C-25.
- **Aspirational pool:** 17 → 18 criteria; per-criterion weight 0.588 → **0.556**.
- **Composite formula denominator:** 17 → **18**.
