...
| Scenario | Ess | Rec | Asp | R2 | R3 | R4 | Score | Golden? |
|----------|-----|-----|-----|----|----|----|-------|---------|
| All pass | 5/5 | 3/3 | 2/2 | 4/4 | 4/4 | 2/2 | 125 | Yes |
| R3 ceiling | 5/5 | 3/3 | 2/2 | 4/4 | 4/4 | 0/2 | 120 | Yes |
| R2 ceiling | 5/5 | 3/3 | 2/2 | 4/4 | 0/4 | 0/2 | 110 | Yes |
| Miss C-04 | fail | -- | -- | -- | -- | -- | n/a | No (essential fail) |
| Essential only | 5/5 | 0/3 | 0/2 | 0/4 | 0/4 | 0/2 | 60 | No |
| Essential + rec | 5/5 | 3/3 | 0/2 | 0/4 | 0/4 | 0/2 | 90 | Yes |
| Essential + 1 rec | 5/5 | 1/3 | 0/2 | 0/4 | 0/4 | 0/2 | 70 | No |
| V-02 R4 profile | 5/5 | 3/3 | 2/2 | 4/4 | 2/4 | 2/2 | 120 | Yes |
| V-03 R3 profile | 5/5 | 3/3 | 2/2 | 4/4 | 2/4 | 0/2 | 115 | Yes |
| V-01 R3 profile | 5/5 | 3/3 | 2/2 | 4/4 | 3/4 | 0/2 | 117.5 | Yes |

*V-02 R4 profile: passes C-15 (7 dimensions are mandatory structural sections)
and C-18 (feedback loop from preliminary paragraph to artifact); passes C-19
(peer test is imperative, sentence must appear in output) and C-20 (consequence
clause present -- forces swap if test fails); fails C-16 (no multi-phase check
structure) and C-17 scored at C-17 floor since C-19/C-20 are its extensions.
Net: 110 + 5 (C-15+C-18) + 5 (C-19+C-20) = 120.*

*V-03 R3 profile: passes C-16 (generation-phase imperative "do not mark top-5
yet") and C-18 (Check A/B/C/D phases explicitly feed top-5 and AMEND decisions);
fails C-15 (categories are scaffolding, not mandated sections) and C-17 (Check B
is interrogative -- "can you complete" not imperative). C-19/C-20 both fail
(same interrogative form as C-17 failure, no consequence clause). Net: 115.*

*V-01 R3 profile: passes C-15 (no -- V-01 lacks structural mandate), C-16 (no --
single-phase), C-17 (yes -- "Why these five and not the unmarked idea in the same
category?" is an embedded peer-comparison test), C-18 (no -- no dedicated check
phase). C-19 fails (peer test is interrogative); C-20 fails (no consequence
clause). Net: 110 + 2.5 (C-17) + 5 (C-16 fail, C-18 fail removed from R3 score)
= 117.5 as scored.*

*V-04 R4 profile requires validation run.*
