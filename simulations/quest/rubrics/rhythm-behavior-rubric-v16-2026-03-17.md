Written to `simulations/quest/rubrics/rhythm-behavior-rubric-v16-2026-03-17.md`.

---

**rhythm-behavior Rubric v16**

| | v15 | v16 |
|---|---|---|
| Aspirational denominator | 36 | **40** |
| New criteria | -- | C-44, C-45, C-46, C-47 |

**Four new criteria from R15:**

**C-44 -- Descriptive Register at Inter-Section Peer Slot Is a Qualifying Position for C-22** (format, R15)
Closes the last untested cell in the position-type x register matrix. Every confirmed position type (named section body, inter-section peer slot, top-of-prompt preamble) now has both imperative and descriptive register confirmations.

**C-45 -- Mixed-Register Dual Section-Body (Descriptive First, Imperative Subsequent) Composes Without Interaction** (format, R15)
C-38's "any subsequent qualifying placement is inert" clause is register-unrestricted. Descriptive-first + imperative-subsequent dual section-body composes cleanly.

**C-46 -- Mixed-Register Dual Section-Body (Imperative First, Descriptive Subsequent) Composes Without Interaction** (format, R15)
Reverse complement of C-45. C-33 + C-34 jointly absorb both register orderings. Neither ordering introduces a new constraint.

**C-47 -- Cross-Type Dual Placement (Section Body + Inter-Section Peer Slot, Descriptive) Is Position-Type-Agnostic** (format, R15)
Inertness generalizes to cross-type multi-placements: section-body first + inter-section peer slot second composes cleanly. The inertness principle is not restricted to same-type placements.

**Cross-references updated:** C-22 (R15 note), C-33 (R15 note), C-34 (R15 note), C-38 (R15 note). C-34 range updated to C-08 through C-47.
R15)
Confirmed in V-05. Inertness extends across position types: a descriptive section-body placement (first qualifying) satisfies C-22, and a descriptive inter-section peer slot placement (second qualifying, different position type) is inert. The general "first qualifying occurrence satisfies; subsequent are inert" principle is position-type-agnostic.
