Reading the scorecard notes for genuine new patterns — three excellence signals emerge that go beyond existing criteria:

1. **Verbatim mechanism verdict as required SEQUENCE input** (V-01/V-04 differentiation on C-17 — architectural handoff, not instruction)
2. **Inertia-relevance column propagating from Step 0 through inventory into CAUSAL GAP** (V-04 differentiation on C-15 — creates a traceable inertia thread, not a static declaration)
3. **Inertia case-strength as a dedicated named section** (V-02/V-04 differentiation on C-18 — structural elevation, not combined with readiness)

These become C-19, C-20, C-21. Denominator updates from `/10` to `/13`.

---

# Signal-Check Rubric — v6 (2026-03-17)
