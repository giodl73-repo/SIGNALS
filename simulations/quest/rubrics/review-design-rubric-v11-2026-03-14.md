Written to `simulations/quest/rubrics/review-design-rubric-v11-2026-03-14.md`.

---

**Three new criteria added (C-33, C-34, C-35):**

**C-33 | BLOCK 4 Unique Catch Finding Cell Content Completeness (F-25)**
The fourth instance of content-completeness-within-structural-presence. C-28 gave BLOCK 4 table form; F-16/C-24 gave reviewer identity. The Finding cell -- the actual catch -- had no content gate. F-25 closes it.

**C-34 | BLOCK 5 Amend Section Cell Content Completeness (F-26)**
The fifth instance of the same class, second on BLOCK 5. After F-24 closed Action, the Section cell remained without a halt -- a present-but-empty Section makes the amend non-localizable. F-26 closes it. All four BLOCK 5 columns now have content enforcement.

**C-35 | BLOCK 2 P1 Section Cell Named Halt Enforcement (F-27)**
A different enforcement class: prose-MUST-to-named-halt conversion. C-07 already required P1 section references in prose; F-27 makes that requirement inline-enforceable. Same class as F-06 (prose inversion requirement -> named halt) and F-05 (prose scope requirement -> named halt).

**Formula update:** denominator 25 -> 28. Each aspirational criterion ~0.357 pts. Ceiling 100 preserved.
o BLOCK 5.

**C-35 | BLOCK 2 P1 Section Cell Named Halt Enforcement (F-27)**
- Confirmed by: V-01 and V-02 scored 100 without it; V-03/V-04/V-05 carried it
- Pattern: C-07 (recommended) requires P1 findings to reference their design section; C-10
  established the Section column in BLOCK 2. The enforcement was prose-only -- no named F-ID
  fired on an empty P1 Section cell. F-27 converts this prose MUST into a named halt, applying
  the prose-MUST-to-named-halt conversion class to the one remaining prose-only traceability
  requirement.

**Formula:** denominator 25 -> 28. Each aspirational criterion now worth ~0.357 pts. Score ceiling
100 preserved.
...
Note: aspirational denominator changed from 25 to 28 in v11 (added C-33, C-34, C-35).
Each aspirational criterion contributes ~0.357 points at full pass.
