...
Reviewers must be drawn from the role registry at `.craft/roles/signal/`, not invented
...
`.craft/roles/signal/`. The output must enumerate the registry before selecting roles —
