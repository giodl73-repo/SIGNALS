Written to `simulations/quest/rubrics/corps-rob-rubric-v6-2026-03-16.md`.

---

**Three new criteria extracted from R5:**

| ID | Signal | Source |
|----|--------|--------|
| C-22 | Post-stage role-concern gap scan | V-01 "Role Concern Gaps" post-stage section -- dedicated audit verifying C-16 compliance across all stages |
| C-23 | Post-stage triage note gap scan | V-01 + V-03 "Triage Note Gaps" -- independently converged across two primary-axis variations |
| C-24 | Multi-type post-stage audit suite | V-01 three-section structure (Calibration Errors + Role Concern Gaps + Triage Note Gaps) simultaneously |

**Distinctions from existing criteria:**

- C-22 vs C-16: C-16 requires the pre-declaration within each stage. C-22 requires a post-stage audit that verifies compliance and surfaces gaps. C-16 can pass (declarations present) without C-22 (no audit). C-22 can be present when C-16 fails stages -- the scan makes failures explicit.
- C-23 vs C-18: C-18 requires a Triage Note per stage. C-23 requires a post-stage audit verifying that. Orthogonal: a run with all notes but no audit passes C-18, fails C-23. C-23 does not require C-18 to be scoreable.
- C-24 vs C-17: C-17 requires one enforcement section. C-24 requires three or more independent sections with distinct pre-commitment scopes. Scope diversity is required -- three calibration audits do not satisfy.

**Scoring impact:**

| | v5 | v6 |
|--|----|----|
| Aspirational pool | 13 x 5 = 65 | 16 x 5 = 80 |
| Max composite | 155 | 170 |
| Golden threshold | 80 (unchanged) | 80 (unchanged) |

**Retroactive R5 scores under v6:**

- V-01: 120 (+15 -- gains C-22, C-23, C-24; was 105)
- V-02: 115 (unchanged -- one post-stage section, no role-concern or triage note gap scans)
- V-03: 115 (+5 -- gains C-23; was 110)

| | v5 | v6 |
|--|----|----|
| Aspirational pool | 13 criteria x 5 pts = 65 | 16 criteria x 5 pts = 80 |
| Max composite | 155 | 170 |
| Golden threshold | 80 (unchanged) | 80 (unchanged) |

**Retroactive R5 scores under v6:**

- V-01: 120 (gains C-22 + C-23 + C-24, was 105)
- V-02: 115 (unchanged -- no role-concern gap scan, no triage note gap scan, only one post-stage section)
- V-03: 115 (gains C-23, was 110)
...
**Minimal pass (not golden)** -- all 5 essential pass, 1/3 recommended, 0/16 aspirational:
...
**Baseline golden** -- all 5 essential pass, 2/3 recommended, 0/16 aspirational:
...
**Strong** -- all 5 essential pass, 3/3 recommended, 2/16 aspirational:
...
**R5 V-01 equivalent** -- all essential, 2/3 recommended (C-07 + C-08), 8/16 aspirational
(C-12, C-13, C-14, C-17, C-19, C-22, C-23, C-24):
...
**R5 V-02 equivalent** -- all essential, 2/3 recommended (C-07 + C-08), 7/16 aspirational
(C-12, C-13, C-14, C-15, C-17, C-19, C-20):
...
**R5 V-03 equivalent** -- all essential, 2/3 recommended (C-07 + C-08), 7/16 aspirational
(C-12, C-13, C-14, C-18, C-19, C-21, C-23):
