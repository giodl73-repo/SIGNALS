...
**Criterion lineage -- C-17 is the trunk; C-19/C-20 are the first branch; C-21/C-22 are the second; C-23/C-24 are the tips:**
...
```
score = ess_pts + rec_pts + asp_pts + r2_asp_pts + r3_asp_pts + r4_asp_pts + r5_asp_pts + r6_asp_pts
```
...
| Scenario | Ess | Rec | Asp | R2 | R3 | R4 | R5 | R6 | Score | Golden? |
|----------|-----|-----|-----|----|----|----|----|-----|-------|---------|
| All pass | 5/5 | 3/3 | 2/2 | 4/4 | 4/4 | 2/2 | 2/2 | 2/2 | 135 | Yes |
| R5 ceiling | 5/5 | 3/3 | 2/2 | 4/4 | 4/4 | 2/2 | 2/2 | 0/2 | 130 | Yes |
| R4 ceiling | 5/5 | 3/3 | 2/2 | 4/4 | 4/4 | 2/2 | 0/2 | 0/2 | 125 | Yes |
| R3 ceiling | 5/5 | 3/3 | 2/2 | 4/4 | 4/4 | 0/2 | 0/2 | 0/2 | 120 | Yes |
| R2 ceiling | 5/5 | 3/3 | 2/2 | 4/4 | 0/4 | 0/2 | 0/2 | 0/2 | 110 | Yes |
| Miss C-04 | fail | -- | -- | -- | -- | -- | -- | -- | n/a | No (essential fail) |
| Essential only | 5/5 | 0/3 | 0/2 | 0/4 | 0/4 | 0/2 | 0/2 | 0/2 | 60 | No |
| Essential + rec | 5/5 | 3/3 | 0/2 | 0/4 | 0/4 | 0/2 | 0/2 | 0/2 | 90 | Yes |
| Essential + 1 rec | 5/5 | 1/3 | 0/2 | 0/4 | 0/4 | 0/2 | 0/2 | 0/2 | 70 | No |
| V-01 R5 profile | 5/5 | 3/3 | 2/2 | 4/4 | 4/4 | 1/2 | 1/2 | 1/2 | 125 | Yes |
| V-02 R5 profile | 5/5 | 3/3 | 2/2 | 4/4 | 4/4 | 1/2 | 1/2 | 1/2 | 125 | Yes |
| V-03 R5 profile | 5/5 | 3/3 | 2/2 | 4/4 | 4/4 | 2/2 | 2/2 | 1/2 | 132.5 | Yes |

*V-01 R5 profile: passes C-19 (imperative + batch gate) + C-21 (explicit sequencing) + C-23
(marking prohibition -- "do not place any `**` marks anywhere until all five Check B sentences
appear in your output"). Fails C-20 (no consequence clause -- intentional isolation), so C-22
and C-24 also fail (prerequisite absent). Net R4: 2.5 (C-19) + R5: 2.5 (C-21) + R6: 2.5 (C-23)
= 125.*

*V-02 R5 profile: passes C-20 (consequence clause) + C-22 (source specificity) + C-24
(rationalization block -- "Do not revise the marked idea's rationale to manufacture a
distinction"). Fails C-19 (interrogative form -- intentional isolation), so C-21 and C-23 also
fail (prerequisite absent). Net R4: 2.5 (C-20) + R5: 2.5 (C-22) + R6: 2.5 (C-24) = 125.*

*V-03 R5 profile: schema encoding satisfies all of C-19/C-20/C-21/C-22. For C-23: "the Top-5?
column cannot contain any entry until all 5 rows of this Registry are filled" -- column-level
marking prohibition present, C-23 PASS. For C-24: V-03 fixes the replacement source to the
Attempted Peer column value but does not explicitly prohibit post-comparison rationale revision
-- C-24 pending validation run. Shown as 1/2 on R6 pending. Net: 130 + 2.5 (C-23) = 132.5.*
