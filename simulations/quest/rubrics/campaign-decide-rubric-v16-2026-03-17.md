# campaign-decide-rubric-v16-2026-03-17.md

**Quest**: campaign-decide
**Version**: v16
**Date**: 2026-03-17
**Denominator**: /34 aspirational (17.0 pts total — 0.5 pts each)
**Max composite**: 107.0
...
| Aspirational | C-09..C-42 | 0.5 | 17.0 | Raise the bar |
| **Max composite** | | | **107.0** | |
...
**C-43 candidate (R16 Excellence Signal 3):** Deferred-column annotation at schema
definition time — encoding `(fill-now)` vs. `(defer-to-Phase-5)` directly in the SCHEMA
PREAMBLE lifecycle schema definition itself, so the temporal commit distinction propagates
from definition point to all downstream closure directives automatically. This raises
C-42's annotation requirement from the closure-directive level to the preamble-definition level.
