v9 rubric written to `simulations/quest/rubrics/discover-literature-rubric-v9-2026-03-19.md`.

---

**Two new criteria extracted from R8 excellence signals:**

| ID | Name | Source | What it closes |
|----|------|--------|----------------|
| **C-25** | N-of-4 Progressive Counter Annotation | V-04 R8 | C-23 compliance requires reading all four tokens to confirm the count; the N-of-4 counter makes compliance scannable from any single token and makes Phase 1/4 instrumentation self-evidently necessary |
| **C-26** | Named Independence Verification Block | V-04/V-05 R8 | C-24 compliance is inferrable from scattered pair annotations; the named block declares it explicitly, runs the remove-either-pair test verbatim, and makes C-24 a single grep target |

**Two failure confirmations codified as key decisions:**
- C-23 annotation requirement is strict (V-02/V-03 R8): bare token lines without annotation paragraphs fail C-23
- C-24 requires explicit PASS annotations (V-01 R8): prose describing token purpose without "C-NN PASS" language fails C-20 pass condition (c)

**Scoring delta:**

| | v8 | v9 |
|--|----|----|
| Aspirational criteria | 16 | 18 |
| Aspirational ceiling | 80 pts | 90 pts |
| Total ceiling | 170 | **180** |

**Dependency chains:**
- C-25: `C-16 -> C-18 -> C-22 -> C-23 -> C-25`
- C-26: `C-18 -> C-20 -> C-24 -> C-26`
4 FAIL for V-01 R8 -- prose annotation ("records the threshold shortfall in the body for auditing") without explicit "C-09 PASS, C-16 PASS" annotations does not satisfy C-20 pass condition (c).
...
**Eight-axis aspiration progression:**
...
**Ceiling trajectory**: v1: 120 -> v2: 125 -> v3: 130 -> v4: 140 -> v5: 150 -> v6: 155 -> v7: 160 -> v8: 170 -> **v9: 180**
...
## ASPIRATIONAL Criteria (90 points -- raise the bar once essential/recommended are stable)
