...
Create .craft/roles/governance/inertia-advocate.md:
...
Organize under .craft/roles/{area}/ with minimum 2 area subdirectories.

Every .craft/roles/{area}/{role}.md requires exactly these five fields:
...
Create .craft/roles/governance/inertia-advocate.md with fields:
orientation, lens, expertise, scope (verbatim template), collaborates_with.

**Gate output:**
- T2-IA-ROLE-PATH:     .craft/roles/governance/inertia-advocate.md
...
File location: .craft/roles/{area}/{role}.md
...
### Artifact B: .craft/roles/{area}/{role}.md
...
Layout schema:
  Minimum 2 area subdirectories under .craft/roles/
...
Location: .craft/roles/governance/inertia-advocate.md
...
MUST: create .craft/roles/governance/inertia-advocate.md.
...
MUST: every .craft/roles/{area}/{role}.md contains all five fields:
  orientation, lens, expertise, scope, collaborates_with.
...
FORBIDDEN: all roles in a single flat directory under .craft/roles/.
...
Create .craft/roles/governance/inertia-advocate.md now, before any other role file:
