...
If a required role has no file in `.craft/roles/`, construct it inline and label the source.
...
Role: signal:pm | .craft/roles/signal/pm.md
...
Role: signal:architect | .craft/roles/signal/architect.md
...
**pm**
Role: load `.craft/roles/signal/pm.md`. Index pm.lens.verify items as `pm.lens.verify[1]`,
...
**arch-board**
Role: load `.craft/roles/signal/architect.md`. Index lens items before writing findings.
...
Read `.craft/roles/` and load all available role files. For each role, extract orientation,
...
**pm**
Role: load `.craft/roles/signal/pm.md`. Use pm.lens.verify as review checklist.
...
**arch-board**
Role: load `.craft/roles/signal/architect.md`. Use architect.lens.verify and lens.simplify.
...
Role: load `.craft/roles/signal/pm.md`. Use pm.lens.verify as checklist.
...
Read `.craft/roles/` and load all available role files. For each role, extract and index:
...
Role: load `.craft/roles/signal/pm.md`. Index pm.lens.verify before writing any finding.
...
Role: load `.craft/roles/signal/architect.md`. Index architect.lens.verify and lens.simplify.
