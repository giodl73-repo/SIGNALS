...
Emit the inertia-advocate role in `.roles/inertia/inertia-advocate.md` with all five fields present: `orientation`, `lens`, `expertise`, `scope`, `collaborates_with`.
...
T3-IA-FILE: .roles/inertia/inertia-advocate.md
=== END RECORD: PHASE-3 ===
```
...
Cover minimum areas: Engineering, Product, Design, Data, Operations, cross-functional coordination. MUST create area subdirectories under `.roles/`. Minimum 2 area subdirs beyond `inertia/`.
...
MUST generate the inertia-advocate role as the final role. MUST place the file at `.roles/inertia/inertia-advocate.md`.
...
```
=== RECORD: PHASE-5 ===
T5-IA-FILE: .roles/inertia/inertia-advocate.md
...
Generate roles across: Engineering, Product, Design, Data, Operations, and cross-functional coordination. MUST group under area subdirectories. Minimum 2 area subdirs. MUST include `inertia-advocate` at `.roles/inertia/inertia-advocate.md`.
