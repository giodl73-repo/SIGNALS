...
If no files are found, DO produce a `ROLES-NOTE: No .roles/ files found. Using inferred roles:` block instead, with one inferred entry per role.
...
DO NOT invent role names unless no roles files are found.
If no files are found, produce a `ROLES-NOTE: No .roles/ files found. Using inferred roles:` block instead.
DO NOT write any other section until this block exists.
...
DO NOT invent role names unless no roles files are found.
If no files are found, produce `ROLES-NOTE: No .roles/ files found. Using inferred roles:` instead.
DO NOT write any other section until this block exists.
