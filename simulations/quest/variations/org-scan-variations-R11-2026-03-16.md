...
/ namespace structure / test coverage areas / SPECS.md or specs/ / .roles/ files.
...
Source types (scan at least 3 of 7): CLAUDE.md / dependency manifests / design/ dirs /
namespace structure / test areas / SPECS.md or specs/ / .roles/ files.
...
namespace structure / test areas / SPECS.md or specs/ / .roles/
