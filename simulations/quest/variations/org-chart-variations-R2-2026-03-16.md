...
If no files are found, produce a `ROLES-NOTE: No .craft/roles/ files found. Using inferred roles:` block with inferred entries.
...
Start by finding the roles for this org. Check `.craft/roles/` for any existing role definitions.
