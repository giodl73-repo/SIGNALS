...
Write the complete role to: .roles/{area}/{subrole}.md
...
Before writing, check if .roles/{area}/inertia-advocate.md exists.
...
File path: .roles/{area}/{subrole}.md
...
craftworks project's .roles/ directory.
...
Before you write anything, check whether .roles/{area}/inertia-advocate.md exists.
...
The file goes in .roles/{area}/{subrole}.md and follows a standard YAML frontmatter
