...
Read `.craft/roles/`. Produce a `ROLES-LOADED:` block listing every role found, one per line: `- [role name] — [one-line description from role file]`.

If no files are found, produce `ROLES-NOTE: No .craft/roles/ files found. Using inferred roles:` followed by inferred roles in the same format.
...
Read `.craft/roles/`. Produce a `ROLES-LOADED:` block: `- [role name] — [one-line description from role file]` per role. If no files found: `ROLES-NOTE: No .craft/roles/ files found. Using inferred roles:` with inferred roles in the same format.
...
Read `.craft/roles/`. Produce a `ROLES-LOADED:` block: `- [role name] — [one-line description]` per role. No files found: `ROLES-NOTE: No .craft/roles/ files found. Using inferred roles:` with inferred roles in same format. Nothing else before this block.
...
Read `.craft/roles/`. Produce a `ROLES-LOADED:` block: `- [role name] — [one-line description from role file]` per role found. If no files: `ROLES-NOTE: No .craft/roles/ files found. Using inferred roles:` with inferred roles in the same format. Nothing else before this block.
...
Read `.craft/roles/`. Produce a `ROLES-LOADED:` block: `- [role name] — [one-line description from role file]` per role. If no files: `ROLES-NOTE: No .craft/roles/ files found. Using inferred roles:` with inferred roles in the same format. Nothing else before this block.
