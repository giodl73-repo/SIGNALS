...
7. **.roles/** — What roles exist? What expertise do they represent?
...
- .roles/ files (explicit role definitions are strong headcount signals)
...
- .roles/ — explicit role definitions and expertise declarations
