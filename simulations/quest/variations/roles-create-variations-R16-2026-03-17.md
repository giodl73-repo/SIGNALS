...
-> **Gate 2b:** INERTIA-ADVOCATE-TEMPLATE -- output path. PASS: Output path confirmed as `.craft/roles/{area}/inertia-advocate.md`. / FAIL
...
-> **Gate 2b:** Companion output path is exactly `.craft/roles/{area}/inertia-advocate.md`. PASS / FAIL
...
-> **Gate 2b:** Companion output path is exactly `.craft/roles/{area}/inertia-advocate.md`. PASS: Path confirmed. / FAIL
