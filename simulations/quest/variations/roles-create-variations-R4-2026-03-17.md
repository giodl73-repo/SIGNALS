...
Generate a YAML frontmatter block for `.craft/roles/{area}/{subrole}.md`.
...
```
[A] Will the main role file be written to `.craft/roles/{area}/{subrole}.md` (not current directory, not simulations/)? YES / NO
...
Write in this order:
1. If inertia-advocate was generated in Phase 2: write to `.craft/roles/{area}/inertia-advocate.md`.
2. Write the main role file to `.craft/roles/{area}/{subrole}.md`.
...
| Check | Status |
|-------|--------|
| Does `.craft/roles/{area}/inertia-advocate.md` exist? | YES / NO |
...
Generate the YAML frontmatter for `.craft/roles/{area}/{subrole}.md`. All fields required.
...
| # | Check | Result |
|---|-------|--------|
| A | Main role file path is `.craft/roles/{area}/{subrole}.md` (not current dir, not simulations/) | YES / NO |
...
→ **Gate 2b:** Companion file will be written to `.craft/roles/{area}/inertia-advocate.md`. ✓
...
Generate YAML frontmatter for `.craft/roles/{area}/{subrole}.md`.
...
Write in order:
1. If companion generated: `.craft/roles/{area}/inertia-advocate.md`
2. Main role: `.craft/roles/{area}/{subrole}.md`
...
> - [A] Main role file path is `.craft/roles/{area}/{subrole}.md`
