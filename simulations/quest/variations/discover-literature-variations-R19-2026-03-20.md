...
| V-02 | Interior-gap: C-34 skipped (chain: `... -> C-33 -> C-35 -> C-36 complete`) | C-37 FAIL = 230/235 |
| V-03 | Interior-gap: C-35 skipped (chain: `... -> C-33 -> C-34 -> C-36 complete`) | C-37 FAIL = 230/235 |
| V-04 | Double interior-gap: both C-34 and C-35 skipped (chain: `... -> C-33 -> C-36 complete`) | C-37 FAIL = 230/235 |
...
**C-37** requires the chain-completion statement within the `#### C-33 Compliance Declaration` sub-section to name all links from C-14 + C-23 through C-36 as the current terminal. Two failure modes are specified:

- **Wrong-terminal failure**: chain ends at a prior ceiling (e.g., `C-33 complete` -- the C-35 canonical form) rather than being extended to C-36.
- **Interior-gap failure**: chain reaches C-36 as terminal but skips one or both of C-34 and C-35.

**Why each variation fails/passes:**

- **V-01** fails: chain ends at `C-33 complete` -- the C-35 canonical form. Never extended when C-34, C-35, and C-36 were added in R16-R18. Wrong-terminal failure.

- **V-02** fails: chain reaches C-36 but skips C-34 (reads `... -> C-33 -> C-35 -> C-36 complete`). Interior-gap failure.

- **V-03** fails: chain reaches C-36 but skips C-35 (reads `... -> C-33 -> C-34 -> C-36 complete`). Interior-gap failure.

- **V-04** fails both interior-gap conditions: chain skips both C-34 and C-35 (reads `... -> C-33 -> C-36 complete`). Two independent interior-gap failures; either alone would fail C-37.

- **V-05** passes: chain reads `... -> C-33 -> C-34 -> C-35 -> C-36 complete`. All links present, terminal correct. C-37 PASS.

Note: All five variations include the structural analogy statement correctly placed inside the `#### C-33 Compliance Declaration` sub-section, naming both C-34/C-33 and C-25/C-23. C-36 PASS in all five. C-37 is the sole differentiator.

---

## V-01 -- Wrong-terminal: chain ends at C-33 complete

**Axis**: Chain-completion statement ends at `C-33 complete` -- copied from the C-35 canonical form; not extended to include C-34, C-35, or C-36
**Hypothesis**: C-36 PASS, C-37 FAIL = 230/235
...
**Axis**: Chain-completion statement reaches C-36 as terminal but omits C-34 -- the link added in R16; chain reads `... -> C-33 -> C-35 -> C-36 complete`
**Hypothesis**: C-36 PASS, C-37 FAIL = 230/235

The prompt is identical to V-01 through the C-29 block and C-32 PASS declaration. Only the `#### C-33 Compliance Declaration` sub-section differs:
...
C-14 + C-23 -> C-27 -> C-28 -> C-29 -> C-30 -> C-31 -> C-32 -> C-33 -> C-35 -> C-36 complete
...
**Axis**: Chain-completion statement reaches C-36 as terminal but omits C-35 -- the link added in R17; chain reads `... -> C-33 -> C-34 -> C-36 complete`
**Hypothesis**: C-36 PASS, C-37 FAIL = 230/235

Phases 1-4 and the C-29 block through C-32 PASS are identical to V-02. Only the `#### C-33 Compliance Declaration` sub-section differs:
...
This token: C-09 PASS, C-16 PASS. Pair 1, Token A.
...
C-14 + C-23 -> C-27 -> C-28 -> C-29 -> C-30 -> C-31 -> C-32 -> C-33 -> C-34 -> C-36 complete
...
**Axis**: Chain-completion statement reaches C-36 as terminal but skips both C-34 and C-35; chain reads `... -> C-33 -> C-36 complete`. Two independent interior-gap failures; either alone would fail C-37.
**Hypothesis**: C-36 PASS, C-37 FAIL = 230/235

Phases 1-4 and the C-29 block through C-32 PASS are identical to prior variations. Only the `#### C-33 Compliance Declaration` sub-section differs:
...
C-14 + C-23 -> C-27 -> C-28 -> C-29 -> C-30 -> C-31 -> C-32 -> C-33 -> C-36 complete
...
## V-05 -- Full synthesis: chain correctly extended to C-36 as terminal (C-37 PASS)

**Axis**: Chain-completion statement names all links in order: `C-14 + C-23 -> ... -> C-33 -> C-34 -> C-35 -> C-36 complete`. Both C-34 and C-35 present as interior links; C-36 is the terminal.
