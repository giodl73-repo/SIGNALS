...
Identify at least two charter constraints from .craft/roles/ that must be honored in Phase 1:
- Quorum requirement.
...
**Designated Inertia Challenger:** [participant name], [role from .craft/roles/]
...
Load .craft/roles/ for this committee type. List participants. The Designated Inertia
...
Name at least two charter constraints from .craft/roles/ to honor in Phase 1:
- Quorum requirement.
- Veto holder and conditions.
- Escalation path.
- Scope boundary.
...
**Designated Inertia Challenger:** [name], [role from .craft/roles/]
...
| Constraint | Requirement from .craft/roles/ | Honor Condition |
|------------|-------------------------------|-----------------|
