...
- Path: `.craft/roles/governance/inertia-advocate.md`
...
For each role, create `.craft/roles/{area}/{role-name}.md` with exactly these five fields:
...
- [ ] `.craft/roles/governance/inertia-advocate.md` exists with all 5 fields
...
## Output 2: .craft/roles/ Files

### Role File Template

Path: `.craft/roles/{area}/{role-name}.md`
...
**Inertia-Advocate** must be present at `.craft/roles/governance/inertia-advocate.md`.
...
Minimum 2 subdirectories under `.craft/roles/`. Example areas: engineering, product, design, data, platform, go-to-market, governance.
...
Now create the named voice of inertia. File: `.craft/roles/governance/inertia-advocate.md`
...
Generate `.craft/roles/{area}/{role-name}.md` for every role in the org.
...
**Area subdirectories**: Group roles under minimum 2 area subdirs under `.craft/roles/`.
...
```markdown
Build a complete org model. Two outputs: `org-chart.md` and a set of `.craft/roles/` files.
...
File: `.craft/roles/governance/inertia-advocate.md`
...
One file per role: `.craft/roles/{area}/{role-name}.md`
...
Create `.craft/roles/governance/inertia-advocate.md` now, before the org diagram. This role's `scope` field must reference the FLAT-CASE-PRESSURE rating from B3:
...
Generate `.craft/roles/{area}/{role-name}.md` for every role.
...
**Area subdirectories**: minimum 2 under `.craft/roles/`.
