...
No .roles/ files will be written.
...
- Do NOT write .roles/ file content anywhere in this output
...
No .roles/ files will be written anywhere in this output.
...
- Don't write or draft any .roles/ file content — that's corps-build's job, not yours
...
2. Don't write .roles/ file content anywhere — that's corps-build's job, not yours
...
No .roles/ files will be written at any point.
