...
|----|-----------|----------|
| A | Main role file path is `.craft/roles/{area}/{subrole}.md` -- not current directory, not `simulations/`, not any other path | Phase 6 setup |
...
```
[A] Main role file path is .craft/roles/{area}/{subrole}.md? ___
