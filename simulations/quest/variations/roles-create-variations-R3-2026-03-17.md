...
Template A: inertia-advocate companion (generate only if .craft/roles/{area}/inertia-advocate.md
...
Step 2 -- Inertia-advocate check
  ...
  Does .craft/roles/{area}/inertia-advocate.md exist?
...
If NO: fix the issue in the stored draft before proceeding to Phase 7.
  ...
  [A] Does .craft/roles/{area}/{subrole}.md exist as the output path? (not current dir, not simulations/)
...
When .craft/roles/{area}/inertia-advocate.md is absent, generate this complete file.
