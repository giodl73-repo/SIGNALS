...
Before writing any structural content, load roles from .craft/roles/.
...
If no roles are found, emit:
  ROLES-NOTE: No .craft/roles/ files found. Inferring roles from context; treat as provisional.
...
Load roles from .craft/roles/. List every file found.
...
Load roles from .craft/roles/. If none found, infer and emit ROLES-NOTE.
...
Look in .craft/roles/. Tell me what you found:
