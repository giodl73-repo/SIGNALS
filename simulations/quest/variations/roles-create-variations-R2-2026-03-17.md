...
Before writing, check whether .craft/roles/{area}/inertia-advocate.md exists.
...
ABSENT: Generate a complete inertia-advocate companion file before the main role.
        ...
        Write to .craft/roles/{area}/inertia-advocate.md.
...
Check .craft/roles/{area}/inertia-advocate.md.
...
Write this file to: .craft/roles/{area}/inertia-advocate.md
...
Write in this order:
  1. .craft/roles/{area}/inertia-advocate.md  (if generated in Step 2)
  2. .craft/roles/{area}/{subrole}.md
...
A role file is a YAML frontmatter document at .craft/roles/{area}/{subrole}.md. It describes
...
Before writing the requested role, check whether .craft/roles/{area}/inertia-advocate.md
...
the companion file to .craft/roles/{area}/inertia-advocate.md before the main role.
...
Check: .craft/roles/{area}/inertia-advocate.md -- does it exist?
...
Write in this order:
  1. .craft/roles/{area}/inertia-advocate.md  (only if generated in Phase 2)
  2. .craft/roles/{area}/{subrole}.md
