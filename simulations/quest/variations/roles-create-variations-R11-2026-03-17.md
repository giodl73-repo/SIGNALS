...
FRONTMATTER GENERATION -- with area and subrole confirmed, all 12 fields are generated. CONTRACT: FIELD-REGISTER applied. All 12 frontmatter fields generated for `.roles/{area}/{subrole}.md`. If any gate fails, correct the specific field using the FIELD-REGISTER register table and re-run the failed gate before advancing to Phase 4.
