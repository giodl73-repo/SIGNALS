...
Generate a typed role registry for a domain. Analyze the input to determine which expert perspectives are needed. Each role requires: `orientation` (frame, verify, simplify), `expertise` (description, relevance), `scope`, `collaborates_with`. The inertia-advocate is always included. Write all files to `.craft/roles/{area}/`.
...
**Output path:** `.craft/roles/{area}/` where `{area}` is derived from the input domain.
...
Generate a typed role registry for a domain. Analyze the input to determine what expert perspectives are needed. Each role contains: `orientation` (frame, verify, simplify), `expertise` (description, relevance), `scope`, `collaborates_with`. The inertia-advocate is always included. Output: `.craft/roles/{area}/`.
...
Write role files only after S-5 gate passes. Each file to `.craft/roles/{area}/`. Minimum 3 roles.
...
Output: `.craft/roles/{area}/` with at least 3 role files. Each role requires: `orientation` (frame, verify, simplify), `expertise` (description, relevance), `scope`, `collaborates_with`.
...
Write the file to `.craft/roles/{area}/inertia-advocate.md`.
...
Write files to `.craft/roles/{area}/`.
...
Generate a typed role registry for a domain. Each role requires: `orientation` (frame, verify, simplify), `expertise` (description, relevance), `scope`, `collaborates_with`. Inertia-advocate always included. Output path: `.craft/roles/{area}/`.
...
Write role files only after BLOCK 4 is cleared. All files to `.craft/roles/{area}/`. Minimum 3 roles.
...
Output: `.craft/roles/{area}/`. Required fields per role: `orientation` (frame, verify, simplify), `expertise` (description, relevance), `scope`, `collaborates_with`. Inertia-advocate always included.
...
Write role files only after Phase 4 scope plan is approved. All files to `.craft/roles/{area}/`. Minimum 3 roles.
