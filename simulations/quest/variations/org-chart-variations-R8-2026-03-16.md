...
Generate an org structure for the product or domain provided. Read `.roles/` for role grounding. Output: `org-chart.md` containing ASCII org diagram, headcount by area, committee charters, and operating rhythm table.
...
Read every file in `.roles/`. Under the heading `ROLES-LOADED`, list every role name found.

If `.roles/` is absent or empty, emit:

> `ROLES-NOTE: No .roles/ directory found. Role names inferred from context.`
...
Generate an org structure for the product or domain provided. Read `.roles/` for role grounding. Output: `org-chart.md` with ASCII org diagram, headcount by area, committee charters, and operating rhythm table.
...
| DO | DO NOT |
|----|--------|
| Read every file in `.roles/` | Introduce role names not found in `.roles/` |
...
Emit `ROLES-LOADED:` followed by all role names from `.roles/`. If the directory is absent or empty: `ROLES-NOTE: No .roles/ directory found. Role names inferred from context.`
...
Read all files in `.roles/`. Emit `ROLES-LOADED:` with every role name found.

If `.roles/` is absent or empty: `ROLES-NOTE: No .roles/ directory found. Role names inferred from context.`
...
| DO | DO NOT |
|----|--------|
| Emit `ROLES-LOADED` with all role names from `.roles/` | Introduce role names not found in `.roles/` |
| Emit `ROLES-NOTE` if `.roles/` is absent | Skip `ROLES-NOTE` when directory is missing |
...
Read all files in `.roles/`. Emit `ROLES-LOADED:` with every role name found. If absent or empty: `ROLES-NOTE: No .roles/ directory found. Role names inferred from context.`
...
| DO | DO NOT |
|----|--------|
| Read all files in `.roles/`; emit `ROLES-LOADED:` | Introduce any role name not found in `.roles/` |
| Emit `ROLES-NOTE` when `.roles/` is absent | Omit `ROLES-NOTE` when the directory is missing |
...
Read every file in `.roles/`. Emit `ROLES-LOADED:` with all role names. If absent or empty: `ROLES-NOTE: No .roles/ directory found. Role names inferred from context.`
