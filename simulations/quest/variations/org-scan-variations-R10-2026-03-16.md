...
| Source Type | REQUIRED | CLAUDE.md / package.json / design/ / namespace-structure / test-coverage / SPECS.md / .roles-roles |
...
7. Existing .roles/ files -- declared role structure
...
Source types (scan at least 3 of 7): CLAUDE.md / package.json / design/ / namespace-structure / test-coverage / SPECS.md / .roles-roles
