...
- .craft/roles/{area}/{role}.md — one file per role with all five fields:
...
2. Group all enumerated roles into area subdirectories.
   Each area becomes a subdirectory under .craft/roles/{area}/.
...
MUST include inertia-advocate as a named role file under .craft/roles/.
MUST create minimum 2 area subdirectories under .craft/roles/.
...
**Sub-step ROLE-FILES:**
2. Write one .craft/roles/{area}/{role}.md file per enumerated role.
...
MUST include inertia-advocate role file under .craft/roles/.
...
**Sub-step AREA-GROUPING:**
2. Group all enumerated roles into area subdirectories under .craft/roles/{area}/.
...
MUST include inertia-advocate role under .craft/roles/.
MUST create minimum 2 area subdirectories under .craft/roles/.
...
**Sub-step ROLE-FILES:**
2. Write one .craft/roles/{area}/{role}.md per role.
...
MUST include all five role file fields in every .craft/roles/ file.
...
**Sub-step AREA-GROUPING:**
2. Group roles into area subdirectories under .craft/roles/{area}/.
...
MUST include inertia-advocate under .craft/roles/.
...
**Sub-step ROLE-FILES:**
2. Write one .craft/roles/{area}/{role}.md per enumerated role.
   Every file includes: orientation, lens, expertise, scope, collaborates_with.
...
- org-chart.md — ASCII hierarchy, headcount-by-area table, operating rhythm,
  committee charters, inertia assessment, evolution roadmap, anti-pattern watch
- .craft/roles/{area}/{role}.md — one file per role: orientation, lens,
...
1. Define the inertia-advocate role as file zero under .craft/roles/.
...
3. Group all roles including the anchor into area subdirectories.
   Create minimum 2 area subdirectories under .craft/roles/{area}/.
...
**Sub-step IA-ANCHOR (first):**
1. Write the inertia-advocate role file as role zero under .craft/roles/.
...
MUST include all five fields in every .craft/roles/ file.
