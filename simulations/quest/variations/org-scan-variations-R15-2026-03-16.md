...
files, and existing .roles/ entries. Produce raw analysis: areas of work, team boundaries,
...
(5) test coverage areas, (6) SPECS.md files, (7) .roles/ entries. For each area found,
