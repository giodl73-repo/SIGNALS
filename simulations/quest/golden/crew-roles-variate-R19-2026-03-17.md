...
Emit each check result before running the next.
  ...
  Check 7: All files are at .craft/roles/{domain}/. Emit: PASS or FAIL
...
Emit each check result before running the next.
  ...
  CHECK 7: All files at .craft/roles/{domain}/. PASS/FAIL
...
Emit each check result before running the next.
  ...
  CHECK 7: All files at .craft/roles/{domain}/. CHECK 7: PASS/FAIL
