...
7. .craft/roles/ directories and role definition files
...
UNDEFINED-BOUNDARY — No clear team ownership; work is claimed ad hoc. Signal: absent .craft/roles/, absent owner fields in CLAUDE.md.
...
7. .craft/roles/ directories: List all role definition files. Note which areas have defined roles and which do not.
...
| UNDEFINED-BOUNDARY | No declared ownership; claimed ad hoc | Absent .craft/roles/, absent owner fields |
...
Step 3: For each pattern, identify which of the 7 source types (CLAUDE.md, package.json, design/, namespace directories, test coverage, SPECS.md, .craft/roles/) would most likely evidence it.
...
7. Read .craft/roles/ files. Note which areas have defined roles.
