...
- `.roles/{area}/{role}.md` — typed role files (orientation, lens, expertise, scope,
...
**Sub-step 2-C — FILE**: Write each `.roles/{area}/{role}.md` file. Every file MUST
...
- `.roles/{area}/{role}.md` — typed role files for every enumerated role
...
**Sub-step 2-C — FILE**: Write each `.roles/{area}/{role}.md` file.
...
- [ ] `.roles/` has min 2 area subdirs; all 5 fields present in every role file
...
**Sub-step 1-C — FILE**: Write each `.roles/{area}/{role}.md` file.
Every file MUST contain: `orientation`, `lens`, `expertise`, `scope`, `collaborates_with`.
...
3. **FILE** — MUST write each `.roles/{area}/{role}.md` file.
