...
INVARIANT: No .craft/roles/ file content, role file markdown, or instruction to create role files
...
no .craft/roles/ files will be written" appears as the first output line and no role file content
