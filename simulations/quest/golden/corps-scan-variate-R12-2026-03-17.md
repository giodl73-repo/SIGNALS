...
[ ] C-05 -- no .craft/roles/ files, role file content, or role-creation instructions.
...
> C-05 ACKNOWLEDGED in GATE: no .craft/roles/ content here."
...
> with selected mode]. C-05 ACKNOWLEDGED in GATE: no .craft/roles/ content here."
...
[ ] C-05 -- no .craft/roles/ files.                  STATUS: ACKNOWLEDGED — essential failure;
...
> C-05 ACKNOWLEDGED: no .craft/roles/ content here."
...
human review. No `.craft/roles/` files will be written here.
...
[ ] C-05 -- you will not write .craft/roles/ files here.    STATUS: ACKNOWLEDGED — if you do,
...
> Hypothesis [YES -- CONFIRMED | YES -- OVERTURNED] — [label]. C-05: no .craft/roles/ content."
...
> Inertia Advocate status: [sound | needs reconstruction]. C-05 ACKNOWLEDGED: no .craft/roles/."
