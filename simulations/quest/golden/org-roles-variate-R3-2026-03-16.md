...
Write one `.md` file per role to `.roles/{area}/`. Write domain-expert roles first (Phase 1), then stock roles (Phase 2).
...
Write one `.md` file per role to `.roles/{area}/`. Domain-expert roles first (Phase 1), then stock roles (Phase 2).
...
1. One file exists per role at `.roles/{area}/`
...
Write `.roles/{area}/REGISTRY.md` containing all five required fields:
...
Write one `.md` file per role to `.roles/{area}/`. Write domain-expert roles first, then stock roles.
