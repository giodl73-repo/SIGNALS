...
Load .craft/roles/ for this committee type. List every participant. For each participant,
...
Name at least two charter constraints from .craft/roles/ that were honored in this meeting.
...
|----------|-------------|------|------------------------------|----------------|
| 1 | [name] | [role from .craft/roles/] | [their one concern, one sentence] | [Standing / Candidate: function] |
| 2 | [name] | [role] | [concern] | [Standing / Candidate: function] |
| ... | | | | |

Rules:
- Load .craft/roles/ for this committee type.
...
FAILS: entries not tied to language or constraints from .craft/roles/ -- C-10 partial.
...
Load .craft/roles/ for this committee type. List every participant with their role and
...
Identify at least two charter constraints from .craft/roles/ that must be honored during
Phase 1:
- Quorum requirement.
...
Load .craft/roles/. List every participant. State the one concern each participant owns.
...
Name two or more constraints from .craft/roles/ that were honored. State each explicitly.
...
|-----|-------------|------|-----------------|----------------|
| 1 | [name] | [role from .craft/roles/] | [one concern -- one sentence] | [Standing / Candidate: function] |
| 2 | [name] | [role] | [concern] | [Standing / Candidate: function] |
| ... | | | | |
...
|------------|--------------------|-----------------------|
| Quorum | [requirement from .craft/roles/] | Yes |
