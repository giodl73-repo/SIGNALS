...
STEP 3 -- Workspace config files: check package.json, *.yaml workspace manifests, *.toml,
  .roles/org.yaml if present; extract named workspaces or service definitions.
STEP 4 -- CLAUDE.md and role files: read CLAUDE.md entries and any .roles/ files present;
...
STEP 4 -- CLAUDE.md and role files (.roles/)
...
Assert: IVR-P1-B: no .roles/ file content present anywhere in response -- PASS / FAIL
...
Emit:   IVR-P3-F: traceability statement "All team areas traced to Phase 2 inventory. C-05 active: no .roles/ content." immediately preceding YAML fence -- PASS / FAIL
...
**IVR-P1-A -- Scope boundary output**
INVARIANT: First output line: "DRAFT org.yaml for human review -- no .roles/ files will be
written in this response."
VIOLATION: Structural content (table, YAML, prose) precedes boundary declaration.
REPAIR: Output declaration as line 1.

**IVR-P1-B -- Role file exclusion**
INVARIANT: No .roles/ file content anywhere in response.
