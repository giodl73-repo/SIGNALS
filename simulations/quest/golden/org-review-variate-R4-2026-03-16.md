...
from `.craft/roles/signal/`, collect structured findings per role, and emit a commitment
disposition.
...
**Second: Pick your reviewers.** Read `.craft/roles/signal/`. Don't invent roles.
...
Read `.craft/roles/signal/`. Select reviewers.
...
Read `.craft/roles/signal/`. Select:
...
`.craft/roles/signal/`, collect structured findings, and emit a commitment disposition.
...
**2. Reviewer selection.** Read `.craft/roles/signal/`. No invented roles.
