...
Load .roles/ for this committee type. List every participant.

| Seq | Participant | Role | Primary Concern This Meeting | Charter Status |
|-----|-------------|------|------------------------------|----------------|
| 1   | [name]      | [role from .roles/] | [one concern] | [Standing / Candidate: function] |
| ... |             |                            |               |                                   |
...
| Seq | Participant | Role | Tier | Primary Concern | Charter Status |
|-----|-------------|------|------|-----------------|----------------|
| 1   | [name]      | [role from .roles/] | T1 | [one concern aligned with role function] | [Standing / Candidate: function -- pending confirmation] |
...
FAILS: charter constraints not sourced from .roles/ language -- C-10 partial.
