...
[ ] C-05 -- no .craft/roles/ files:
    I will not write .craft/roles/ files, include role file content, or instruct the user
...
> Schema has [n] rows. C-05 active: no .craft/roles/ content."
...
.craft/roles/ content: [NONE / FOUND]
...
[ ] C-05 -- no .craft/roles/ files:
    No .craft/roles/ files, role file content, or role-creation instructions appear anywhere
    in this output.
...
> [n] rows. C-05 active: no .craft/roles/ content."
...
[ ] exec-office present                                     STATUS: [CONFIRMED / FAIL]
[ ] At least one group container above teams                STATUS: [CONFIRMED / FAIL]
[ ] No .craft/roles/ content in any role's output          STATUS: [CONFIRMED / FAIL]
...
REQ-2 (C-05): No .craft/roles/ files, role file content, or role-creation instructions.
...
[ ] C-05 -- I confirm I will not write .craft/roles/ files          STATUS: CONFIRMED
...
> inventory. REQ-2 (C-05) active: no .craft/roles/ content in this phase."
...
[ ] C-05 -- no .craft/roles/ content in Phase 3                    STATUS: [CONFIRMED / FAIL]
...
[ ] C-05 -- no .craft/roles/ content in any phase                 STATUS: CONFIRMED
