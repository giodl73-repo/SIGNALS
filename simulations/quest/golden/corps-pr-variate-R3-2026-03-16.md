...
Read `org.yaml`, the PR diff, and `.craft/roles/` before any output begins.
...
Open `.craft/roles/`. Know what each person in that room actually worries about —
...
What I look at: [one phrase from .craft/roles/ — the failure mode I am trained to catch]
...
Scope: [one phrase from .craft/roles/]
