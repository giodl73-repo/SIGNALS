...
STEP 3 -- Workspace config files: check package.json, *.yaml workspace manifests, *.toml,
  .roles/org.yaml if present; extract named workspaces or service definitions as Signal rows.
...
**IVR-P1-A -- Scope boundary output**
INVARIANT: Emit as first output line: "DRAFT org.yaml for human review -- no .roles/
files will be written in this response."
VIOLATION: Structural content (table, YAML, prose) precedes boundary declaration.
REMEDIATION: Emit declaration as line 1. Emit nothing before it.

**IVR-P1-B -- Role file exclusion**
INVARIANT: Verify: no .roles/ file content, role file markdown, or create-role-file
...
"All team areas traced to Phase 2 inventory. C-05 active: no .roles/ content."
