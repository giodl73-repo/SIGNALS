# trace-state — Simplified Golden Prompt (QU5)
# Three variations: V-01 (single-domain reference), V-04 (two-domain), V-05 (three-domain)

---

## V-01 — Single Domain: Sales (Tabular, IS-NOT/IS Contrast)
...
**C-54 REQUIREMENT.** The remediation implication IS REQUIRED to use IS-NOT/IS canonical contrast form: "IS NOT an [epoch-label] finding; IS a [structural-role] finding." This contrast MUST appear within the remediation implication body — not only in preamble, criterion annotation, or section header. A remediation that IS role-grounded without the explicit IS-NOT/IS contrast IS C-49/C-51 synergy-activated but IS NOT C-54-compliant.
...
## V-04 — Two-Domain: Finance to Sales (C-54 Per Domain + C-55 Cross-Domain Handoff)
...
*(same structure as V-01; Sales domain: Proposal, Negotiation, Committed, Closed-Won, Closed-Lost; VOCABULARY CLOSED preamble IS NOT a label for the Sales domain)*
...
## V-05 — Three-Domain: Finance to Sales to CS (C-54 Per Domain + C-55 at Both Handoff Boundaries)
