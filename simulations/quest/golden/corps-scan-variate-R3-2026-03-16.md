...
`.craft/roles/` files, includes role file content, or instructs the user to create role files.
...
Item 3 — C-05 ROLE FILE EXCLUSION:
  Requirement: No .craft/roles/ files, role file content, or role-creation instructions.
  Obligation: I will not write .craft/roles/ files at any point in this output.
...
**DRAFT-ONLY: This output is a draft org.yaml for human review. No `.craft/roles/` files will
...
- **R2 (maps to C-05)**: No `.craft/roles/` files, role file content, or role-creation
...
> active. No .craft/roles/ content will appear."
...
.craft/roles/ content: [NONE / FOUND — if FOUND, list location]
...
**DECLARATION: This output is a draft org.yaml for human review. No `.craft/roles/` files will
...
This output does not write `.craft/roles/` files, does not include role file content, and does
...
> "Producing org.yaml draft. Requirements 2, 4, 5, 6 active. No .craft/roles/ content."
...
Requirement 2 (no role files): [SATISFIED — no .craft/roles/ content produced]
...
[ ] C-12 DRAFT BOUNDARY: The draft-only statement below is the first substantive line of
    ...
    Statement: "This output is a draft org.yaml for human review. No .craft/roles/ files
...
[ ] C-05 ROLE FILE EXCLUSION: I will not write .craft/roles/ files, include role file content,
...
> No .craft/roles/ content in this output."
...
`.craft/roles/` files will be written in this response.**
...
[ ] C-05 ROLE FILES: I confirm I will not write .craft/roles/ files            STATUS: CONFIRMED
...
[ ] exec-office section present                                       STATUS: [CONFIRMED / FAIL]
[ ] At least one group container above teams                          STATUS: [CONFIRMED / FAIL]
[ ] No .craft/roles/ content produced in Phase 3                     STATUS: [CONFIRMED / FAIL]
...
[ ] Draft-only constraint: no .craft/roles/ content in any prior phase        STATUS: CONFIRMED
...
[ ] corps-scan complete — no .craft/roles/ content in any phase                STATUS: CONFIRMED
```
