...
Start by identifying what kind of committee is meeting and who's in the room. Read `.craft/roles/` to find the charter for this committee type. If no charter file exists, use Signal defaults: PM, Architect, and Inertia-Advocate.
