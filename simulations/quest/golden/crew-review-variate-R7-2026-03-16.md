...
| Role | string -- filename stem from `.roles/` at execution time | NOT: invented names; names recalled from prior runs; any name absent from the registry at this execution. |
...
|--------|--------------|----------------------|
| Role | string -- filename stem from `.roles/` at execution time | NOT: invented names; names recalled from prior runs; any name not in the registry at this execution |
...
- Role cell: filename stem exists in `.roles/` at this execution -- not invented.
...
| Column | Type -- valid | Anti-pattern excluded |
|--------|--------------|----------------------|
| Role | string -- filename stem from `.roles/` at execution time | NOT: invented names; names from memory or prior runs |
...
| Role | string -- filename stem from `.roles/` at execution time | NOT: invented names; names not in the registry at this execution. |
...
- Role cell: filename stem exists in `.roles/` -- not invented
