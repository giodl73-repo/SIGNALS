...
|---------|--------------|-----------------|
| `G1` | `HALT [G1]: .roles/ absent or empty. Not ready to select reviewers.` | `--amend reload` |
...
| Gate ID | Halt message | Re-entry command |
|---------|--------------|-----------------|
| `G1` | `HALT [G1]: .roles/ absent or empty. Not ready to proceed.` | `--amend reload` |
...
| Gate ID | Halt message | Re-entry command |
|---------|--------------|-----------------|
| `G1` | `HALT [G1] BLOCKING: .roles/ absent or empty. Not ready to select reviewers.` | `--amend reload` *(after fixing directory)* |
...
If `.roles/` absent or empty: output `HALT [G1] BLOCKING` with its re-entry command. Stop.
...
If `.roles/` absent or empty: output `HALT [G1]` with both recovery paths. Stop.
