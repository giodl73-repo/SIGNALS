...
BUILD-VERIFY: [team name]
  ...
  IA lens field opening:  "[actual first phrase in written .roles/ file]"
...
### Stage 5: What .roles/inertia-advocate.md files look like
...
field in every .roles/ file opens with the exact lens-phrase from Stage 4. This is
...
**Entry**: VALIDATE-PASS.
**This phase produces the headcount table and analytic prose before any .roles/ file.
