...
Role: load `.craft/roles/signal/pm.md`. Work through `lens.verify` explicitly; quote or
...
Role: load `.craft/roles/signal/architect.md`. Work through `lens.verify` and `lens.simplify`.
...
Role: S-office missions cascade; construct if no `.craft/roles/` file.
...
Read `.craft/roles/` and load all role files. Extract orientation, lens, expertise per role.
...
**PM**
Role: load `.craft/roles/signal/pm.md`. Use `lens.verify` as checklist; quote or paraphrase
...
**ARCH-BOARD**
Role: load `.craft/roles/signal/architect.md`. Use `lens.verify` and `lens.simplify`.
...
Read `.craft/roles/` and load all role files. Extract orientation, lens, expertise.
...
**LEADERSHIP**
Load VP/executive archetype from `.craft/roles/`; construct if absent as
...
**TEAMS**
Load team archetype from `.craft/roles/`; construct if absent as "Engineering Lead".
...
**PM**
Load `.craft/roles/signal/pm.md`. Voice using its documented lens items directly.
...
**ARCH-BOARD**
Load `.craft/roles/signal/architect.md`. Voice using `lens.verify` and `lens.simplify`.
...
Role: team archetype from `.craft/roles/`; construct if absent.
...
Role: load `.craft/roles/signal/pm.md`. The `lens.verify` items inform the Finding column.
...
Role: load `.craft/roles/signal/architect.md`. `lens.verify` informs Finding column.
...
Read `.craft/roles/` and load all role files. Required: load
`.craft/roles/signal/inertia-advocate.md` before any stage begins. Also load all stage-
...
**PM**
Role: load `.craft/roles/signal/pm.md`. Use `lens.verify` as explicit checklist; quote or
