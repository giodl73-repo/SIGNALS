...
/org-review     artifact reviewed through all relevant roles from .roles/ with verdict per role  *(T3)*
...
/org-review     routes an artifact through the org's relevant roles -> verdict per role from .roles/ registry  *(T3)*
