...
**PHASE 0**: Read `.craft/roles/` for the charter matching this committee type. Load every named role. If no charter exists, fall back to Signal defaults (PM, Architect, Inertia-Advocate) and name them in Charter Source as: `"Signal defaults — no charter found"`.
...
Charter: [path to .craft/roles/ file used, or "Signal defaults — no charter found: [list fallback roles]"]
Participants:
...
Read `.craft/roles/` for the charter matching this committee type. Load every named role. If no charter exists, fall back to Signal defaults (PM, Architect, Inertia-Advocate) and state the fallback explicitly.
...
Charter: [.craft/roles/ path or "Signal defaults: [roles]"]
Participants:
  [Role] — [orientation]
  [repeat per participant]
```

LOAD: Read `.craft/roles/` for this committee type. If absent: load PM, Architect, Inertia-Advocate; PRINT charter source as "Signal defaults — no charter found."
...
```
Committee: [TYPE: ROB / shiproom / arch-board / other] — [agenda item title]
Charter: [path to .craft/roles/ file, or "Signal defaults — no charter found: [roles]"]
Participants:
  [Role Name] — [charter-defined orientation in one phrase]
  [one line per loaded role]
```

Read `.craft/roles/` for this committee type. Load every named role. If no charter exists, fall back to Signal defaults (PM, Architect, Inertia-Advocate) and state the fallback.
...
- Read `.craft/roles/` for the charter matching this committee type. Load every named role with charter-defined orientation.
