...
**PHASE 0 rules:**
Load charter from `.craft/roles/` matching this committee type. If none found: Charter Source
...
**PHASE 0:**
Load charter from `.craft/roles/` for this committee type. No charter → `Signal defaults —
...
**Phase 0:**
You'll want to load the charter from `.craft/roles/` for this committee type. If you can't
