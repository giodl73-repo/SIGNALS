...
Write one `.md` file per role to `.craft/roles/{area}/`. Write domain-expert roles first (Phase 1),
...
1. One `.md` file exists per role at `.craft/roles/{area}/`
...
Write `.craft/roles/{area}/REGISTRY.md` using this template. Fill every slot. The "Inertia surface"
...
Write `.craft/roles/{area}/REGISTRY.md` using this template. Fill every slot. The "Domain risk
...
Write one `.md` file per role to `.craft/roles/{area}/`. Domain-expert roles first (Phase 1),
...
Write `.craft/roles/{area}/REGISTRY.md` using this template. The extension field below uses the
...
Write `.craft/roles/{area}/REGISTRY.md` using this template. Fill every slot. The "Inertia
...
Write `.craft/roles/{area}/REGISTRY.md` using this template. The extension field uses the Phase 0
