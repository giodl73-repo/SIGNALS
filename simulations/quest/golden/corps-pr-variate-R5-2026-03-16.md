...
|-------|-------------------|----------------------------------------------|---------------------------------------------------------------------|---------------------------------|
| A     | Route             | org.yaml + PR diff + .craft/roles/ loaded    | Routing table complete; every changed file has a row; every role    | C-01, C-06                      |
...
| Phase | Name              | Entry Condition                               | Exit Condition                                                       | Criteria Gated             |
|-------|-------------------|-----------------------------------------------|----------------------------------------------------------------------|----------------------------|
| A     | Route             | org.yaml + PR diff + .craft/roles/ loaded     | Routing table complete; every file has a row; every role cites       | C-01, C-06                 |
