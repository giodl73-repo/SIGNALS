...
`.craft/roles/` files. No role includes role file content or instructions to create role files.
...
**Draft-only constraint** (re-stated): No `.craft/roles/` content in any form. org.yaml only.
