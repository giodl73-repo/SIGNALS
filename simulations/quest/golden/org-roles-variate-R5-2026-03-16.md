...
1. One `.md` file exists per role in `.roles/{area}/`
...
Answer by writing `.roles/{area}/REGISTRY.md`. Before writing, count the `.md`
...
**WRITE:** One `.md` file per role to `.roles/{area}/`. Domain experts first, stock
...
Answer by writing `.roles/{area}/REGISTRY.md`:
