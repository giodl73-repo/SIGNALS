...
Read `.craft/roles/` and load all available role files. For each role, extract the field
inventory:
...
If a required role has no file in `.craft/roles/`, construct a minimal role inline, assign
...
Role: VP/executive archetype from `.craft/roles/`; construct if absent as "VP -- strategic
...
Role: load `.craft/roles/signal/pm.md`. Work through `lens.verify` items in order; each item
...
Role: load `.craft/roles/signal/architect.md`. Lens items include `architect.lens.verify`
...
Role: load `.craft/roles/signal/pm.md`. Work through `lens.verify` items explicitly.
...
Read `.craft/roles/` and load all available role files. For each role, build a lens inventory:
...
Role: load `.craft/roles/signal/pm.md`. Publish full lens inventory before Review section.
...
Role: load `.craft/roles/signal/architect.md`. Publish full lens inventory before Review.
...
Read `.craft/roles/` and load all available role files. For each role, build and publish
...
Role: load `.craft/roles/signal/pm.md`. Publish full lens inventory from pm.md.
...
Role: load `.craft/roles/signal/architect.md`. Publish full lens inventory from architect.md.
