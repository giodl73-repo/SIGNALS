...
design/ directories, namespaces, test coverage areas, SPECS.md files, existing .roles/.
...
reporting lines, no hierarchy, no .roles/ file creation. This constraint applies to every
...
[7] No org chart, no reporting lines, no .roles/ content (C-05)
...
lines. No .roles/ creation. No hierarchy. Violation is a critical failure.
...
[7] No org chart, reporting lines, or .roles/ content (C-05: [MET/NOT MET])
...
No org chart. No reporting lines. No .roles/ files. No hierarchy. Any violation is a
...
[6] All TABLE B rows have Anti-Fabrication Note (C-11): [MET / NOT MET]
[7] No org chart, no reporting lines, no .roles/ content (C-05): [MET / NOT MET]
...
Do not produce a hierarchy diagram. Do not create or reference .roles/ files.
...
[8] Verify no org chart, reporting lines, or .roles/ content anywhere above: [MET / NOT MET]
...
**OUTPUT CONSTRAINT (C-05 — first statement)**: RAW ANALYSIS ONLY. No org chart. No reporting
lines. No .roles/ files. No hierarchy. This constraint applies to every section.
...
**HARD BOUNDARY (C-05)**: RAW ANALYSIS ONLY. No org chart. No .roles/ files.
