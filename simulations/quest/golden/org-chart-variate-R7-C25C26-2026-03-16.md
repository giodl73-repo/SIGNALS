...
DO:
  - Glob `.roles/` and produce ROLES-LOADED listing every role name found
  - If .roles/ is absent or empty, produce ROLES-NOTE declaring inferred roles are used
...
DO:
  - Glob `.roles/` and produce ROLES-LOADED listing every role name found with one-line
