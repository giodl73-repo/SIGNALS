...
Read `.roles/`. Assign each slot from loaded roles.
...
Read `.roles/`. PROHIBITED: inventing roles not in manifest. VIOLATION TYPE: §1-invented-role.
...
Read `.roles/`. PROHIBITED: inventing roles. VIOLATION TYPE: §1-invented-role.
