...
Read `.craft/roles/signal/`. Choose the inertia-advocate as the challenger. Choose a domain
...
Read `.craft/roles/signal/`. Choose challenger (inertia-advocate), domain role, lifecycle role.
