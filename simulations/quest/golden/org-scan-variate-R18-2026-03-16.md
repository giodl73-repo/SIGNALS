...
| I-03 | Domain Teams | Named namespace directories; per-namespace CLAUDE.md or README; per-domain tests; explicit ownership in docs or .craft/roles | "that's the X team's area"; clear escalation path per domain; PRs stay within domain seams |
...
- not-applicable: source type structurally absent from this repo (e.g., no .craft/roles/
...
| .craft/roles/ or role definitions | [scanned / not-found / not-applicable] | [brief note] |
...
5. Test coverage areas
6. SPECS.md or specification files
7. .craft/roles/ or role definitions
...
| .craft/roles/ or role definitions | [scanned / not-found / not-applicable] | [one sentence] |
