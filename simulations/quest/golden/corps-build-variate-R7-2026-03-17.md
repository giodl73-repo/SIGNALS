...
3. Area slug uniqueness across the org (no two teams produce the same `.roles/{slug}/` path)
...
1. **Standard roles** -- `.roles/{area-slug}/{role-slug}.md`
...
For each team, write `.roles/{area-slug}/inertia-advocate.md` with five fields:
