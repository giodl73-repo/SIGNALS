...
ROLE: [name from .craft/roles/] — [their orientation in one phrase]
...
Before you start, pull each stage's assigned persona from `.craft/roles/` via `org.yaml`.
...
ROLE: [name from .craft/roles/] | LENS: [orientation — one phrase]
