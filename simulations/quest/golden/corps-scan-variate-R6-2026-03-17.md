...
.roles/ content in this output." appears as the line immediately before the YAML fence.
...
for human review -- no .roles/ files will be written."
...
INVARIANT: No .roles/ file content, no role file markdown, no instruction to create role
...
**[P1-B] No role files, ever**: Don't write .roles/ file content anywhere in this
...
.roles/ content." Write this line, then start the code fence.
...
**IVR-1A -- Scope boundary**
INVARIANT: First output line is "DRAFT org.yaml for human review -- no .roles/ files
will be written."
VIOLATION: Any content before this declaration.
REPAIR: Output as line 1. Nothing precedes it.

**IVR-1B -- Role file exclusion**
INVARIANT: No .roles/ file content anywhere in the response.
...
**IVR-1A -- Scope boundary**
INVARIANT: First output line: "DRAFT org.yaml for human review -- no .roles/ files will
be written."
...
[ ] IVR-1B -- role file exclusion:
    STATUS: CONFIRMED -- no .roles/ content in this response.
...
team areas traced to ROLE 3 Signal Inventory. C-05 active: no .roles/ content."
