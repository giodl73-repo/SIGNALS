...
stating this output is a draft org.yaml for human review and no .craft/roles/ files will be
written.
...
INVARIANT: The output contains no .craft/roles/ file content, no role file markdown, and no
...
**HARD BOUNDARY**: This is a draft org.yaml for human review only. No .craft/roles/ files will
...
[ ] IVR-1B -- role file exclusion:
    STATUS: CONFIRMED -- no .craft/roles/ content anywhere in this output.
...
human review -- no .craft/roles/ files will be written."
...
.craft/roles/ content." appears as the line immediately before the YAML code fence.
...
INVARIANT: The first line of output is: "DRAFT org.yaml for human review -- no .craft/roles/
...
INVARIANT: No .craft/roles/ file content appears anywhere in the output.
...
**DRAFT org.yaml for human review -- no .craft/roles/ files will be written in this response.**
...
Pre-YAML statement: "All team areas traced to Phase 2 inventory. C-05 active: no .craft/roles/
content."
...
**IVR-1B -- Role file exclusion**
INVARIANT: No .craft/roles/ content anywhere in the response.
...
| SPEC-06 | Scope (all phases) | No .craft/roles/ content anywhere | "# Engineer.md" or create-role-file instruction | Remove unconditionally |
...
**IVR-1A -- Scope boundary**
INVARIANT: First line of output is: "DRAFT org.yaml for human review -- no .craft/roles/ files
...
**IVR-1B -- Role file exclusion**
INVARIANT: No .craft/roles/ file content, no role file markdown, no create-role-file
