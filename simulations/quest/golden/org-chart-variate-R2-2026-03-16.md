...
Produce immediately:
```
ROLES-LOADED: [role names from .craft/roles/]
```
...
```
ROLES-LOADED: [roles from .craft/roles/]
```
...
If no roles exist: DO write `ROLES-NOTE: No .craft/roles/ files found -- using inferred roles: [list]`
