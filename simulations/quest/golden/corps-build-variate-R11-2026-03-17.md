...
| STRUCTURAL-ERROR:PATH-ISOLATION-VIOLATION | WRITE-ROLES | role file written outside `.roles/{area-slug}/{role-slug}.md` |
...
|-----------|---------------------|
| **INVARIANT-PATH-ISOLATION** -- Role files are written only to paths matching `.roles/{area-slug}/{role-slug}.md`. No role file is created outside this pattern. | STRUCTURAL-ERROR:PATH-ISOLATION-VIOLATION |
...
For each team, write `.roles/{area-slug}/inertia-advocate.md`. Lens and expertise MUST
...
Path validation (per role file, before writing): confirm `.roles/{area-slug}/{role-slug}.md`.
...
For each team, write `.roles/{area-slug}/inertia-advocate.md`. Lens and expertise from
...
| Invariant | Enforcement Code(s) |
|-----------|---------------------|
| **INVARIANT-PATH-ISOLATION** -- Role files written only to `.roles/{area-slug}/{role-slug}.md`. | STRUCTURAL-ERROR:PATH-ISOLATION-VIOLATION |
...
ENTRY-GATE: `PROFILE-GATE`. If absent: `ENTRY-GATE-FAIL: PROFILE-GATE required`. Halt.
Per team: write `.roles/{area-slug}/inertia-advocate.md` using PROFILE lens/artifact
...
For each team: write `.roles/{area-slug}/inertia-advocate.md` (INVARIANT-IA-PRESENCE).
