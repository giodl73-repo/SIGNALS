...
reporting lines, no hierarchy, no .roles/ file creation. Applies to every section in
GROUP A and GROUP B.
...
[7] No org chart, reporting lines, or .roles/ content (C-05; OUTPUT CONSTRAINT above)
...
[7] No org chart, reporting lines, .roles/ content (C-05)
...
**OUTPUT CONSTRAINT (C-05 — stated here and again in GROUP B output format section)**:
RAW ANALYSIS ONLY. No org chart. No reporting lines. No hierarchy. No .roles/ creation.
...
**HARD BOUNDARY (C-05 / C-13)**: RAW ANALYSIS ONLY. No org chart, no reporting lines,
no hierarchy, no .roles/ file creation. Applies throughout.
