...
> Pivot mode: [ROLE 3 selection]. C-05 active: no .roles/ content in this output."
...
> Pivot mode: [DELIBERATE PHASE selection]. C-05 active: no .roles/ content."
...
> [ROLE 3 selection]. C-05 active: no .roles/ content in this output."
...
"DRAFT ONLY (C-12): This is a draft org.yaml for human review. No `.roles/` files will
be written."
...
- No .roles/ content anywhere in this output               [yes / no]
