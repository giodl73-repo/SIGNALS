...
**Step 1 -- Write inertia-advocate** (`.craft/roles/{area}/inertia-advocate.md`):
...
Write each role to `.craft/roles/{area}/{role-slug}.md`. **After writing each role's verify and
...
**Additional requirements for the inertia-advocate** (`.craft/roles/{area}/inertia-advocate.md`):
...
**Step 1 -- Write inertia-advocate first** (`.craft/roles/{area}/inertia-advocate.md`):
...
Write each role to `.craft/roles/{area}/{role-slug}.md`. After completing each role file, run the
