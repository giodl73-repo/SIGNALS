...
Read `.roles/`. Produce a `ROLES-LOADED:` block: `- [role name] -- [one-line description from role file]` per role. If no files are found, produce `ROLES-NOTE: No .roles/ files found. Using inferred roles:` with inferred roles in the same format.
...
Read `.roles/`. Produce a `ROLES-LOADED:` block: `- [role name] -- [one-line description]` per role. If no files found, produce `ROLES-NOTE: No .roles/ files found. Using inferred roles:` with inferred roles in the same format. DO NOT write any other section until this block exists.
...
Read `.roles/`. Produce a `ROLES-LOADED:` block: `- [role name] -- [one-line description]` per role. If no files found: `ROLES-NOTE: No .roles/ files found. Using inferred roles:` with inferred roles in the same format. No other section until this block is complete.
...
Read `.roles/`. Produce `ROLES-LOADED:` with one entry per role: `- [role name] -- [one-line description]`. If no files found: `ROLES-NOTE: No .roles/ files found. Using inferred roles:` with inferred roles in the same format. No other section until this block is written.
...
Read `.roles/`. Produce `ROLES-LOADED:`: `- [role name] -- [one-line description]` per role. If no files found: `ROLES-NOTE: No .roles/ files found. Using inferred roles:` with inferred roles. No other section until complete.
