...
1. One `.md` file exists per role in `.craft/roles/{area}/` — inertia-advocate (Phase 1),
...
**GATE:** OUTPUT-AREA written; area slug from Phase 2; path format is `.craft/roles/{area}/`
...
3. One `.md` file per role at `.craft/roles/{area}/`
...
**GATE:** OUTPUT-AREA written; area slug from Phase 2; path is `.craft/roles/{area}/`
