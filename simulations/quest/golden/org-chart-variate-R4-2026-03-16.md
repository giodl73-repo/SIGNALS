...
If no files found, produce `ROLES-NOTE: No .craft/roles/ files found. Using inferred roles:`.
...
Check `.craft/roles/` before writing anything.
...
Confirm: "Have I listed every role from .craft/roles/, or stated that no files were found?"
