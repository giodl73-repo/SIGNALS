out = open('C:/src/sim/simulations/quest/rubrics/org-rob-rubric-v3-2026-03-16.md', 'w', encoding='utf-8')
...
'# org-rob Rubric -- v3',
'',
'**16 criteria across 3 tiers** (up from 13):',
'',
...
'**What changed (v2 -> v3):**',
'',
'- **C-14 Lens-anchored findings** -- each finding cites the specific lens item or',
'  orientation frame from the loaded role that triggered it. Role-loading is',
'  verifiable at the finding level, not just at the stage level. Both V-01 and V-02',
'  in R2 scored `+` on C-02 (role lens shapes the stage) but neither reached `++`',
'  because no per-finding lens citation field was required. C-14 rewards the',
'  structural step that closes that gap.',
'',
