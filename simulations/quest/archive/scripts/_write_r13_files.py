...
rubric_path = pathlib.Path(r"C:\src\sim\simulations\quest\rubrics\prove-interview-rubric-v13-2026-03-15.md")
golden_path = pathlib.Path(r"C:\src\sim\simulations\quest\golden\prove-interview-variate-R13-2026-03-15.md")

rubric_content = r"""# prove-interview — Rubric v13 — 2026-03-15
...
golden_content = r"""# prove-interview — Skill Body Variations — R13
...
print(f"Size: {rubric_path.stat().st_size} bytes")

golden_path.write_text(golden_content, encoding="utf-8")
print(f"Written: {golden_path}")
print(f"Size: {golden_path.stat().st_size} bytes")
