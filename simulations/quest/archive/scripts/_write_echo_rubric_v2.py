OUT = r'C:\src\sim\simulations\quest\rubrics\topic-echo-rubric-v2-2026-03-16.md'
...
date: 2026-03-16
version: 2
prior_version: topic-echo-rubric-v1-2026-03-16.md
---

# topic-echo -- Scoring Rubric v2
...
## Aspirational Criteria (weight: 20 points total, 5 pts each)
...
- Aspirational: 20 points total (4 criteria, 5 points each)
- Max composite: 110
...
- Aspirational: 1/4 pass -> 1/4 * 20 = 5
