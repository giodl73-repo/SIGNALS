"""Build org-chart-variate-R7-2026-03-16.md from component parts."""

OUT = 'C:/src/sim/simulations/quest/golden/org-chart-variate-R7-2026-03-16.md'
...
def build_var(heading, block_b, roadmap):
    return (
        heading
...
content = (
    HEADER
    + build_var(V1_HEAD, BLOCK_B_STANDARD, ROADMAP_STANDARD)
    + build_var(V2_HEAD, BLOCK_B_STANDARD, ROADMAP_PROSE)
    + build_var(V3_HEAD, BLOCK_B_CONSTRAINTS, ROADMAP_CONSTRAINTS)
    + build_var(V4_HEAD, BLOCK_B_CONSTRAINTS, ROADMAP_PROSE)
    + build_var(V5_HEAD, BLOCK_B_WHY, ROADMAP_WHY)
    + FOOTER
)
