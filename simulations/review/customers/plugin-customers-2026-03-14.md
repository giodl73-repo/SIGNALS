...
**Findings**:
- F-19: Custom persona path exists (.roles/signal/) but is not documented in any getting-started flow (MINOR)
...
domain, create .roles/signal/{name}/ROLE.md. Template at
