...
rhythms (ROB cadence, shiprooms, architecture boards). Reads existing `.craft/roles/` to build
...
- **C-03 requires inspecting the run context** -- check whether `.craft/roles/` was populated
...
dest = "C:/src/sim/simulations/quest/rubrics/org-chart-rubric-v2-2026-03-15.md"
with open(dest, "w", encoding="utf-8") as f:
    f.write(rubric)
print("written", len(rubric), "bytes to", dest)
