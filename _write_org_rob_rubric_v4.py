out = open('C:/src/sim/simulations/quest/rubrics/org-rob-rubric-v4-2026-03-16.md', 'w', encoding='utf-8')
...
'# org-rob Rubric -- v4',
'',
'*Version history: v1 (round 1, C-01--C-08), v2 (round 2, added C-11--C-13),',
'v3 (round 3a, added C-14--C-16), v4 (round 3b, added C-17)*',
'',
'**17 criteria across 3 tiers** (up from 16):',
'',
