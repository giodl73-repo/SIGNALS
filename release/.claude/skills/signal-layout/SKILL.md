---
name: signal-layout
description: "Show or switch your Signal command layout. Five variants: flat (/discover-competitors), bare (/competitors), signal (/signal-competitors), grouped (/discover menu), prefixed. See what you have, try a different style."
