...
description: "Check whether your discover signals agree. Surfaces contradictions with severity (blocking/advisory), inertia-first rendering, and runnable resolution tokens. Requires 2+ prior discover signals."
