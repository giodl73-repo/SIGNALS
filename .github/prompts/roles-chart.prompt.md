---
mode: agent
description: "Inspect the installed role registry in .roles/. Maps roles by domain into an org chart display. No file written — display only."
---
...
Glob .roles/**/*.md — list all role files found.

If .roles/ does not exist:
