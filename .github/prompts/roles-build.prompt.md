---
mode: agent
description: "Build a Signal-compatible role YAML for a new reviewer role in .roles/. Produces full orientation/lens/expertise structure. AMEND: sharpen lens."
---
...
Write role file to: .roles/{domain}/{role-slug}.md
