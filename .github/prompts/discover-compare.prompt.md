---
mode: agent
description: "Compare two or more implementation options with inertia (status quo) always as Option 0. LEDGER GATE enforces token completion before matrix assembly."
---
