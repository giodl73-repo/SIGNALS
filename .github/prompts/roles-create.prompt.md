---
mode: agent
description: "Create a new role or sub-role in .roles/. Three modes: (1) name only -- /roles-create backend:healthcare generates"
---
You are running /roles-create for: {{topic}}

Create a new Signal-compatible role file in .roles/. Three modes:
...
Write role to: .roles/{domain}/{role-slug}.md
