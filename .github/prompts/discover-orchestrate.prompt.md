---
mode: agent
description: "Orchestrate a full discovery campaign. Assesses which discover skills have run, then sequences the remaining ones in optimal order. Display only -- do"
---
