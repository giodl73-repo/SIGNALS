...
files in `.craft/roles/`. Customer segment roles (customer/*) and MSFT internal roles
...
| Abbreviation | File |
|---|---|
| pm | .craft/roles/pm.md |
| architect | .craft/roles/architect.md |
| product-marketing | .craft/roles/product-marketing/ROLE.md |
| ux-researcher | .craft/roles/ux-researcher/ROLE.md |
| security | .craft/roles/security/ROLE.md |
| compliance | .craft/roles/compliance/ROLE.md |
| tpm | .craft/roles/tpm/ROLE.md |
| sre | .craft/roles/sre/ROLE.md |
| executive | .craft/roles/executive/ROLE.md |
| inertia | .craft/roles/inertia.md |
| inertia-advocate | .craft/roles/inertia-advocate.md |
| discover:inertia-first | .craft/roles/discover/inertia-first.md |
| discover:evidence-rigor | .craft/roles/discover/evidence-rigor.md |
| discover:falsifiability | .craft/roles/discover/falsifiability.md |
| discover:scope-guardian | .craft/roles/discover/scope-guardian.md |
| specify:commitment-clarity | .craft/roles/specify/commitment-clarity.md |
| specify:reversibility | .craft/roles/specify/reversibility.md |
| specify:scope-integrity | .craft/roles/specify/scope-integrity.md |
| validate:user-centricity | .craft/roles/validate/user-centricity.md |
| validate:adoption-friction | .craft/roles/validate/adoption-friction.md |
| validate:coverage-depth | .craft/roles/validate/coverage-depth.md |
| simulate:contract-integrity | .craft/roles/simulate/contract-integrity.md |
| simulate:failure-mode-coverage | .craft/roles/simulate/failure-mode-coverage.md |
| simulate:inertia-baseline | .craft/roles/simulate/inertia-baseline.md |
| narrate:decision-hygiene | .craft/roles/narrate/decision-hygiene.md |
| narrate:narrative-coherence | .craft/roles/narrate/narrative-coherence.md |
| narrate:commitment-gate | .craft/roles/narrate/commitment-gate.md |
| govern:representation | .craft/roles/govern/representation.md |
| govern:inertia-advocate | .craft/roles/govern/inertia-advocate.md |
| govern:escalation-clarity | .craft/roles/govern/escalation-clarity.md |
| customer:enterprise | .craft/roles/customer/enterprise.md |
| customer:smb | .craft/roles/customer/smb.md |
| customer:isv | .craft/roles/customer/isv.md |
| customer:startup | .craft/roles/customer/startup.md |
| customer:public-sector | .craft/roles/customer/public-sector.md |
| customer:developer | .craft/roles/customer/developer.md |
| msft:pm | .craft/roles/msft/pm.md |
| msft:fte | .craft/roles/msft/fte.md |
| msft:csa | .craft/roles/msft/csa.md |
| msft:field | .craft/roles/msft/field.md |
| msft:tam | .craft/roles/msft/tam.md |
