...
- `.craft/` ← roles registry, no README
...
```
README.md                    ← links to: docs/, install/, signals/, simulations/, .craft/roles/
  ↓
docs/
...
5. **Add README.md** to: `simulations/`, `signals/`, `install/`, `tools/`, `experiments/`, `findings/`, `.craft/`, `output/`
...
4. How do I create a role? (README → docs/guides/roles.md → .craft/README → .craft/roles/)
