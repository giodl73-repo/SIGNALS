...
**Sources**:
- `.roles/pipelines/suite/simulate.md` — pipeline stage definition
- `.roles/waves/*/simulate-*.md` — per-persona walkthrough reports
...
- `.roles/reviews/concepts/` — review output directories
